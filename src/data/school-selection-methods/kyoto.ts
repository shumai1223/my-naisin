...
// 別学校に収録。同様に丹後緑風も網野学舎(普通科・企画経営科)と久美浜学舎
// (アグリサイエンス科・みらいクリエイト科)を別学校として収録。清新(頁147-148・総合学科
// A/D方式)は「単位制による定時制（昼間）課程」のため清明・京都奏和・北桑田美山分校・
// 福知山三和分校と同様に対象外。清新の確認をもって後半PDF全82頁の前期選抜独自枠
// 募集要項セクション(頁1-82・印刷頁79-148、その先の「特別入学者選抜実施要項」は別制度
// のためスコープ外)を完全に確認済み。他学区(南丹通学圏を除く残り・中丹/丹後通学圏)は
// この収録で概ね出揃った。
//
...
export const KYOTO_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '「京都市・乙訓」学区26校(58レコード)＋「城陽」学区8校(18レコード)＋「相楽」学区3校(13レコード)＋北桑田(本校・2レコード)＋亀岡(4レコード)＋南丹(3レコード)＋園部(1レコード)＋農芸(1レコード)＋須知(3レコード)＋綾部(本校・2レコード)＋綾部(東分校・2レコード)＋福知山(本校・2レコード)＋工業(3レコード)＋大江(1レコード)＋東舞鶴(1レコード)＋西舞鶴(3レコード)＋海洋(1レコード)＋宮津天橋(宮津学舎・2レコード)＋宮津天橋(加悦谷学舎・2レコード)＋峰山(3レコード)＋丹後緑風(網野学舎・3レコード)＋丹後緑風(久美浜学舎・2レコード)の計56校130レコードを収録。京都市・乙訓学区の山城〜東稜13校は一覧表(頁14-18)と個別学校ページ(頁21-51)の両方で行の帰属を突合できた学校、洛水〜開建13校は個別学校ページ(頁52-77)のみを直接転記(一覧表側の該当ページに文字化けがあったため)。城陽学区以降(東宇治〜丹後緑風久美浜学舎)は後半PDF頁1-68(印刷頁79-146)の個別学校ページのみで構成され一覧表との突合は不要だった。**後半PDF全82頁(頁1-82・印刷頁79-148の前期選抜独自枠募集要項セクション)は清新の確認(頁69-70・定時制のため対象外)をもって完全確認済み**(その先の「特別入学者選抜実施要項」は別制度でスコープ外)。清明高校・京都奏和・北桑田美山分校・福知山三和分校・清新(いずれも定時制・昼間課程)は本表の対象外(定時制は別掲)',
  source: {
    url: 'https://www.kyoto-be.ne.jp/koukyou/cms/wp-content/uploads/2026/09/前期選抜独自枠等募集要項（1前半）.pdf',
    docTitle: '京都府教育委員会「令和9年度京都府公立高等学校入学者選抜 前期選抜独自枠等募集要項」前半(頁14-18・頁21-77)＋後半(https://www.kyoto-be.ne.jp/koukyou/cms/wp-content/uploads/2026/08/前期選抜独自枠等募集要項（後半）.pdf・頁1-70=印刷頁79-148・全82頁の前期選抜独自枠セクションを完全確認)',
  ...
  schools: [
    ...
    {
      schoolName: '京都府立丹後緑風高等学校（網野学舎）',
      department: '企画経営科（単位制）',
      selectionCategory: '前期選抜独自枠 A方式',
      note: '独自枠募集人員12人',
    },
    {
      schoolName: '京都府立丹後緑風高等学校（久美浜学舎）',
      department: 'アグリサイエンス科（単位制）',
      selectionCategory: '前期選抜独自枠 A方式',
      note: '独自枠募集人員15人',
    },
    {
      schoolName: '京都府立丹後緑風高等学校（久美浜学舎）',
      department: 'みらいクリエイト科（単位制）',
      selectionCategory: '前期選抜独自枠 A方式',
      note: '独自枠募集人員10人',
    },
  ],
