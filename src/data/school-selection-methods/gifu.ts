...
// 頁1のうち学校番号1〜14(岐阜/岐阜北/長良/岐山/加納/羽島北/岐阜総合学園/岐阜城北/岐阜商業/
// 岐南工業/各務原/各務原西/岐阜各務野/本巣松陽)を収録。
//
...
export const GIFU_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '全4頁のうち頁1の学校番号1〜14(岐阜/岐阜北/長良/岐山[2学科]/加納[3学科]/羽島北/岐阜総合学園/岐阜城北[2学科]/岐阜商業[4学科]/岐南工業[6学科]/各務原/各務原西/岐阜各務野[3学科]/本巣松陽)を収録。頁1の残り(岐阜農林以降・学校番号15〜18)および頁2〜4は未着手',
  schools: [
    {
      schoolName: '岐阜',
      department: '普通',
  ...
  note: '全4頁のうち頁1の学校番号1〜14(14校28学科・78レコード)を収録。岐阜総合学園・各務原・本巣松陽は同一学科に区分I/IIの2つの独自検査枠が存在するため、selectionCategoryを「第一次選抜(独自検査区分I)」「第一次選抜(独自検査区分II)」の2つに分けて両方収録した。岐阜各務野の情報学科・各務原西は独自検査自体が実施されないケース(区分欄が空欄)。ratioTypeは標準検査を「調査書:学力検査=X:Y」、独自検査を「募集人員のXX%」の形で転記',
};
