...
//
// ✅収録完了（2026-09-17）: 全92頁のうち「I 全日制課程選抜」（頁2〜68・67校）の先頭18校
// （前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・
// 高崎北・榛名・高崎女子・吉井・高崎工業・高崎商業・桐生(普通科)・桐生(理数科)）を収録。
// フレックススクール選抜・定時制課程選抜・連携型選抜、および全日制の残り49校は未収録。
...
export const GUNMA_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '全92頁のうち「I 全日制課程選抜」(頁2〜68・67校)の先頭18校(前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・高崎北・榛名・高崎女子・吉井・高崎工業・高崎商業・桐生(普通科・理数科))を収録。フレックススクール選抜・定時制課程選抜・連携型選抜、及び全日制の残り49校は未収録。ratioTypeは学力検査:面接等:調査書の割合(%)をコロン区切りで転記',
  schools: [
    // 前橋（普通科【280】男280人）
