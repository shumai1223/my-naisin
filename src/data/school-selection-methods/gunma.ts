...
//
// ✅収録完了（2026-09-17）: 全92頁のうち「I 全日制課程選抜」（頁2〜68・67校）の先頭12校
// （前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・
// 高崎北・榛名）を収録。フレックススクール選抜・定時制課程選抜・連携型選抜、および全日制の
// 残り55校は未収録。★前橋工業は「特色型選抜」が第1次・「総合型選抜」が第2次という他校と
// 逆順の選抜順序を採る例外校（選抜の順自体が学校ごとに異なりうることが判明）。
...
export const GUNMA_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '全92頁のうち「I 全日制課程選抜」(頁2〜68・67校)の先頭12校(前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・高崎北・榛名)を収録。フレックススクール選抜・定時制課程選抜・連携型選抜、及び全日制の残り55校は未収録。ratioTypeは学力検査:面接等:調査書の割合(%)をコロン区切りで転記',
  schools: [
    // 前橋（普通科【280】男280人）
