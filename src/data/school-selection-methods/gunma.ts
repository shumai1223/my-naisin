...
export const GUNMA_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  schools: [
    ...
    { schoolName: '西邑楽', department: 'スポーツ科', selectionCategory: '特色型選抜', interviewRequired: true, ratioType: '学力検査28%:面接等8%:調査書8%:実技検査56%', note: '特色型選抜10%(令和9年度版で段階名が「特色型選抜①」から「特色型選抜」へ)。第1次選抜合格者以外を対象に、実技検査の結果を重視。学力検査計500・面接等(集団面接)150点・調査書150点・実技検査1000点' },
