...
//
// ✅収録完了（2026-09-17）: 全92頁のうち「I 全日制課程選抜」（頁2〜68・67校）の先頭47校
...
// 藤岡工業・富岡・富岡実業・松井田・安中総合学園）を収録。フレックススクール選抜・定時制課程
// 選抜・連携型選抜、および全日制の残り20校は未収録。★安中総合学園(特色型選抜①)は面接等の
// 配点が学力検査:面接等:調査書=10%:50%:40%と面接等が過半数を占める最も面接偏重の例。
...
export const GUNMA_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '全92頁のうち「I 全日制課程選抜」(頁2〜68・67校)の先頭47校(前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・高崎北・榛名・高崎女子・吉井・高崎工業・高崎商業・桐生(普通科・理数科)・桐生清桜(普通・アドバンスト探究)・桐生工業・伊勢崎・伊勢崎清明・伊勢崎興陽・伊勢崎工業・伊勢崎商業・太田・太田東・太田女子・新田暁・太田工業・沼田(普通コース・文理探究コース)・尾瀬・利根実業・館林・館林女子・渋川・渋川女子・渋川青翠・渋川工業・藤岡中央・藤岡北・藤岡工業・富岡・富岡実業・松井田・安中総合学園)を収録。フレックススクール選抜・定時制課程選抜・連携型選抜、及び全日制の残り20校は未収録。ratioTypeは学力検査:面接等:調査書の割合(%)をコロン区切りで転記',
  schools: [
    // 前橋（普通科【280】男280人）
