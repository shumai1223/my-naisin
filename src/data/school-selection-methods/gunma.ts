...
//
// ✅収録完了（2026-09-17）: 全92頁のうち「I 全日制課程選抜」（頁2〜68・67校）の先頭57校
...
// 尾瀬・利根実業・館林・館林女子・渋川・渋川女子・渋川青翠・渋川工業・藤岡中央・藤岡北・
// 藤岡工業・富岡・富岡実業・松井田・安中総合学園・大間々・万場・下仁田・吾妻中央・長野原・
// 嬬恋・玉村・板倉・館林商工・西邑楽(普通科・スポーツ科・芸術科)）を収録。フレックススクール
// 選抜・定時制課程選抜・連携型選抜、および全日制の残り10校は未収録。★安中総合学園(特色型
// 選抜①)は面接等の配点が学力検査:面接等:調査書=10%:50%:40%と面接等が過半数を占める最も
// 面接偏重の例。★吾妻中央は普通科・生物生産科・環境工学科・福祉科の4学科間で相互に第2志望を
// 認める(他校の「同一学科内のトラック間」より広いくくり)。★西邑楽のスポーツ科・芸術科は
// 他校に無い「実技検査」列を持つ唯一の例（学力検査・面接等・調査書に加え実技検査を独立した
// 検査項目として得点化）。ratioTypeにも実技検査の割合を含めて4項目で転記する。
...
export const GUNMA_SCHOOL_SELECTION_METHOD: PrefectureSchoolSelectionMethod = {
  ...
  status: 'structured',
  coverageNote:
    '全92頁のうち「I 全日制課程選抜」(頁2〜68・67校)の先頭57校(前橋・前橋南・前橋西・前橋女子・前橋東・勢多農林・前橋工業・前橋商業・高崎・高崎東・高崎北・榛名・高崎女子・吉井・高崎工業・高崎商業・桐生(普通科・理数科)・桐生清桜(普通・アドバンスト探究)・桐生工業・伊勢崎・伊勢崎清明・伊勢崎興陽・伊勢崎工業・伊勢崎商業・太田・太田東・太田女子・新田暁・太田工業・沼田(普通コース・文理探究コース)・尾瀬・利根実業・館林・館林女子・渋川・渋川女子・渋川青翠・渋川工業・藤岡中央・藤岡北・藤岡工業・富岡・富岡実業・松井田・安中総合学園・大間々・万場・下仁田・吾妻中央・長野原・嬬恋・玉村・板倉・館林商工・西邑楽(普通科・スポーツ科・芸術科))を収録。フレックススクール選抜・定時制課程選抜・連携型選抜、及び全日制の残り10校は未収録。ratioTypeは学力検査:面接等:調査書(西邑楽のスポーツ科・芸術科は実技検査を含む4項目)の割合(%)をコロン区切りで転記',
  schools: [
    // 前橋（普通科【280】男280人）
