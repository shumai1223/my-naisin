 ...
 */
describe('兵庫県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4/令和3の5年度分・grand-total-only）', () => {
  it('5年度分（令和7年度・令和6年度・令和5年度・令和4年度・令和3年度）を収録している', () => {
    expect(HYOGO_COMPETITION_RATE_HISTORY.years).toHaveLength(5);
  ...
  it('令和4年度の全日制計は令和5年度版出願状況PDFの前年度列と一致する(定員21,815・志願22,913・倍率1.05)', () => {
    const r4 = HYOGO_COMPETITION_RATE_HISTORY.years[3];
  ...
  it('令和3年度の全日制計は一次資料と一致する(定員21,320・志願22,243・倍率1.04)', () => {
    const r3 = HYOGO_COMPETITION_RATE_HISTORY.years[4];
