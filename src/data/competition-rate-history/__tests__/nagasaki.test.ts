 ...
 */
describe('長崎県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4/令和3の5年度分・grand-total-only）', () => {
  it('5年度分（令和7年度〜令和3年度）を収録している', () => {
    expect(NAGASAKI_COMPETITION_RATE_HISTORY.years).toHaveLength(5);
  ...
  it('令和7年度の合計は一次資料と一致する(一般選抜・募集人員7,372・志願者数5,953・倍率0.81)', () => {
    const r7 = NAGASAKI_COMPETITION_RATE_HISTORY.years[0];
  ...
  it('令和6年度の合計はリセモム記事と一致する(後期選抜・募集人員5,250・志願者数3,906・倍率0.74)', () => {
    const r6 = NAGASAKI_COMPETITION_RATE_HISTORY.years[1];
  ...
  it('令和5年度の合計はリセモム記事と一致する(後期選抜・募集人員5,554・志願者数4,277・倍率0.77)', () => {
    const r5 = NAGASAKI_COMPETITION_RATE_HISTORY.years[2];
  ...
  it('令和4年度の合計はリセモム記事と一致する(後期選抜・募集人員5,577・志願者数4,277・倍率0.77)', () => {
    const r4 = NAGASAKI_COMPETITION_RATE_HISTORY.years[3];
  ...
  it('令和3年度の合計はリセモム記事と一致する(後期選抜・募集人員5,527・志願者数4,350・倍率0.79)', () => {
    const r3 = NAGASAKI_COMPETITION_RATE_HISTORY.years[4];
