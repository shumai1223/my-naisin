 ...
 */
describe('佐賀県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4の4年度分・grand-total-only）', () => {
  it('4年度分（令和7年度・令和6年度・令和5年度・令和4年度）を収録している', () => {
    expect(SAGA_COMPETITION_RATE_HISTORY.years).toHaveLength(4);
  ...
  it('令和5年度の合計はリセモム記事と一致する(募集人員4,744・出願者数4,899・倍率1.03)', () => {
    const r5 = SAGA_COMPETITION_RATE_HISTORY.years[2];
  ...
  it('令和4年度の合計はリセモム記事と一致する(募集人員4,742・出願者数4,919・倍率1.04)', () => {
    const r4 = SAGA_COMPETITION_RATE_HISTORY.years[3];
