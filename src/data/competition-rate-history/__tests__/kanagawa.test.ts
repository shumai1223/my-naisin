 ...
 * （カナロコ報道記事・令和8年度別紙1の前年度列・令和7年度別紙1の前年度列）と
 * 一致することを固定値で確認する。
 */
describe('神奈川県 多年度アーカイブ（Λ-4・令和7/令和6年度分・grand-total-only）', () => {
  it('2年度分（令和7年度・令和6年度）を収録している', () => {
    expect(KANAGAWA_COMPETITION_RATE_HISTORY.years).toHaveLength(2);
