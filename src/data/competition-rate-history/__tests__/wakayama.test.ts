 ...
 */
describe('和歌山県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4/令和3の5年度分・grand-total-only）', () => {
  it('5年度分（令和7年度・令和6年度・令和5年度・令和4年度・令和3年度）を収録している', () => {
    expect(WAKAYAMA_COMPETITION_RATE_HISTORY.years).toHaveLength(5);
  ...
  it('令和4年度の合計は一次資料と一致する(入学者枠数6,042・本出願者数5,392・倍率0.89)', () => {
    const r4 = WAKAYAMA_COMPETITION_RATE_HISTORY.years[3];
  ...
  it('令和3年度の合計は一次資料と一致する(入学者枠数6,063・本出願者数5,389・倍率0.89)', () => {
    const r3 = WAKAYAMA_COMPETITION_RATE_HISTORY.years[4];
