 ...
 */
describe('滋賀県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4/令和3/令和2の6年度分・grand-total-only）', () => {
  it('6年度分（令和7年度・令和6年度・令和5年度・令和4年度・令和3年度・令和2年度）を収録している', () => {
    expect(SHIGA_COMPETITION_RATE_HISTORY.years).toHaveLength(6);
  ...
  it('令和4年度の合計はリセモム記事と一致する(学力検査定員6,308・出願者数6,912・倍率1.09)', () => {
    const r4 = SHIGA_COMPETITION_RATE_HISTORY.years[3];
  ...
  it('令和3年度の合計はリセモム記事と一致する(学力検査定員6,004・出願者数6,602・倍率1.10)', () => {
    const r3 = SHIGA_COMPETITION_RATE_HISTORY.years[4];
  ...
  it('令和2年度の合計は一次資料と一致する(学力検査定員6,379・確定出願者数6,928・倍率1.09)', () => {
    const r2 = SHIGA_COMPETITION_RATE_HISTORY.years[5];
