 ...
 */
describe('福井県 多年度アーカイブ（Λ-4・令和7/令和6/令和5/令和4/令和3の5年度分・grand-total-only）', () => {
  it('5年度分（令和7年度・令和6年度・令和5年度・令和4年度・令和3年度）を収録している', () => {
    expect(FUKUI_COMPETITION_RATE_HISTORY.years).toHaveLength(5);
  ...
  it('令和3年度の全日制合計はリセモム記事と一致する(募集人員3,791・志願3,836・倍率1.01)', () => {
    const r3 = FUKUI_COMPETITION_RATE_HISTORY.years[4];
