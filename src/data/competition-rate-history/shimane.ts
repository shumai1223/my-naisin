...
/**
 * 令和8年度（2026年度）: 既存Y-6 competition-rates/shimane.tsが確定済みのofficialSubtotals「合計」行(35校=県立34校+市立1校・R7と同一校数)をそのまま転記（新規リサーチ不要・2026-08-05発見）。
 */
const REIWA_8: YearSnapshot = {
  fiscalYear: '令和8年度（2026年度）',
  sourceUrl: 'https://www.pref.shimane.lg.jp/education/kyoiku/senbatsu/senbatsu_info/kanendosenbatsu.data/01_R8_henkougoitiran_teisei.pdf',
  sourceTitle: '島根県教育委員会 令和８年度島根県公立高等学校入学者選抜 一般選抜出願者数（志願変更後）',
  fetchedAt: '2026-08-05',
  origin: 'current-year-column',
  granularity: 'grand-total-only',
  categories: [],
  grandTotal: { label: '全日制 本校（35校＝県立34校＋市立1校）', quota: 3084, schoolCount: 35, applicants: 2493, rate: 0.81 },
};
...
/**
 * 令和3年度（2021年度）: 4年→5年横展開。R4/R5と同じ理由（一次PDFが多段見出し表でOsaka型
 * 誤読リスクに該当）でR4/R5/R6/R7と同一シリーズのリセモム確定記事（2021年2月19日発表）を
 * WebFetchで直接引用。全日制全体: 募集定員4,140・出願者数3,755・志願倍率0.91
 * （3755/4140=0.9070…≈0.91で整合。記事本文にも同数値が明記）。
 */
const REIWA_3: YearSnapshot = {
  fiscalYear: '令和3年度（2021年度）',
  sourceUrl: 'https://resemom.jp/article/2021/02/19/60552.html',
  sourceTitle:
    'リセモム「【高校受験2021】島根県公立高、一般選抜の志願倍率（確定）松江北（理数）1.38倍」（島根県教育委員会 令和3年度一般選抜出願状況の発表を引用）',
  fetchedAt: '2026-08-03',
  origin: 'current-year-column',
  granularity: 'grand-total-only',
  categories: [],
