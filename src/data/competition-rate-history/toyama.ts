...
/**
 * 令和8年度（2026年度）: 既存Y-6 competition-rates/toyama.tsが確定済みのofficialSubtotals「全日制計」行(34校・R7と同一校数)をそのまま転記（新規リサーチ不要・2026-08-05発見）。
 */
const REIWA_8: YearSnapshot = {
  fiscalYear: '令和8年度（2026年度）',
  sourceUrl: 'https://www.pref.toyama.jp/documents/47208/080224.pdf',
  sourceTitle: '富山県教育委員会 令和8年度富山県立高等学校入学者選抜 全日制の課程一般入学者選抜志願状況（令和8年2月24日正午現在）',
  fetchedAt: '2026-08-05',
  origin: 'current-year-column',
  granularity: 'grand-total-only',
  categories: [],
  grandTotal: { label: '合計（34校82学科）', quota: 5020, applicants: 4482, rate: 0.89 },
};
...
/**
 * 令和2年度（2020年度）: 5年→6年横展開。教委旧サイト（kengaku.tym.ed.jp）のR2発表資料
 * アーカイブページ（archives/399）経由で同一シリーズの一次PDF（r020225.pdf・令和2年2月25日
 * 正午現在・全3頁）を発見・Read toolで直読み成功。「合計 34校82学科」行（推薦入学内定者数
 * 1,118を除いた募集人数5,544・志願者数5,928・倍率1.07）を転記（5928/5544=1.0693…≈1.07で
 * 印字済み値と整合）。3頁目の大学科別内訳表の合計行（募集定員6,662/推薦内定1,118/募集人数
 * 5,544/志願者数5,928/倍率1.07）とも完全一致し、同一資料内の二重検証が取れている。定時制・
 * 通信制課程はR3〜R7と同じ理由でスコープ外。
 */
const REIWA_2: YearSnapshot = {
  fiscalYear: '令和2年度（2020年度）',
  sourceUrl: 'https://www.kengaku.tym.ed.jp/wp-content/uploads/2020/03/r020225.pdf',
  sourceTitle: '富山県教育委員会 令和2年度富山県立高等学校入学者選抜 全日制の課程一般入学者選抜志願状況（令和2年2月25日正午現在）',
  fetchedAt: '2026-08-03',
  origin: 'current-year-column',
  granularity: 'grand-total-only',
  categories: [],
  grandTotal: { label: '合計（34校82学科）', quota: 5544, applicants: 5928, rate: 1.07 },
};
