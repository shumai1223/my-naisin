...
export const GUNMA_TEIJI_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  coverage: {
    ...
    note: '3頁目上段「定時制課程選抜志願状況」の全13レコードを完全収録。同頁下段の連携型選抜実施校（尾瀬・万場・嬬恋）は別制度のため未収録。' +
      '2026-09-23にT-P1通信制拡張の調査: 群馬県立前橋清陵・高崎・桐生・太田フレックスの4校に' +
      '公立通信制課程が存在することを確認したが、県教委の「志願状況等の情報」ハブページ' +
      '（R6/R7/R8いずれの年度版も同一の見出し文言）が明記する対象は' +
      '「全日制課程選抜、フレックススクール選抜、定時制課程選抜、連携型選抜」の4区分のみで、' +
      '通信制課程選抜は対象外。出願期間も他選抜（1〜2月）より遅い3月と確認しており、' +
      '別建ての公表がある可能性を探したが該当ページ・PDFを発見できず、捏造回避のため未収録。',
  },
  records: [
