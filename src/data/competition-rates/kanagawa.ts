 ...
 * 次回以降のセッションで横展開する。
 *
 * **2026-08-08追記(掛-1・kanagawa R5横展開第3弾・完結)**: sheet3「単位制」（普通科17校(戸塚一般
 * コース含む)+専門コース1校(戸塚音楽コース)+総合学科8校+専門学科11学科11校+連携募集2校=計38
 * レコード）を追加。R5にも「横浜旭陵」(quota231/apps217)が単位制普通科として存在（R6・R5とも
 * 同校が在籍・R7で消滅というR6での発見と整合）。連携募集2校(光陵/愛川)は共に1/30時点=最終値と
 * 完全一致(quota=apps=40/45、志願変更を行わない設計のため)。全ての印字済み小計・合計
 * （普通科単位制計4,331/5,217・総合学科単位制計2,055/2,213・農業単位制合計156/128・
 * 音楽コース39/43・国際関係単位制計158/189・連携募集合計85/85）が完全一致（node.js機械計算）。
 * **これでbessi3.xlsx(R5)全体（sheet1〜3）が完結し、kanagawaのR5学校粒度データが確定した
 * （kanagawaはこれでR5-R8の4年度が揃った）。**
 *
 * **2026-09-12追記(T-Y11F §11払底時の逃げ場・項目1・掛-1横展開R4第1弾)**: R4(令和4年度)版の
 * 別紙3を`pref.kanagawa.jp/docs/dc4/prs/koko/r6969952.html`（現在は404・WebSearchで再発見）
 * からリンクされるxlsx(documents/76292/bessi3.xlsx相当)をWayback Machine経由で取得し
 * sheet1「普通科・クリエイティブ」を追加した。**重要な発見**: 過去セッションが記録した
 * 「学科名がdrawing.xmlの浮動テキストボックス」という仮説はXML内容を精査した結果誤りと
 * 判明・撤回（drawing1/2.xmlはページタイトルと脚注が1個ずつあるのみ）。真の構造は
 * 「普通科（クリエイティブスクールを除く）」区分がB列に学校名でなく3桁の数値コードのみを
 * 印字し、このコードは`kanagaku.com`で確認した公式「学校整理番号」(001-166)とは無関係
 * （240-410台まで出現）で当該配布物限りの印字順コードと判明、デコード不能。よって既存
 * R5データが確立した地区ごとの学校並び順（年度をまたいで安定していることをR5↔R8比較で
 * 確認済み）に位置対応させ、10地区・県立89校（横浜北13・横浜中10・横浜南6・川崎9・
 * 横須賀三浦5・鎌倉藤沢茅ヶ崎12・平塚秦野伊勢原8・県西4・県央13・相模原9）＋市立6校
 * （横浜市立3+川崎市立3）＋クリエイティブスクール5校（学校名はこの区分のみ直接印字済み）
 * ＝計100レコードを収録した。相模原地区のみ他年度の8校でなく9校（R5比+1）で、これは
 * 令和5年度(2023年度)4月に相模原総合高校が城山高校と再編統合し「相模原城山」（単位制）に
 * 改編される直前の最後の年度のため、廃校前の城山高校（普通科・全日制）が独立して存在した
...
export const KANAGAWA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8: 全13ページ中1〜10ページ目(全日制対象範囲)をpdftoppm 150dpiでレンダリングし
      // 目視確認。各ページ内は「地区の学校名列挙順」がそのままデータ配列順と完全一致(西尾のような
      // 配列末尾追記アノマリーはkanagawaには存在しない)。複数コース設置校(神奈川総合・横浜国際等)は
      // 印字済み「計」行の位置をrowIndexに採用(既存の「計行採用方式」の値は変更していない)。
      pdfSha256: 'afb7003c5deab9f3e05fb12d645633af18af1059c0016407e4f8e8d27ac1d148',
    },
    {
    ...
    },
    {
      ...
      docTitle:
        '神奈川県教育委員会 令和5年度神奈川県公立高等学校入学者選抜一般募集共通選抜等志願変更締切時志願状況（別紙3・sheet1〜3完全収録・掛-1・kanagawa横展開R5第1〜3弾・完結・Wayback Machine経由で取得）',
      fiscalYear: '令和5年度（2023年度）',
      fetchedAt: '2026-08-08',
    },
    {
      url: 'https://www.pref.kanagawa.jp/docs/dc4/prs/koko/r6969952.html',
      docTitle:
        '神奈川県教育委員会 令和4年度神奈川県公立高等学校入学者選抜一般募集共通選抜等の志願者数（志願変更締切時）について（別紙3・sheet1「普通科・クリエイティブ」収録・T-Y11F §11・掛-1横展開R4第1弾・Wayback Machine経由で取得。現在ページは404）',
  ...
  records: [
    // ===== 普通科（共通選抜）県立87校 =====
    // --- 横浜北（13校） ---
    { schoolName: '鶴見', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 381, finalRate: 1.2, page: 1, rowIndex: 0 },
    { schoolName: '横浜翠嵐', area: '横浜北', department: '普通科', quota: 359, finalApplicants: 736, finalRate: 2.05, page: 1, rowIndex: 1 },
    { schoolName: '城郷', area: '横浜北', department: '普通科', quota: 238, finalApplicants: 277, finalRate: 1.16, page: 1, rowIndex: 2 },
    { schoolName: '港北', area: '横浜北', department: '普通科', quota: 358, finalApplicants: 478, finalRate: 1.34, page: 1, rowIndex: 3 },
    { schoolName: '新羽', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 450, finalRate: 1.13, page: 1, rowIndex: 4 },
    { schoolName: '岸根', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 427, finalRate: 1.34, page: 1, rowIndex: 5 },
    { schoolName: '霧が丘', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 339, finalRate: 1.07, page: 1, rowIndex: 6 },
    { schoolName: '白山', area: '横浜北', department: '普通科', quota: 238, finalApplicants: 224, finalRate: 0.94, page: 1, rowIndex: 7 },
    { schoolName: '市ケ尾', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 515, finalRate: 1.29, page: 1, rowIndex: 8 },
    { schoolName: '元石川', area: '横浜北', department: '普通科', quota: 358, finalApplicants: 432, finalRate: 1.21, page: 1, rowIndex: 9 },
    { schoolName: '川和', area: '横浜北', department: '普通科', quota: 359, finalApplicants: 452, finalRate: 1.26, page: 1, rowIndex: 10 },
    { schoolName: '荏田', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 473, finalRate: 1.19, page: 1, rowIndex: 11 },
    { schoolName: '新栄', area: '横浜北', department: '普通科', quota: 346, finalApplicants: 359, finalRate: 1.04, page: 1, rowIndex: 12 },

    // --- 横浜中（11校） ---
    { schoolName: '希望ケ丘', area: '横浜中', department: '普通科', quota: 359, finalApplicants: 527, finalRate: 1.47, page: 1, rowIndex: 13 },
    { schoolName: '二俣川', area: '横浜中', department: '普通科', quota: 118, finalApplicants: 94, finalRate: 0.8, page: 1, rowIndex: 14 },
    { schoolName: '旭', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 326, finalRate: 1.03, page: 1, rowIndex: 15 },
    { schoolName: '松陽', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 410, finalRate: 1.29, page: 1, rowIndex: 16 },
    { schoolName: '横浜瀬谷', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 378, finalRate: 1.19, page: 1, rowIndex: 17 },
    { schoolName: '横浜平沼', area: '横浜中', department: '普通科', quota: 319, finalApplicants: 443, finalRate: 1.39, page: 1, rowIndex: 18 },
    { schoolName: '光陵', area: '横浜中', department: '普通科', quota: 279, finalApplicants: 380, finalRate: 1.36, page: 1, rowIndex: 19 },
    { schoolName: '保土ケ谷', area: '横浜中', department: '普通科', quota: 238, finalApplicants: 249, finalRate: 1.05, page: 1, rowIndex: 20 },
    { schoolName: '舞岡', area: '横浜中', department: '普通科', quota: 358, finalApplicants: 364, finalRate: 1.02, page: 1, rowIndex: 21 },
    { schoolName: '上矢部', area: '横浜中', department: '普通科', quota: 238, finalApplicants: 243, finalRate: 1.02, page: 1, rowIndex: 22 },
    { schoolName: '金井', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 358, finalRate: 1.13, page: 1, rowIndex: 23 },

    // --- 横浜南（5校） ---
    { schoolName: '横浜南陵', area: '横浜南', department: '普通科', quota: 238, finalApplicants: 272, finalRate: 1.14, page: 1, rowIndex: 24 },
    { schoolName: '柏陽', area: '横浜南', department: '普通科', quota: 319, finalApplicants: 503, finalRate: 1.58, page: 1, rowIndex: 25 },
    { schoolName: '横浜緑ケ丘', area: '横浜南', department: '普通科', quota: 279, finalApplicants: 433, finalRate: 1.55, page: 1, rowIndex: 26 },
    { schoolName: '横浜立野', area: '横浜南', department: '普通科', quota: 278, finalApplicants: 336, finalRate: 1.21, page: 1, rowIndex: 27 },
    { schoolName: '横浜氷取沢', area: '横浜南', department: '普通科', quota: 358, finalApplicants: 428, finalRate: 1.2, page: 1, rowIndex: 28 },

    // --- 川崎（9校） ---
    { schoolName: '新城', area: '川崎', department: '普通科', quota: 268, finalApplicants: 440, finalRate: 1.64, page: 1, rowIndex: 29 },
    { schoolName: '住吉', area: '川崎', department: '普通科', quota: 358, finalApplicants: 440, finalRate: 1.23, page: 1, rowIndex: 30 },
    { schoolName: '川崎北', area: '川崎', department: '普通科', quota: 278, finalApplicants: 255, finalRate: 0.92, page: 1, rowIndex: 31 },
    { schoolName: '多摩', area: '川崎', department: '普通科', quota: 279, finalApplicants: 491, finalRate: 1.76, page: 1, rowIndex: 32 },
    { schoolName: '生田', area: '川崎', department: '普通科', quota: 398, finalApplicants: 470, finalRate: 1.18, page: 1, rowIndex: 33 },
    { schoolName: '百合丘', area: '川崎', department: '普通科', quota: 398, finalApplicants: 384, finalRate: 0.96, page: 1, rowIndex: 34 },
    { schoolName: '生田東', area: '川崎', department: '普通科', quota: 318, finalApplicants: 335, finalRate: 1.05, page: 1, rowIndex: 35 },
    { schoolName: '菅', area: '川崎', department: '普通科', quota: 278, finalApplicants: 162, finalRate: 0.58, page: 1, rowIndex: 36 },
    { schoolName: '麻生', area: '川崎', department: '普通科', quota: 318, finalApplicants: 318, finalRate: 1.0, page: 1, rowIndex: 37 },

    // --- 横須賀・三浦（5校） ---
    { schoolName: '横須賀', area: '横須賀三浦', department: '普通科', quota: 279, finalApplicants: 348, finalRate: 1.25, page: 2, rowIndex: 0 },
    { schoolName: '横須賀大津', area: '横須賀三浦', department: '普通科', quota: 278, finalApplicants: 321, finalRate: 1.15, page: 2, rowIndex: 1 },
    { schoolName: '追浜', area: '横須賀三浦', department: '普通科', quota: 318, finalApplicants: 349, finalRate: 1.1, page: 2, rowIndex: 2 },
    { schoolName: '津久井浜', area: '横須賀三浦', department: '普通科', quota: 238, finalApplicants: 281, finalRate: 1.18, page: 2, rowIndex: 3 },
    { schoolName: '逗子葉山', area: '横須賀三浦', department: '普通科', quota: 318, finalApplicants: 364, finalRate: 1.14, page: 2, rowIndex: 4 },

    // --- 鎌倉・藤沢・茅ケ崎（11校） ---
    { schoolName: '鎌倉', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 359, finalApplicants: 441, finalRate: 1.23, page: 2, rowIndex: 5 },
    { schoolName: '七里ガ浜', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 358, finalApplicants: 529, finalRate: 1.48, page: 2, rowIndex: 6 },
    { schoolName: '大船', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 398, finalApplicants: 471, finalRate: 1.18, page: 2, rowIndex: 7 },
    { schoolName: '湘南', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 359, finalApplicants: 593, finalRate: 1.65, page: 2, rowIndex: 8 },
    { schoolName: '藤沢西', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 318, finalApplicants: 379, finalRate: 1.19, page: 2, rowIndex: 9 },
    { schoolName: '湘南台', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 238, finalApplicants: 273, finalRate: 1.15, page: 2, rowIndex: 10 },
    { schoolName: '茅ケ崎', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 278, finalApplicants: 337, finalRate: 1.21, page: 2, rowIndex: 11 },
    { schoolName: '茅ケ崎北陵', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 279, finalApplicants: 371, finalRate: 1.33, page: 2, rowIndex: 12 },
    { schoolName: '鶴嶺', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 383, finalApplicants: 438, finalRate: 1.14, page: 2, rowIndex: 13 },
    { schoolName: '茅ケ崎西浜', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 358, finalApplicants: 371, finalRate: 1.04, page: 2, rowIndex: 14 },
    { schoolName: '寒川', area: '鎌倉藤沢茅ケ崎', department: '普通科', quota: 238, finalApplicants: 132, finalRate: 0.55, page: 2, rowIndex: 15 },

    // --- 平塚・秦野・伊勢原（8校） ---
    { schoolName: '平塚江南', area: '平塚秦野伊勢原', department: '普通科', quota: 319, finalApplicants: 374, finalRate: 1.17, page: 2, rowIndex: 16 },
    { schoolName: '高浜', area: '平塚秦野伊勢原', department: '普通科', quota: 228, finalApplicants: 249, finalRate: 1.09, page: 2, rowIndex: 17 },
    { schoolName: '大磯', area: '平塚秦野伊勢原', department: '普通科', quota: 278, finalApplicants: 346, finalRate: 1.24, page: 2, rowIndex: 18 },
    { schoolName: '二宮', area: '平塚秦野伊勢原', department: '普通科', quota: 238, finalApplicants: 84, finalRate: 0.35, page: 2, rowIndex: 19 },
    { schoolName: '秦野', area: '平塚秦野伊勢原', department: '普通科', quota: 358, finalApplicants: 414, finalRate: 1.16, page: 2, rowIndex: 20 },
    { schoolName: '秦野曽屋', area: '平塚秦野伊勢原', department: '普通科', quota: 278, finalApplicants: 247, finalRate: 0.89, page: 2, rowIndex: 21 },
    { schoolName: '伊勢原', area: '平塚秦野伊勢原', department: '普通科', quota: 228, finalApplicants: 255, finalRate: 1.12, page: 2, rowIndex: 22 },
    { schoolName: '伊志田', area: '平塚秦野伊勢原', department: '普通科', quota: 308, finalApplicants: 331, finalRate: 1.07, page: 2, rowIndex: 23 },

    // --- 県西（4校） ---
    { schoolName: '小田原東', area: '県西', department: '普通科', quota: 118, finalApplicants: 67, finalRate: 0.57, page: 2, rowIndex: 24 },
    { schoolName: '西湘', area: '県西', department: '普通科', quota: 348, finalApplicants: 340, finalRate: 0.98, page: 2, rowIndex: 25 },
    { schoolName: '足柄', area: '県西', department: '普通科', quota: 238, finalApplicants: 239, finalRate: 1.0, page: 2, rowIndex: 26 },
    { schoolName: '山北', area: '県西', department: '普通科', quota: 198, finalApplicants: 153, finalRate: 0.77, page: 2, rowIndex: 27 },

    // --- 県央（13校） ---
    { schoolName: '厚木', area: '県央', department: '普通科', quota: 359, finalApplicants: 450, finalRate: 1.25, page: 2, rowIndex: 28 },
    { schoolName: '厚木王子', area: '県央', department: '普通科', quota: 198, finalApplicants: 214, finalRate: 1.08, page: 2, rowIndex: 29 },
    { schoolName: '厚木北', area: '県央', department: '普通科', quota: 238, finalApplicants: 253, finalRate: 1.06, page: 2, rowIndex: 30 },
    { schoolName: '厚木西', area: '県央', department: '普通科', quota: 238, finalApplicants: 204, finalRate: 0.86, page: 2, rowIndex: 31 },
    { schoolName: '海老名', area: '県央', department: '普通科', quota: 398, finalApplicants: 473, finalRate: 1.19, page: 2, rowIndex: 32 },
    { schoolName: '有馬', area: '県央', department: '普通科', quota: 318, finalApplicants: 345, finalRate: 1.08, page: 2, rowIndex: 33 },
    { schoolName: '愛川', area: '県央', department: '普通科', quota: 178, finalApplicants: 97, finalRate: 0.54, page: 2, rowIndex: 34 },
    { schoolName: '大和', area: '県央', department: '普通科', quota: 279, finalApplicants: 379, finalRate: 1.36, page: 2, rowIndex: 35 },
    { schoolName: '大和南', area: '県央', department: '普通科', quota: 308, finalApplicants: 307, finalRate: 1.0, page: 2, rowIndex: 36 },
    { schoolName: '大和西', area: '県央', department: '普通科', quota: 278, finalApplicants: 321, finalRate: 1.15, page: 2, rowIndex: 37 },
    { schoolName: '座間', area: '県央', department: '普通科', quota: 318, finalApplicants: 421, finalRate: 1.32, page: 2, rowIndex: 38 },
    { schoolName: '綾瀬', area: '県央', department: '普通科', quota: 318, finalApplicants: 324, finalRate: 1.02, page: 2, rowIndex: 39 },
    { schoolName: '綾瀬西', area: '県央', department: '普通科', quota: 318, finalApplicants: 288, finalRate: 0.91, page: 2, rowIndex: 40 },

    // --- 相模原（8校） ---
    { schoolName: '麻溝台', area: '相模原', department: '普通科', quota: 358, finalApplicants: 419, finalRate: 1.17, page: 3, rowIndex: 0 },
    { schoolName: '上鶴間', area: '相模原', department: '普通科', quota: 278, finalApplicants: 287, finalRate: 1.03, page: 3, rowIndex: 1 },
    { schoolName: '上溝', area: '相模原', department: '普通科', quota: 238, finalApplicants: 278, finalRate: 1.17, page: 3, rowIndex: 2 },
    { schoolName: '相模原', area: '相模原', department: '普通科', quota: 279, finalApplicants: 360, finalRate: 1.29, page: 3, rowIndex: 3 },
    { schoolName: '上溝南', area: '相模原', department: '普通科', quota: 358, finalApplicants: 383, finalRate: 1.07, page: 3, rowIndex: 4 },
    { schoolName: '橋本', area: '相模原', department: '普通科', quota: 268, finalApplicants: 314, finalRate: 1.17, page: 3, rowIndex: 5 },
    { schoolName: '相模田名', area: '相模原', department: '普通科', quota: 278, finalApplicants: 267, finalRate: 0.96, page: 3, rowIndex: 6 },
    { schoolName: '津久井', area: '相模原', department: '普通科', quota: 158, finalApplicants: 59, finalRate: 0.37, page: 3, rowIndex: 7 },

    // ===== 普通科（共通選抜）市立5校 =====
    { schoolName: '横浜市立桜丘', area: '横浜市立', department: '普通科', quota: 318, finalApplicants: 390, finalRate: 1.23, page: 3, rowIndex: 8 },
    { schoolName: '横浜市立金沢', area: '横浜市立', department: '普通科', quota: 318, finalApplicants: 413, finalRate: 1.3, page: 3, rowIndex: 9 },
    { schoolName: '川崎市立橘', area: '川崎市立', department: '普通科', quota: 198, finalApplicants: 286, finalRate: 1.44, page: 3, rowIndex: 10 },
    { schoolName: '川崎市立高津', area: '川崎市立', department: '普通科', quota: 278, finalApplicants: 349, finalRate: 1.26, page: 3, rowIndex: 11 },
    { schoolName: '川崎市立幸', area: '川崎市立', department: '普通科', quota: 118, finalApplicants: 165, finalRate: 1.4, page: 3, rowIndex: 12 },

    // ===== 普通科（クリエイティブスクール・4校） =====
    { schoolName: '釜利谷', area: '横浜市', department: '普通科（クリエイティブスクール）', quota: 238, finalApplicants: 113, finalRate: 0.47, page: 3, rowIndex: 13 },
    { schoolName: '横須賀南', area: '横須賀市', department: '普通科（クリエイティブスクール）', quota: 118, finalApplicants: 115, finalRate: 0.97, page: 3, rowIndex: 14 },
    { schoolName: '小田原北', area: '小田原市', department: '普通科（クリエイティブスクール）', quota: 78, finalApplicants: 73, finalRate: 0.94, page: 3, rowIndex: 15 },
    { schoolName: '大和東', area: '大和市', department: '普通科（クリエイティブスクール）', quota: 238, finalApplicants: 224, finalRate: 0.94, page: 3, rowIndex: 16 },

    // ===== 専門学科（農業・3校） =====
    { schoolName: '平塚農商', area: '平塚', department: '農業科', quota: 152, finalApplicants: 168, finalRate: 1.11, page: 4, rowIndex: 0 },
    { schoolName: '相原', area: '相模原', department: '農業科', quota: 114, finalApplicants: 138, finalRate: 1.21, page: 4, rowIndex: 1 },
    { schoolName: '中央農業', area: '海老名', department: '農業科', quota: 194, finalApplicants: 182, finalRate: 0.94, page: 4, rowIndex: 2 },

    // ===== 専門学科（工業・10校） =====
    { schoolName: '神奈川工業', area: '横浜市', department: '工業科', quota: 312, finalApplicants: 354, finalRate: 1.13, page: 4, rowIndex: 3 },
    { schoolName: '商工', area: '藤沢市', department: '工業科', quota: 118, finalApplicants: 102, finalRate: 0.86, page: 4, rowIndex: 4 },
    { schoolName: '磯子工業', area: '横浜市', department: '工業科', quota: 224, finalApplicants: 212, finalRate: 0.95, page: 4, rowIndex: 5 },
    { schoolName: '川崎工科', area: '川崎市', department: '工業科', quota: 238, finalApplicants: 248, finalRate: 1.04, page: 4, rowIndex: 6 },
    { schoolName: '向の岡工業', area: '川崎市', department: '工業科', quota: 234, finalApplicants: 181, finalRate: 0.77, page: 4, rowIndex: 7 },
    { schoolName: '横須賀工業', area: '横須賀市', department: '工業科', quota: 232, finalApplicants: 179, finalRate: 0.77, page: 5, rowIndex: 0 },
    { schoolName: '平塚工科', area: '平塚市', department: '工業科', quota: 238, finalApplicants: 127, finalRate: 0.53, page: 5, rowIndex: 1 },
    { schoolName: '藤沢工科', area: '藤沢市', department: '工業科', quota: 238, finalApplicants: 161, finalRate: 0.68, page: 5, rowIndex: 2 },
    { schoolName: '小田原北', area: '小田原市', department: '工業科', quota: 152, finalApplicants: 117, finalRate: 0.77, page: 5, rowIndex: 3 },
    { schoolName: '川崎市立川崎総合科学', area: '川崎市', department: '工業科', quota: 195, finalApplicants: 193, finalRate: 0.99, page: 5, rowIndex: 4 },

    // ===== 専門学科（商業・7校） =====
    { schoolName: '商工', area: '藤沢市', department: '商業科', quota: 118, finalApplicants: 106, finalRate: 0.9, page: 5, rowIndex: 5 },
    { schoolName: '平塚農商', area: '平塚', department: '商業科', quota: 158, finalApplicants: 164, finalRate: 1.04, page: 5, rowIndex: 6 },
    { schoolName: '小田原東', area: '県西', department: '商業科', quota: 118, finalApplicants: 75, finalRate: 0.64, page: 5, rowIndex: 7 },
    { schoolName: '相原', area: '相模原', department: '商業科', quota: 118, finalApplicants: 136, finalRate: 1.15, page: 5, rowIndex: 8 },
    { schoolName: '厚木王子', area: '県央', department: '商業科', quota: 158, finalApplicants: 184, finalRate: 1.16, page: 5, rowIndex: 9 },
    { schoolName: '横浜市立横浜商業', area: '横浜市立', department: '商業科', quota: 238, finalApplicants: 274, finalRate: 1.15, page: 5, rowIndex: 10 },
    { schoolName: '川崎市立幸', area: '川崎市立', department: '商業科', quota: 118, finalApplicants: 139, finalRate: 1.18, page: 5, rowIndex: 11 },

    // ===== 専門学科（水産・1校） =====
    { schoolName: '海洋科学', area: '横須賀市', department: '水産科', quota: 152, finalApplicants: 141, finalRate: 0.93, page: 6, rowIndex: 0 },

    // ===== 専門学科（家庭・1校） =====
    { schoolName: '川崎市立川崎', area: '川崎市立', department: '家庭科', quota: 39, finalApplicants: 31, finalRate: 0.79, page: 6, rowIndex: 1 },

    // ===== 専門学科（福祉・4校） =====
    { schoolName: '二俣川', area: '横浜中', department: '福祉科', quota: 38, finalApplicants: 28, finalRate: 0.74, page: 6, rowIndex: 2 },
    { schoolName: '横須賀南', area: '横須賀市', department: '福祉科', quota: 78, finalApplicants: 48, finalRate: 0.62, page: 6, rowIndex: 3 },
    { schoolName: '津久井', area: '相模原', department: '福祉科', quota: 38, finalApplicants: 15, finalRate: 0.39, page: 6, rowIndex: 4 },
    { schoolName: '川崎市立川崎', area: '川崎市立', department: '福祉科', quota: 39, finalApplicants: 37, finalRate: 0.95, page: 6, rowIndex: 5 },

    // ===== 専門学科（理数・1校） =====
    { schoolName: '川崎市立川崎総合科学', area: '川崎市立', department: '理数科', quota: 39, finalApplicants: 53, finalRate: 1.36, page: 6, rowIndex: 6 },

    // ===== 専門学科（体育・2校） =====
    { schoolName: '厚木北', area: '県央', department: '体育科', quota: 38, finalApplicants: 46, finalRate: 1.21, page: 7, rowIndex: 0 },
    { schoolName: '川崎市立橘', area: '川崎市立', department: '体育科', quota: 39, finalApplicants: 49, finalRate: 1.26, page: 7, rowIndex: 1 },

    // ===== 専門学科（美術・2校） =====
    { schoolName: '白山', area: '横浜北', department: '美術科', quota: 38, finalApplicants: 35, finalRate: 0.92, page: 7, rowIndex: 2 },
    { schoolName: '上矢部', area: '横浜中', department: '美術科', quota: 38, finalApplicants: 47, finalRate: 1.24, page: 7, rowIndex: 3 },

    // ===== 専門学科（国際・2校） =====
    { schoolName: '横浜市立横浜商業', area: '横浜市立', department: '国際科', quota: 35, finalApplicants: 52, finalRate: 1.49, page: 7, rowIndex: 4 },
    { schoolName: '川崎市立橘', area: '川崎市立', department: '国際科', quota: 39, finalApplicants: 50, finalRate: 1.28, page: 7, rowIndex: 5 },

    // ===== 単位制 普通科（16校。神奈川総合は2コース・横浜市立戸塚は一般コースのみここに含む） =====
    { schoolName: '神奈川総合', area: '横浜市', department: '普通科（単位制）', quota: 208, finalApplicants: 320, finalRate: 1.54, page: 8, rowIndex: 0 },
    { schoolName: '横浜緑園', area: '横浜市', department: '普通科（単位制）', quota: 278, finalApplicants: 262, finalRate: 0.94, page: 8, rowIndex: 1 },
    { schoolName: '横浜桜陽', area: '横浜市', department: '普通科（単位制）', quota: 270, finalApplicants: 191, finalRate: 0.71, page: 8, rowIndex: 2 },
    { schoolName: '横浜清陵', area: '横浜市', department: '普通科（単位制）', quota: 305, finalApplicants: 332, finalRate: 1.09, page: 8, rowIndex: 3 },
    { schoolName: '横浜栄', area: '横浜市', department: '普通科（単位制）', quota: 318, finalApplicants: 382, finalRate: 1.2, page: 8, rowIndex: 4 },
    { schoolName: '川崎', area: '川崎市', department: '普通科（単位制）', quota: 222, finalApplicants: 284, finalRate: 1.28, page: 8, rowIndex: 5 },
    { schoolName: '大師', area: '川崎市', department: '普通科（単位制）', quota: 225, finalApplicants: 150, finalRate: 0.67, page: 8, rowIndex: 6 },
    { schoolName: '三浦初声', area: '三浦市', department: '普通科（単位制）', quota: 198, finalApplicants: 86, finalRate: 0.43, page: 8, rowIndex: 7 },
    { schoolName: '藤沢清流', area: '藤沢市', department: '普通科（単位制）', quota: 278, finalApplicants: 303, finalRate: 1.09, page: 8, rowIndex: 8 },
    { schoolName: '平塚湘風', area: '平塚市', department: '普通科（単位制）', quota: 238, finalApplicants: 170, finalRate: 0.71, page: 8, rowIndex: 9 },
    { schoolName: '小田原', area: '小田原市', department: '普通科（単位制）', quota: 319, finalApplicants: 371, finalRate: 1.16, page: 8, rowIndex: 10 },
    { schoolName: '厚木清南', area: '県央', department: '普通科（単位制）', quota: 230, finalApplicants: 234, finalRate: 1.02, page: 8, rowIndex: 11 },
    { schoolName: '相模原城山', area: '相模原', department: '普通科（単位制）', quota: 278, finalApplicants: 263, finalRate: 0.95, page: 8, rowIndex: 12 },
    { schoolName: '相模原弥栄', area: '相模原', department: '普通科（単位制）', quota: 183, finalApplicants: 191, finalRate: 1.04, page: 8, rowIndex: 13 },
    { schoolName: '横浜市立東', area: '横浜市立', department: '普通科（単位制）', quota: 268, finalApplicants: 324, finalRate: 1.21, page: 8, rowIndex: 14 },
    { schoolName: '横浜市立戸塚', area: '横浜市立', department: '普通科（単位制・一般コース）', quota: 279, finalApplicants: 341, finalRate: 1.22, page: 8, rowIndex: 15 },

    // ===== 単位制 普通科専門コース（1校） =====
    { schoolName: '横浜市立戸塚', area: '横浜市立', department: '普通科（単位制・音楽コース）', quota: 39, finalApplicants: 46, finalRate: 1.18, page: 8, rowIndex: 16 },

    // ===== 単位制 総合学科（クリエイティブ除く・7校） =====
    { schoolName: '鶴見総合', area: '横浜市', department: '総合学科（単位制）', quota: 259, finalApplicants: 302, finalRate: 1.17, page: 8, rowIndex: 17 },
    { schoolName: '金沢総合', area: '横浜市', department: '総合学科（単位制）', quota: 278, finalApplicants: 316, finalRate: 1.14, page: 8, rowIndex: 18 },
    { schoolName: '藤沢総合', area: '藤沢市', department: '総合学科（単位制）', quota: 268, finalApplicants: 320, finalRate: 1.19, page: 8, rowIndex: 19 },
    { schoolName: '秦野総合', area: '秦野市', department: '総合学科（単位制）', quota: 238, finalApplicants: 198, finalRate: 0.83, page: 8, rowIndex: 20 },
    { schoolName: '座間総合', area: '座間市', department: '総合学科（単位制）', quota: 264, finalApplicants: 261, finalRate: 0.99, page: 8, rowIndex: 21 },
    { schoolName: '横浜市立みなと総合', area: '横浜市立', department: '総合学科（単位制）', quota: 232, finalApplicants: 250, finalRate: 1.08, page: 8, rowIndex: 22 },
    { schoolName: '横須賀市立横須賀総合', area: '横須賀市立', department: '総合学科（単位制）', quota: 320, finalApplicants: 364, finalRate: 1.14, page: 8, rowIndex: 23 },

    // ===== 単位制 総合学科クリエイティブスクール（1校） =====
    { schoolName: '青葉総合', area: '横浜市', department: '総合学科（単位制・クリエイティブスクール）', quota: 158, finalApplicants: 143, finalRate: 0.91, page: 9, rowIndex: 0 },

    // ===== 単位制 専門学科（農業・2校） =====
    { schoolName: '三浦初声', area: '三浦市', department: '農業科（単位制）', quota: 38, finalApplicants: 26, finalRate: 0.68, page: 9, rowIndex: 1 },
    { schoolName: '吉田島', area: '開成町', department: '農業科（単位制）', quota: 114, finalApplicants: 79, finalRate: 0.69, page: 9, rowIndex: 2 },

    // ===== 単位制 専門学科（家庭・1校） =====
    { schoolName: '吉田島', area: '開成町', department: '家庭科（単位制）', quota: 38, finalApplicants: 34, finalRate: 0.89, page: 9, rowIndex: 3 },

    // ===== 単位制 専門学科（理数・1校） =====
    { schoolName: '横浜サイエンスフロンティア', area: '横浜市立', department: '理数科（単位制）', quota: 158, finalApplicants: 255, finalRate: 1.61, page: 9, rowIndex: 4 },

    // ===== 単位制 専門学科（体育・1校） =====
    { schoolName: '相模原弥栄', area: '相模原', department: '体育科（単位制）', quota: 78, finalApplicants: 85, finalRate: 1.09, page: 9, rowIndex: 5 },

    // ===== 単位制 専門学科（音楽・1校） =====
    { schoolName: '相模原弥栄', area: '相模原', department: '音楽科（単位制）', quota: 38, finalApplicants: 45, finalRate: 1.18, page: 9, rowIndex: 6 },

    // ===== 単位制 専門学科（美術・1校） =====
    { schoolName: '相模原弥栄', area: '相模原', department: '美術科（単位制）', quota: 38, finalApplicants: 55, finalRate: 1.45, page: 10, rowIndex: 0 },

    // ===== 単位制 専門学科（国際関係・1校） =====
    { schoolName: '横浜国際', area: '横浜市', department: '国際科（単位制）', quota: 159, finalApplicants: 190, finalRate: 1.19, page: 10, rowIndex: 1 },

    // ===== 単位制 専門学科（総合産業・1校） =====
    { schoolName: '神奈川総合産業', area: '横浜市', department: '総合産業科（単位制）', quota: 238, finalApplicants: 218, finalRate: 0.92, page: 10, rowIndex: 2 },

    // ===== 単位制 専門学科（舞台芸術・1校） =====
    { schoolName: '神奈川総合', area: '横浜市', department: '舞台芸術科（単位制）', quota: 30, finalApplicants: 37, finalRate: 1.23, page: 10, rowIndex: 3 },

    // ===== 連携募集（2校・既存校への追加募集枠。志願変更を行わないため1/30の値=最終値） =====
    { schoolName: '光陵', area: '横浜中', department: '普通科（連携募集）', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 10, rowIndex: 4 },
    { schoolName: '愛川', area: '県央', department: '普通科（連携募集）', quota: 45, finalApplicants: 31, finalRate: 0.69, page: 10, rowIndex: 5 },
    ...
    // 掛-1横展開R5第3弾・kanagawa R5完結: R5分・sheet3「単位制」(documents/95719/bessi3.xlsx・Wayback Machine経由)。
    { schoolName: '神奈川総合', area: '横浜市', department: '普通科（単位制）', quota: 208, finalApplicants: 389, finalRate: 1.87, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜旭陵', area: '横浜市', department: '普通科（単位制）', quota: 231, finalApplicants: 217, finalRate: 0.94, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜緑園', area: '横浜市', department: '普通科（単位制）', quota: 278, finalApplicants: 303, finalRate: 1.09, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜桜陽', area: '横浜市', department: '普通科（単位制）', quota: 270, finalApplicants: 304, finalRate: 1.13, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜清陵', area: '横浜市', department: '普通科（単位制）', quota: 305, finalApplicants: 411, finalRate: 1.35, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜栄', area: '横浜市', department: '普通科（単位制）', quota: 318, finalApplicants: 469, finalRate: 1.47, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '川崎', area: '川崎市', department: '普通科（単位制）', quota: 223, finalApplicants: 302, finalRate: 1.35, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '大師', area: '川崎市', department: '普通科（単位制）', quota: 228, finalApplicants: 237, finalRate: 1.04, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '三浦初声', area: '三浦市', department: '普通科（単位制）', quota: 198, finalApplicants: 196, finalRate: 0.99, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '藤沢清流', area: '藤沢市', department: '普通科（単位制）', quota: 278, finalApplicants: 335, finalRate: 1.21, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '平塚湘風', area: '平塚市', department: '普通科（単位制）', quota: 238, finalApplicants: 152, finalRate: 0.64, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '小田原', area: '小田原市', department: '普通科（単位制）', quota: 318, finalApplicants: 386, finalRate: 1.21, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '厚木清南', area: '県央', department: '普通科（単位制）', quota: 230, finalApplicants: 241, finalRate: 1.05, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '相模原城山', area: '相模原', department: '普通科（単位制）', quota: 278, finalApplicants: 284, finalRate: 1.02, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '相模原弥栄', area: '相模原', department: '普通科（単位制）', quota: 183, finalApplicants: 223, finalRate: 1.22, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜市立東', area: '横浜市立', department: '普通科（単位制）', quota: 268, finalApplicants: 409, finalRate: 1.53, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜市立戸塚', area: '横浜市立', department: '普通科（単位制・一般コース）', quota: 279, finalApplicants: 359, finalRate: 1.29, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜市立戸塚', area: '横浜市立', department: '普通科（単位制・音楽コース）', quota: 39, finalApplicants: 43, finalRate: 1.1, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '鶴見総合', area: '横浜市', department: '総合学科（単位制）', quota: 258, finalApplicants: 285, finalRate: 1.1, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '金沢総合', area: '横浜市', department: '総合学科（単位制）', quota: 278, finalApplicants: 368, finalRate: 1.32, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '麻生総合', area: '川崎市', department: '総合学科（単位制）', quota: 190, finalApplicants: 134, finalRate: 0.71, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '藤沢総合', area: '藤沢市', department: '総合学科（単位制）', quota: 271, finalApplicants: 342, finalRate: 1.26, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '秦野総合', area: '秦野市', department: '総合学科（単位制）', quota: 238, finalApplicants: 192, finalRate: 0.81, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '座間総合', area: '座間市', department: '総合学科（単位制）', quota: 268, finalApplicants: 284, finalRate: 1.06, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜市立みなと総合', area: '横浜市立', department: '総合学科（単位制）', quota: 232, finalApplicants: 289, finalRate: 1.25, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横須賀市立横須賀総合', area: '横須賀市立', department: '総合学科（単位制）', quota: 320, finalApplicants: 319, finalRate: 1, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '三浦初声', area: '三浦市', department: '農業科（単位制）', quota: 39, finalApplicants: 35, finalRate: 0.9, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '吉田島', area: '開成町', department: '農業科（単位制）', quota: 117, finalApplicants: 93, finalRate: 0.79, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '吉田島', area: '開成町', department: '家庭科（単位制）', quota: 39, finalApplicants: 31, finalRate: 0.79, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜サイエンスフロンティア', area: '横浜市立', department: '理数科（単位制）', quota: 158, finalApplicants: 253, finalRate: 1.6, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '相模原弥栄', area: '相模原', department: '体育科（単位制）', quota: 78, finalApplicants: 123, finalRate: 1.58, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '相模原弥栄', area: '相模原', department: '音楽科（単位制）', quota: 39, finalApplicants: 53, finalRate: 1.36, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '相模原弥栄', area: '相模原', department: '美術科（単位制）', quota: 39, finalApplicants: 61, finalRate: 1.56, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '横浜国際', area: '横浜市', department: '国際科（単位制）', quota: 158, finalApplicants: 189, finalRate: 1.2, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '神奈川総合産業', area: '横浜市立', department: '総合産業科（単位制）', quota: 238, finalApplicants: 265, finalRate: 1.11, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '神奈川総合', area: '横浜市', department: '舞台芸術科（単位制）', quota: 30, finalApplicants: 58, finalRate: 1.93, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '光陵', area: '横浜中', department: '普通科（連携募集）', quota: 40, finalApplicants: 40, finalRate: 1.0, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '愛川', area: '県央', department: '普通科（連携募集）', quota: 45, finalApplicants: 45, finalRate: 1.0, fiscalYear: '令和5年度（2023年度）' },

    // 掛-1横展開R4第1弾: R4分・sheet1「普通科・クリエイティブスクール」(Wayback Machine経由・地区別位置対応で学校名を復元)。
    { schoolName: '鶴見', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 474, finalRate: 1.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜翠嵐', area: '横浜北', department: '普通科', quota: 358, finalApplicants: 804, finalRate: 2.25, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '城郷', area: '横浜北', department: '普通科', quota: 238, finalApplicants: 317, finalRate: 1.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '港北', area: '横浜北', department: '普通科', quota: 358, finalApplicants: 427, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新羽', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 476, finalRate: 1.2, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岸根', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 450, finalRate: 1.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '霧が丘', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 337, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '白山', area: '横浜北', department: '普通科', quota: 278, finalApplicants: 336, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市ケ尾', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 592, finalRate: 1.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '元石川', area: '横浜北', department: '普通科', quota: 358, finalApplicants: 483, finalRate: 1.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川和', area: '横浜北', department: '普通科', quota: 318, finalApplicants: 431, finalRate: 1.36, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '荏田', area: '横浜北', department: '普通科', quota: 398, finalApplicants: 475, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新栄', area: '横浜北', department: '普通科', quota: 351, finalApplicants: 424, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '希望ケ丘', area: '横浜中', department: '普通科', quota: 358, finalApplicants: 551, finalRate: 1.54, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '旭', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 369, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松陽', area: '横浜中', department: '普通科', quota: 278, finalApplicants: 376, finalRate: 1.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜瀬谷', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 380, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜平沼', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 481, finalRate: 1.51, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '光陵', area: '横浜中', department: '普通科', quota: 278, finalApplicants: 380, finalRate: 1.37, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '保土ケ谷', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 318, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '舞岡', area: '横浜中', department: '普通科', quota: 318, finalApplicants: 386, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上矢部', area: '横浜中', department: '普通科', quota: 238, finalApplicants: 248, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '金井', area: '横浜中', department: '普通科', quota: 358, finalApplicants: 390, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜南陵', area: '横浜南', department: '普通科', quota: 278, finalApplicants: 297, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '永谷', area: '横浜南', department: '普通科', quota: 199, finalApplicants: 83, finalRate: 0.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '柏陽', area: '横浜南', department: '普通科', quota: 318, finalApplicants: 453, finalRate: 1.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜緑ケ丘', area: '横浜南', department: '普通科', quota: 278, finalApplicants: 468, finalRate: 1.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜立野', area: '横浜南', department: '普通科', quota: 278, finalApplicants: 308, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜氷取沢', area: '横浜南', department: '普通科', quota: 358, finalApplicants: 404, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新城', area: '川崎', department: '普通科', quota: 268, finalApplicants: 428, finalRate: 1.6, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '住吉', area: '川崎', department: '普通科', quota: 358, finalApplicants: 503, finalRate: 1.41, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川崎北', area: '川崎', department: '普通科', quota: 278, finalApplicants: 319, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '多摩', area: '川崎', department: '普通科', quota: 278, finalApplicants: 495, finalRate: 1.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '生田', area: '川崎', department: '普通科', quota: 358, finalApplicants: 454, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '百合丘', area: '川崎', department: '普通科', quota: 358, finalApplicants: 421, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '生田東', area: '川崎', department: '普通科', quota: 318, finalApplicants: 369, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '菅', area: '川崎', department: '普通科', quota: 358, finalApplicants: 357, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '麻生', area: '川崎', department: '普通科', quota: 318, finalApplicants: 374, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横須賀', area: '横須賀・三浦', department: '普通科', quota: 278, finalApplicants: 357, finalRate: 1.28, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横須賀大津', area: '横須賀・三浦', department: '普通科', quota: 318, finalApplicants: 336, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '追浜', area: '横須賀・三浦', department: '普通科', quota: 278, finalApplicants: 350, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '津久井浜', area: '横須賀・三浦', department: '普通科', quota: 238, finalApplicants: 283, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '逗子葉山', area: '横須賀・三浦', department: '普通科', quota: 318, finalApplicants: 366, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鎌倉', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 318, finalApplicants: 486, finalRate: 1.53, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '七里ガ浜', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 398, finalApplicants: 569, finalRate: 1.43, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大船', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 398, finalApplicants: 481, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深沢', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 238, finalApplicants: 259, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '湘南', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 358, finalApplicants: 537, finalRate: 1.5, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '藤沢西', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 278, finalApplicants: 359, finalRate: 1.29, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '湘南台', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 238, finalApplicants: 397, finalRate: 1.67, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '茅ケ崎', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 278, finalApplicants: 340, finalRate: 1.22, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '茅ケ崎北陵', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 278, finalApplicants: 420, finalRate: 1.51, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鶴嶺', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 383, finalApplicants: 417, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '茅ケ崎西浜', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 358, finalApplicants: 401, finalRate: 1.12, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '寒川', area: '鎌倉・藤沢・茅ヶ崎', department: '普通科', quota: 278, finalApplicants: 223, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '平塚江南', area: '平塚・秦野・伊勢原', department: '普通科', quota: 318, finalApplicants: 404, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '高浜', area: '平塚・秦野・伊勢原', department: '普通科', quota: 231, finalApplicants: 258, finalRate: 1.12, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大磯', area: '平塚・秦野・伊勢原', department: '普通科', quota: 278, finalApplicants: 308, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '二宮', area: '平塚・秦野・伊勢原', department: '普通科', quota: 238, finalApplicants: 233, finalRate: 0.98, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秦野', area: '平塚・秦野・伊勢原', department: '普通科', quota: 358, finalApplicants: 419, finalRate: 1.17, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秦野曽屋', area: '平塚・秦野・伊勢原', department: '普通科', quota: 278, finalApplicants: 269, finalRate: 0.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '伊勢原', area: '平塚・秦野・伊勢原', department: '普通科', quota: 228, finalApplicants: 261, finalRate: 1.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '伊志田', area: '平塚・秦野・伊勢原', department: '普通科', quota: 268, finalApplicants: 310, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小田原東', area: '県西', department: '普通科', quota: 118, finalApplicants: 98, finalRate: 0.83, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '西湘', area: '県西', department: '普通科', quota: 348, finalApplicants: 353, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足柄', area: '県西', department: '普通科', quota: 238, finalApplicants: 212, finalRate: 0.89, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '山北', area: '県西', department: '普通科', quota: 198, finalApplicants: 186, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '厚木', area: '県央', department: '普通科', quota: 358, finalApplicants: 485, finalRate: 1.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '厚木東', area: '県央', department: '普通科', quota: 198, finalApplicants: 227, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '厚木北', area: '県央', department: '普通科', quota: 238, finalApplicants: 248, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '厚木西', area: '県央', department: '普通科', quota: 238, finalApplicants: 257, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '海老名', area: '県央', department: '普通科', quota: 398, finalApplicants: 488, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '有馬', area: '県央', department: '普通科', quota: 318, finalApplicants: 351, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '愛川', area: '県央', department: '普通科', quota: 183, finalApplicants: 156, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大和', area: '県央', department: '普通科', quota: 278, finalApplicants: 400, finalRate: 1.44, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大和南', area: '県央', department: '普通科', quota: 308, finalApplicants: 367, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大和西', area: '県央', department: '普通科', quota: 278, finalApplicants: 338, finalRate: 1.22, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '座間', area: '県央', department: '普通科', quota: 278, finalApplicants: 352, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '綾瀬', area: '県央', department: '普通科', quota: 318, finalApplicants: 339, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '綾瀬西', area: '県央', department: '普通科', quota: 318, finalApplicants: 349, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '麻溝台', area: '相模原', department: '普通科', quota: 358, finalApplicants: 461, finalRate: 1.29, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上鶴間', area: '相模原', department: '普通科', quota: 278, finalApplicants: 326, finalRate: 1.17, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上溝', area: '相模原', department: '普通科', quota: 238, finalApplicants: 285, finalRate: 1.2, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '相模原', area: '相模原', department: '普通科', quota: 278, finalApplicants: 344, finalRate: 1.24, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上溝南', area: '相模原', department: '普通科', quota: 358, finalApplicants: 387, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '橋本', area: '相模原', department: '普通科', quota: 268, finalApplicants: 309, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '相模田名', area: '相模原', department: '普通科', quota: 278, finalApplicants: 285, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '城山', area: '相模原', department: '普通科', quota: 278, finalApplicants: 302, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '津久井', area: '相模原', department: '普通科', quota: 158, finalApplicants: 110, finalRate: 0.7, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜市立桜丘', area: '横浜市立', department: '普通科', quota: 318, finalApplicants: 390, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜市立南', area: '横浜市立', department: '普通科', quota: 38, finalApplicants: 59, finalRate: 1.55, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '横浜市立金沢', area: '横浜市立', department: '普通科', quota: 318, finalApplicants: 449, finalRate: 1.41, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川崎市立橘', area: '川崎市立', department: '普通科', quota: 198, finalApplicants: 247, finalRate: 1.25, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川崎市立高津', area: '川崎市立', department: '普通科', quota: 278, finalApplicants: 393, finalRate: 1.41, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川崎市立幸', area: '川崎市立', department: '普通科', quota: 118, finalApplicants: 148, finalRate: 1.25, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '田奈', area: '横浜市', department: '普通科（クリエイティブスクール）', quota: 158, finalApplicants: 76, finalRate: 0.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '釜利谷', area: '横浜市', department: '普通科（クリエイティブスクール）', quota: 238, finalApplicants: 145, finalRate: 0.61, fiscalYear: '令和4年度（2022年度）' },
