...
export const TOTTORI_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8（出典ロケータ）: 2026-09-10にPDFを再取得しSHA-256を計測（全8頁・459,130
      // バイト）。学校別詳細表は物理ページ5〜7（1〜4頁は地区別概要・8頁は定時制で対象外）。
      // 43件全レコードのpage/rowIndexは`bairitsu-ingest/parsers/tottori.ts`の`parseTottori()`
      // （`__fixtures__/tottori-r8-geometry.json`を再実行）で機械算出し、既存のquota/
      // finalApplicants/finalRateと全43件一致することを確認した上でバックフィルした
      // （既存データの値自体は一切書き換えていない）。
      pdfSha256: '5745310ec7e1a91c026d76d4ac4595a145b4a4ceb38016e439982469817466a0',
    },
    {
  ...
  records: [
    ...
    { schoolName: '鳥取西', area: '東部', department: '普通', quota: 272, finalApplicants: 308, finalRate: 1.13, page: 5, rowIndex: 1 },
    { schoolName: '鳥取商業', area: '東部', department: '商業', quota: 100, finalApplicants: 67, finalRate: 0.67, page: 5, rowIndex: 2 },
    { schoolName: '鳥取工業', area: '東部', department: '工業（機械・電気・情報工学・建設工学）（くくり募集）', quota: 104, finalApplicants: 47, finalRate: 0.45, page: 5, rowIndex: 3 },
    { schoolName: '鳥取湖陵', area: '東部', department: '食品システム', quota: 21, finalApplicants: 12, finalRate: 0.57, page: 5, rowIndex: 4 },
    { schoolName: '鳥取湖陵', area: '東部', department: '緑地デザイン', quota: 28, finalApplicants: 5, finalRate: 0.18, page: 5, rowIndex: 5 },
    { schoolName: '鳥取湖陵', area: '東部', department: '電子機械', quota: 31, finalApplicants: 13, finalRate: 0.42, page: 5, rowIndex: 6 },
    { schoolName: '鳥取湖陵', area: '東部', department: '人間環境', quota: 27, finalApplicants: 14, finalRate: 0.52, page: 5, rowIndex: 7 },
    { schoolName: '鳥取湖陵', area: '東部', department: '情報科学', quota: 24, finalApplicants: 13, finalRate: 0.54, page: 5, rowIndex: 8 },
    { schoolName: '青谷', area: '東部', department: '総合', quota: 57, finalApplicants: 9, finalRate: 0.16, page: 5, rowIndex: 9 },
    { schoolName: '岩美', area: '東部', department: '普通', quota: 55, finalApplicants: 26, finalRate: 0.47, page: 5, rowIndex: 10 },
    { schoolName: '八頭', area: '東部', department: '普通', quota: 182, finalApplicants: 139, finalRate: 0.76, page: 5, rowIndex: 11 },
    { schoolName: '智頭農林', area: '東部', department: '生産科学・森林科学（くくり募集）', quota: 57, finalApplicants: 9, finalRate: 0.16, page: 5, rowIndex: 12 },
    { schoolName: '倉吉東', area: '中部', department: '普通', quota: 170, finalApplicants: 158, finalRate: 0.93, page: 6, rowIndex: 0 },
    { schoolName: '倉吉西', area: '中部', department: '普通', quota: 96, finalApplicants: 68, finalRate: 0.71, page: 6, rowIndex: 1 },
    { schoolName: '倉吉農業', area: '中部', department: '生物', quota: 24, finalApplicants: 14, finalRate: 0.58, page: 6, rowIndex: 2 },
    { schoolName: '倉吉農業', area: '中部', department: '食品', quota: 24, finalApplicants: 11, finalRate: 0.46, page: 6, rowIndex: 3 },
    { schoolName: '倉吉農業', area: '中部', department: '環境', quota: 29, finalApplicants: 4, finalRate: 0.14, page: 6, rowIndex: 4 },
    { schoolName: '倉吉総合産業', area: '中部', department: '機械', quota: 21, finalApplicants: 12, finalRate: 0.57, page: 6, rowIndex: 5 },
    { schoolName: '倉吉総合産業', area: '中部', department: '電気', quota: 23, finalApplicants: 9, finalRate: 0.39, page: 6, rowIndex: 6 },
    { schoolName: '倉吉総合産業', area: '中部', department: 'ビジネス', quota: 19, finalApplicants: 12, finalRate: 0.63, page: 6, rowIndex: 7 },
    { schoolName: '倉吉総合産業', area: '中部', department: '生活デザイン', quota: 19, finalApplicants: 14, finalRate: 0.74, page: 6, rowIndex: 8 },
    { schoolName: '鳥取中央育英', area: '中部', department: '普通', quota: 72, finalApplicants: 47, finalRate: 0.65, page: 6, rowIndex: 9 },
    { schoolName: '米子東', area: '西部', department: '普通（生命科学）', quota: 40, finalApplicants: 48, finalRate: 1.2, page: 7, rowIndex: 0 },
    { schoolName: '米子東', area: '西部', department: '普通（普通）', quota: 240, finalApplicants: 250, finalRate: 1.04, page: 7, rowIndex: 1 },
    { schoolName: '米子西', area: '西部', department: '普通', quota: 245, finalApplicants: 302, finalRate: 1.23, page: 7, rowIndex: 2 },
    { schoolName: '米子', area: '西部', department: '総合', quota: 114, finalApplicants: 83, finalRate: 0.73, page: 7, rowIndex: 3 },
    { schoolName: '米子南', area: '西部', department: 'ＩＴビジネス', quota: 69, finalApplicants: 38, finalRate: 0.55, page: 7, rowIndex: 4 },
    { schoolName: '米子南', area: '西部', department: '生活創造（ライフデザイン）', quota: 11, finalApplicants: 20, finalRate: 1.82, page: 7, rowIndex: 5 },
    { schoolName: '米子南', area: '西部', department: '生活創造（調理）', quota: 12, finalApplicants: 14, finalRate: 1.17, page: 7, rowIndex: 6 },
    { schoolName: '米子工業', area: '西部', department: '機械', quota: 22, finalApplicants: 14, finalRate: 0.64, page: 7, rowIndex: 7 },
    { schoolName: '米子工業', area: '西部', department: '電気', quota: 21, finalApplicants: 16, finalRate: 0.76, page: 7, rowIndex: 8 },
    { schoolName: '米子工業', area: '西部', department: '情報電子', quota: 22, finalApplicants: 19, finalRate: 0.86, page: 7, rowIndex: 9 },
    { schoolName: '米子工業', area: '西部', department: '環境エネルギー', quota: 23, finalApplicants: 13, finalRate: 0.57, page: 7, rowIndex: 10 },
    { schoolName: '米子工業', area: '西部', department: '建設（土木）', quota: 10, finalApplicants: 10, finalRate: 1, page: 7, rowIndex: 11 },
    { schoolName: '米子工業', area: '西部', department: '建設（建築）', quota: 10, finalApplicants: 9, finalRate: 0.9, page: 7, rowIndex: 12 },
    { schoolName: '境', area: '西部', department: '普通', quota: 150, finalApplicants: 106, finalRate: 0.71, page: 7, rowIndex: 13 },
    { schoolName: '境港総合技術', area: '西部', department: '海洋', quota: 29, finalApplicants: 21, finalRate: 0.72, page: 7, rowIndex: 14 },
    { schoolName: '境港総合技術', area: '西部', department: '食品・ビジネス', quota: 33, finalApplicants: 19, finalRate: 0.58, page: 7, rowIndex: 15 },
    { schoolName: '境港総合技術', area: '西部', department: '機械', quota: 30, finalApplicants: 13, finalRate: 0.43, page: 7, rowIndex: 16 },
    { schoolName: '境港総合技術', area: '西部', department: '電気電子', quota: 38, finalApplicants: 0, finalRate: 0, page: 7, rowIndex: 17 },
    { schoolName: '境港総合技術', area: '西部', department: '福祉', quota: 29, finalApplicants: 12, finalRate: 0.41, page: 7, rowIndex: 18 },
    { schoolName: '日野', area: '西部', department: '総合', quota: 54, finalApplicants: 22, finalRate: 0.41, page: 7, rowIndex: 19 },
