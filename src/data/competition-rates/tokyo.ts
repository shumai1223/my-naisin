...
export const TOKYO_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  records: [
    ...
    { schoolName: '深川', area: '江東', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 104, finalRate: 1.86, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '片倉', area: '八王子', department: '普通科（コース制・造形美術）', quota: 56, finalApplicants: 73, finalRate: 1.3, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '松が谷', area: '八王子', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 66, finalRate: 1.18, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '小平', area: '小平', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 85, finalRate: 1.52, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '新宿', area: '新宿', department: '普通科（単位制）', quota: 284, finalApplicants: 637, finalRate: 2.24, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '忍岡', area: '台東', department: '普通科（単位制）', quota: 124, finalApplicants: 121, finalRate: 0.98, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '墨田川', area: '墨田', department: '普通科（単位制）', quota: 252, finalApplicants: 346, finalRate: 1.37, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '美原', area: '大田', department: '普通科（単位制）', quota: 156, finalApplicants: 196, finalRate: 1.26, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '芦花', area: '世田谷', department: '普通科（単位制）', quota: 220, finalApplicants: 434, finalRate: 1.97, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '飛鳥', area: '北', department: '普通科（単位制）', quota: 170, finalApplicants: 191, finalRate: 1.12, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '板橋有徳', area: '板橋', department: '普通科（単位制）', quota: 156, finalApplicants: 139, finalRate: 0.89, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '大泉桜', area: '練馬', department: '普通科（単位制）', quota: 156, finalApplicants: 124, finalRate: 0.79, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '翔陽', area: '八王子', department: '普通科（単位制）', quota: 188, finalApplicants: 200, finalRate: 1.06, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '国分寺', area: '国分寺', department: '普通科（単位制）', quota: 252, finalApplicants: 410, finalRate: 1.63, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '上水', area: '武蔵村山', department: '普通科（単位制）', quota: 188, finalApplicants: 250, finalRate: 1.33, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '三田', area: '港', department: '普通科（海外帰国生徒対象・帰国生）', quota: 18, finalApplicants: 22, finalRate: 1.22, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '竹早', area: '文京', department: '普通科（海外帰国生徒対象・帰国生）', quota: 13, finalApplicants: 16, finalRate: 1.23, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '日野台', area: '日野', department: '普通科（海外帰国生徒対象・帰国生）', quota: 13, finalApplicants: 13, finalRate: 1.0, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '深川', area: '江東', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '光丘', area: '練馬', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '富士森', area: '八王子', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和5年度（2023年度）' },
    // 掛-1横展開R5第4弾・PDF3完結: R5分・専門学科13学科49校+総合学科10校(documents/d/kyoiku/05_teisei_2)。
    { schoolName: '芝商業', area: '港', department: '商業科', quota: 101, finalApplicants: 91, finalRate: 0.9, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '江東商業', area: '江東', department: '商業科', quota: 122, finalApplicants: 83, finalRate: 0.68, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '第三商業', area: '江東', department: '商業科', quota: 123, finalApplicants: 121, finalRate: 0.98, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '第一商業', area: '渋谷', department: '商業科', quota: 126, finalApplicants: 135, finalRate: 1.07, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '第四商業', area: '練馬', department: '商業科', quota: 105, finalApplicants: 109, finalRate: 1.04, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '葛飾商業', area: '葛飾', department: '商業科', quota: 126, finalApplicants: 144, finalRate: 1.14, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '第五商業', area: '国立', department: '商業科', quota: 126, finalApplicants: 115, finalRate: 0.91, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '大田桜台', area: '大田', department: 'ビジネスコミュニケーション科', quota: 107, finalApplicants: 63, finalRate: 0.59, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '千早', area: '豊島', department: 'ビジネスコミュニケーション科', quota: 126, finalApplicants: 164, finalRate: 1.3, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '工芸', area: '文京', department: '工業科', quota: 125, finalApplicants: 200, finalRate: 1.6, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '蔵前工科', area: '台東', department: '工業科', quota: 97, finalApplicants: 73, finalRate: 0.75, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '墨田工科', area: '江東', department: '工業科', quota: 129, finalApplicants: 79, finalRate: 0.61, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '総合工科', area: '世田谷', department: '工業科', quota: 109, finalApplicants: 48, finalRate: 0.44, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '中野工科', area: '中野', department: '工業科', quota: 63, finalApplicants: 47, finalRate: 0.75, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '杉並工科', area: '杉並', department: '工業科', quota: 102, finalApplicants: 29, finalRate: 0.28, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '荒川工科', area: '荒川', department: '工業科', quota: 93, finalApplicants: 53, finalRate: 0.57, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '北豊島工科', area: '板橋', department: '工業科', quota: 92, finalApplicants: 49, finalRate: 0.53, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '練馬工科', area: '練馬', department: '工業科', quota: 88, finalApplicants: 81, finalRate: 0.92, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '足立工科', area: '足立', department: '工業科', quota: 120, finalApplicants: 56, finalRate: 0.47, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '葛西工科', area: '江戸川', department: '工業科', quota: 122, finalApplicants: 107, finalRate: 0.88, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '府中工科', area: '府中', department: '工業科', quota: 105, finalApplicants: 101, finalRate: 0.96, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '町田工科', area: '町田', department: '工業科', quota: 105, finalApplicants: 86, finalRate: 0.82, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '多摩工科', area: '福生', department: '工業科', quota: 107, finalApplicants: 86, finalRate: 0.8, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '田無工科', area: '西東京', department: '工業科', quota: 111, finalApplicants: 64, finalRate: 0.58, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '六郷工科', area: '大田', department: '工業科（単位制）', quota: 118, finalApplicants: 67, finalRate: 0.57, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '科学技術', area: '江東', department: '科学技術科', quota: 126, finalApplicants: 237, finalRate: 1.88, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '多摩科学技術', area: '小金井', department: '科学技術科', quota: 147, finalApplicants: 265, finalRate: 1.8, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '園芸', area: '世田谷', department: '農業科', quota: 99, finalApplicants: 128, finalRate: 1.29, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '農芸', area: '杉並', department: '農業科', quota: 92, finalApplicants: 106, finalRate: 1.15, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '農産', area: '葛飾', department: '農業科', quota: 84, finalApplicants: 101, finalRate: 1.2, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '農業', area: '府中', department: '農業科', quota: 69, finalApplicants: 78, finalRate: 1.13, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '瑞穂農芸', area: '瑞穂', department: '農業科', quota: 75, finalApplicants: 77, finalRate: 1.03, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '大島海洋国際', area: '大島', department: '水産科', quota: 42, finalApplicants: 28, finalRate: 0.67, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '赤羽北桜', area: '北', department: '家庭科', quota: 123, finalApplicants: 108, finalRate: 0.88, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '農業', area: '府中', department: '家庭科', quota: 50, finalApplicants: 65, finalRate: 1.3, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '瑞穂農芸', area: '瑞穂', department: '家庭科', quota: 49, finalApplicants: 50, finalRate: 1.02, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '忍岡', area: '台東', department: '家庭科（単位制）', quota: 49, finalApplicants: 46, finalRate: 0.94, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '赤羽北桜', area: '北', department: '福祉科', quota: 25, finalApplicants: 21, finalRate: 0.84, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '野津田', area: '町田', department: '福祉科', quota: 26, finalApplicants: 10, finalRate: 0.38, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '立川', area: '立川', department: '理数科', quota: 35, finalApplicants: 128, finalRate: 3.66, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '総合芸術', area: '新宿', department: '芸術科', quota: 112, finalApplicants: 193, finalRate: 1.72, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '駒場', area: '目黒', department: '体育科', quota: 28, finalApplicants: 52, finalRate: 1.86, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '野津田', area: '町田', department: '体育科', quota: 24, finalApplicants: 18, finalRate: 0.75, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '国際', area: '目黒', department: '国際科', quota: 138, finalApplicants: 338, finalRate: 2.45, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '大島', area: '大島', department: '併合科（農林・家政）', quota: 35, finalApplicants: 14, finalRate: 0.4, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '三宅', area: '三宅', department: '併合科（農業・家政）', quota: 35, finalApplicants: 3, finalRate: 0.09, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '八丈', area: '八丈', department: '併合科（園芸・家政）', quota: 35, finalApplicants: 5, finalRate: 0.14, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '橘', area: '墨田', department: '産業科', quota: 147, finalApplicants: 159, finalRate: 1.08, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '八王子桑志', area: '八王子', department: '産業科', quota: 148, finalApplicants: 139, finalRate: 0.94, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '晴海総合', area: '中央', department: '総合学科', quota: 192, finalApplicants: 351, finalRate: 1.83, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: 'つばさ総合', area: '大田', department: '総合学科', quota: 164, finalApplicants: 193, finalRate: 1.18, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '世田谷総合', area: '世田谷', department: '総合学科', quota: 164, finalApplicants: 212, finalRate: 1.29, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '杉並総合', area: '杉並', department: '総合学科', quota: 150, finalApplicants: 184, finalRate: 1.23, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '王子総合', area: '北', department: '総合学科', quota: 164, finalApplicants: 264, finalRate: 1.61, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '葛飾総合', area: '葛飾', department: '総合学科', quota: 136, finalApplicants: 148, finalRate: 1.09, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '青梅総合', area: '青梅', department: '総合学科', quota: 164, finalApplicants: 172, finalRate: 1.05, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '町田総合', area: '町田', department: '総合学科', quota: 164, finalApplicants: 167, finalRate: 1.02, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '東久留米総合', area: '東久留米', department: '総合学科', quota: 164, finalApplicants: 173, finalRate: 1.05, fiscalYear: '令和5年度（2023年度）' },
    { schoolName: '若葉総合', area: '稲城', department: '総合学科', quota: 164, finalApplicants: 224, finalRate: 1.37, fiscalYear: '令和5年度（2023年度）' },
    // 掛-1横展開R4第1弾: R4分・PDF1「1[普通科(コース、単位制以外)]」1〜2頁目(documents/d/kyoiku/02_86)の区部59校。
    { schoolName: '日比谷', area: '千代田', department: '普通科', quota: 254, finalApplicants: 546, finalRate: 2.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三田', area: '港', department: '普通科', quota: 206, finalApplicants: 423, finalRate: 2.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '戸山', area: '新宿', department: '普通科', quota: 254, finalApplicants: 525, finalRate: 2.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '竹早', area: '文京', department: '普通科', quota: 210, finalApplicants: 383, finalRate: 1.82, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '向丘', area: '文京', department: '普通科', quota: 222, finalApplicants: 438, finalRate: 1.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上野', area: '台東', department: '普通科', quota: 254, finalApplicants: 500, finalRate: 1.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '白鷗', area: '台東', department: '普通科', quota: 62, finalApplicants: 108, finalRate: 1.74, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日本橋', area: '墨田', department: '普通科', quota: 181, finalApplicants: 306, finalRate: 1.69, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '本所', area: '墨田', department: '普通科', quota: 191, finalApplicants: 289, finalRate: 1.51, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '城東', area: '江東', department: '普通科', quota: 254, finalApplicants: 374, finalRate: 1.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東', area: '江東', department: '普通科', quota: 191, finalApplicants: 397, finalRate: 2.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深川', area: '江東', department: '普通科', quota: 185, finalApplicants: 338, finalRate: 1.83, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大崎', area: '品川', department: '普通科', quota: 223, finalApplicants: 325, finalRate: 1.46, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小山台', area: '品川', department: '普通科', quota: 254, finalApplicants: 384, finalRate: 1.51, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮', area: '品川', department: '普通科', quota: 150, finalApplicants: 137, finalRate: 0.91, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '駒場', area: '目黒', department: '普通科', quota: 222, finalApplicants: 306, finalRate: 1.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '目黒', area: '目黒', department: '普通科', quota: 191, finalApplicants: 434, finalRate: 2.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大森', area: '大田', department: '普通科', quota: 159, finalApplicants: 153, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '蒲田', area: '大田', department: '普通科', quota: 87, finalApplicants: 96, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '田園調布', area: '大田', department: '普通科', quota: 170, finalApplicants: 325, finalRate: 1.91, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '雪谷', area: '大田', department: '普通科', quota: 223, finalApplicants: 397, finalRate: 1.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '桜町', area: '世田谷', department: '普通科', quota: 254, finalApplicants: 275, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '千歳丘', area: '世田谷', department: '普通科', quota: 223, finalApplicants: 227, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深沢', area: '世田谷', department: '普通科', quota: 143, finalApplicants: 60, finalRate: 0.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松原', area: '世田谷', department: '普通科', quota: 158, finalApplicants: 231, finalRate: 1.46, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '青山', area: '渋谷', department: '普通科', quota: 250, finalApplicants: 558, finalRate: 2.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '広尾', area: '渋谷', department: '普通科', quota: 189, finalApplicants: 417, finalRate: 2.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鷺宮', area: '中野', department: '普通科', quota: 222, finalApplicants: 415, finalRate: 1.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '武蔵丘', area: '中野', department: '普通科', quota: 254, finalApplicants: 386, finalRate: 1.52, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉並', area: '杉並', department: '普通科', quota: 254, finalApplicants: 295, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '豊多摩', area: '杉並', department: '普通科', quota: 254, finalApplicants: 533, finalRate: 2.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '西', area: '杉並', department: '普通科', quota: 254, finalApplicants: 442, finalRate: 1.74, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '豊島', area: '豊島', department: '普通科', quota: 222, finalApplicants: 452, finalRate: 2.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '文京', area: '豊島', department: '普通科', quota: 285, finalApplicants: 525, finalRate: 1.84, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '竹台', area: '荒川', department: '普通科', quota: 144, finalApplicants: 211, finalRate: 1.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '板橋', area: '板橋', department: '普通科', quota: 223, finalApplicants: 293, finalRate: 1.31, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大山', area: '板橋', department: '普通科', quota: 171, finalApplicants: 152, finalRate: 0.89, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '北園', area: '板橋', department: '普通科', quota: 254, finalApplicants: 523, finalRate: 2.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '高島', area: '板橋', department: '普通科', quota: 254, finalApplicants: 301, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '井草', area: '練馬', department: '普通科', quota: 223, finalApplicants: 475, finalRate: 2.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '石神井', area: '練馬', department: '普通科', quota: 222, finalApplicants: 411, finalRate: 1.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '田柄', area: '練馬', department: '普通科', quota: 124, finalApplicants: 81, finalRate: 0.65, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '練馬', area: '練馬', department: '普通科', quota: 191, finalApplicants: 214, finalRate: 1.12, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '光丘', area: '練馬', department: '普通科', quota: 185, finalApplicants: 163, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '青井', area: '足立', department: '普通科', quota: 139, finalApplicants: 119, finalRate: 0.86, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足立', area: '足立', department: '普通科', quota: 222, finalApplicants: 353, finalRate: 1.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足立新田', area: '足立', department: '普通科', quota: 210, finalApplicants: 158, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足立西', area: '足立', department: '普通科', quota: 158, finalApplicants: 184, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足立東', area: '足立', department: '普通科', quota: 124, finalApplicants: 132, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '江北', area: '足立', department: '普通科', quota: 254, finalApplicants: 389, finalRate: 1.53, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '淵江', area: '足立', department: '普通科', quota: 175, finalApplicants: 220, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '葛飾野', area: '葛飾', department: '普通科', quota: 254, finalApplicants: 231, finalRate: 0.91, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '南葛飾', area: '葛飾', department: '普通科', quota: 162, finalApplicants: 241, finalRate: 1.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '江戸川', area: '江戸川', department: '普通科', quota: 254, finalApplicants: 424, finalRate: 1.67, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '葛西南', area: '江戸川', department: '普通科', quota: 192, finalApplicants: 165, finalRate: 0.86, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小岩', area: '江戸川', department: '普通科', quota: 285, finalApplicants: 474, finalRate: 1.66, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小松川', area: '江戸川', department: '普通科', quota: 254, finalApplicants: 351, finalRate: 1.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '篠崎', area: '江戸川', department: '普通科', quota: 223, finalApplicants: 243, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '紅葉川', area: '江戸川', department: '普通科', quota: 191, finalApplicants: 311, finalRate: 1.63, fiscalYear: '令和4年度（2022年度）' },
    // 掛-1横展開R4第2弾・個票PDF1完結: R4分・3頁目の多摩部44校+2[普通科(島しょの学校)]6校(documents/d/kyoiku/02_86)。
    { schoolName: '片倉', area: '八王子', department: '普通科', quota: 191, finalApplicants: 238, finalRate: 1.25, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八王子北', area: '八王子', department: '普通科', quota: 159, finalApplicants: 165, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八王子東', area: '八王子', department: '普通科', quota: 254, finalApplicants: 410, finalRate: 1.61, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '富士森', area: '八王子', department: '普通科', quota: 250, finalApplicants: 298, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松が谷', area: '八王子', department: '普通科', quota: 190, finalApplicants: 299, finalRate: 1.57, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '立川', area: '立川', department: '普通科', quota: 222, finalApplicants: 285, finalRate: 1.28, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '武蔵野北', area: '武蔵野', department: '普通科', quota: 191, finalApplicants: 266, finalRate: 1.39, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '多摩', area: '青梅', department: '普通科', quota: 159, finalApplicants: 118, finalRate: 0.74, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '府中', area: '府中', department: '普通科', quota: 222, finalApplicants: 397, finalRate: 1.79, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '府中西', area: '府中', department: '普通科', quota: 236, finalApplicants: 278, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '府中東', area: '府中', department: '普通科', quota: 241, finalApplicants: 356, finalRate: 1.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '昭和', area: '昭島', department: '普通科', quota: 254, finalApplicants: 481, finalRate: 1.89, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '拝島', area: '昭島', department: '普通科', quota: 223, finalApplicants: 210, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '神代', area: '調布', department: '普通科', quota: 222, finalApplicants: 469, finalRate: 2.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '調布北', area: '調布', department: '普通科', quota: 190, finalApplicants: 326, finalRate: 1.72, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '調布南', area: '調布', department: '普通科', quota: 191, finalApplicants: 362, finalRate: 1.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小川', area: '町田', department: '普通科', quota: 254, finalApplicants: 314, finalRate: 1.24, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '成瀬', area: '町田', department: '普通科', quota: 223, finalApplicants: 286, finalRate: 1.28, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '野津田', area: '町田', department: '普通科', quota: 96, finalApplicants: 84, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '町田', area: '町田', department: '普通科', quota: 254, finalApplicants: 328, finalRate: 1.29, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '山崎', area: '町田', department: '普通科', quota: 140, finalApplicants: 131, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小金井北', area: '小金井', department: '普通科', quota: 191, finalApplicants: 267, finalRate: 1.4, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小平', area: '小平', department: '普通科', quota: 159, finalApplicants: 230, finalRate: 1.45, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小平西', area: '小平', department: '普通科', quota: 223, finalApplicants: 228, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小平南', area: '小平', department: '普通科', quota: 223, finalApplicants: 403, finalRate: 1.81, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日野', area: '日野', department: '普通科', quota: 254, finalApplicants: 327, finalRate: 1.29, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日野台', area: '日野', department: '普通科', quota: 242, finalApplicants: 336, finalRate: 1.39, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '南平', area: '日野', department: '普通科', quota: 254, finalApplicants: 396, finalRate: 1.56, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東村山', area: '東村山', department: '普通科', quota: 118, finalApplicants: 153, finalRate: 1.3, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東村山西', area: '東村山', department: '普通科', quota: 191, finalApplicants: 157, finalRate: 0.82, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '国立', area: '国立', department: '普通科', quota: 254, finalApplicants: 419, finalRate: 1.65, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '福生', area: '福生', department: '普通科', quota: 223, finalApplicants: 274, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狛江', area: '狛江', department: '普通科', quota: 254, finalApplicants: 394, finalRate: 1.55, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東大和', area: '東大和', department: '普通科', quota: 223, finalApplicants: 270, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東大和南', area: '東大和', department: '普通科', quota: 222, finalApplicants: 350, finalRate: 1.58, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '清瀬', area: '清瀬', department: '普通科', quota: 222, finalApplicants: 304, finalRate: 1.37, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久留米西', area: '東久留米', department: '普通科', quota: 190, finalApplicants: 199, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '武蔵村山', area: '武蔵村山', department: '普通科', quota: 223, finalApplicants: 209, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '永山', area: '多摩', department: '普通科', quota: 241, finalApplicants: 276, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽村', area: '羽村', department: '普通科', quota: 195, finalApplicants: 172, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秋留台', area: 'あきる野', department: '普通科', quota: 137, finalApplicants: 165, finalRate: 1.2, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '五日市', area: 'あきる野', department: '普通科', quota: 128, finalApplicants: 69, finalRate: 0.54, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '田無', area: '西東京', department: '普通科', quota: 254, finalApplicants: 338, finalRate: 1.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '保谷', area: '西東京', department: '普通科', quota: 254, finalApplicants: 378, finalRate: 1.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大島', area: '大島', department: '普通科', quota: 80, finalApplicants: 27, finalRate: 0.34, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新島', area: '新島', department: '普通科', quota: 40, finalApplicants: 13, finalRate: 0.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '神津', area: '神津島', department: '普通科', quota: 40, finalApplicants: 15, finalRate: 0.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三宅', area: '三宅', department: '普通科', quota: 40, finalApplicants: 4, finalRate: 0.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八丈', area: '八丈', department: '普通科', quota: 78, finalApplicants: 38, finalRate: 0.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小笠原', area: '小笠原', department: '普通科', quota: 30, finalApplicants: 16, finalRate: 0.53, fiscalYear: '令和4年度（2022年度）' },
    // 掛-1横展開R4第3弾: R4分・PDF2「3[コース制]・4[単位制]・5[海外帰国生徒対象]」(documents/d/kyoiku/03_77)。
    { schoolName: '深川', area: '江東', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 94, finalRate: 1.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '片倉', area: '八王子', department: '普通科（コース制・造形美術）', quota: 56, finalApplicants: 77, finalRate: 1.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松が谷', area: '八王子', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 77, finalRate: 1.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小平', area: '小平', department: '普通科（コース制・外国語）', quota: 56, finalApplicants: 106, finalRate: 1.89, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新宿', area: '新宿', department: '普通科（単位制）', quota: 284, finalApplicants: 670, finalRate: 2.36, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '忍岡', area: '台東', department: '普通科（単位制）', quota: 124, finalApplicants: 143, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '墨田川', area: '墨田', department: '普通科（単位制）', quota: 252, finalApplicants: 319, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '美原', area: '大田', department: '普通科（単位制）', quota: 156, finalApplicants: 175, finalRate: 1.12, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '芦花', area: '世田谷', department: '普通科（単位制）', quota: 220, finalApplicants: 424, finalRate: 1.93, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '飛鳥', area: '北', department: '普通科（単位制）', quota: 170, finalApplicants: 214, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '板橋有徳', area: '板橋', department: '普通科（単位制）', quota: 156, finalApplicants: 123, finalRate: 0.79, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大泉桜', area: '練馬', department: '普通科（単位制）', quota: 156, finalApplicants: 173, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '翔陽', area: '八王子', department: '普通科（単位制）', quota: 188, finalApplicants: 237, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '国分寺', area: '国分寺', department: '普通科（単位制）', quota: 252, finalApplicants: 429, finalRate: 1.7, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上水', area: '武蔵村山', department: '普通科（単位制）', quota: 188, finalApplicants: 262, finalRate: 1.39, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三田', area: '港', department: '普通科（海外帰国生徒対象・帰国生）', quota: 18, finalApplicants: 27, finalRate: 1.5, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '竹早', area: '文京', department: '普通科（海外帰国生徒対象・帰国生）', quota: 13, finalApplicants: 14, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日野台', area: '日野', department: '普通科（海外帰国生徒対象・帰国生）', quota: 13, finalApplicants: 12, finalRate: 0.92, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深川', area: '江東', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '光丘', area: '練馬', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '富士森', area: '八王子', department: '普通科（海外帰国生徒対象・引揚者）', quota: 6, finalApplicants: 0, finalRate: 0, fiscalYear: '令和4年度（2022年度）' },
    // 掛-1横展開R4第4弾・PDF3完結: R4分・専門学科13学科49校+総合学科10校(documents/d/kyoiku/04_56)。
    { schoolName: '芝商業', area: '港', department: '商業科', quota: 102, finalApplicants: 59, finalRate: 0.58, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '江東商業', area: '江東', department: '商業科', quota: 105, finalApplicants: 64, finalRate: 0.61, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '第三商業', area: '江東', department: '商業科', quota: 123, finalApplicants: 123, finalRate: 1.0, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '第一商業', area: '渋谷', department: '商業科', quota: 126, finalApplicants: 132, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '第四商業', area: '練馬', department: '商業科', quota: 105, finalApplicants: 72, finalRate: 0.69, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '葛飾商業', area: '葛飾', department: '商業科', quota: 126, finalApplicants: 107, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '第五商業', area: '国立', department: '商業科', quota: 126, finalApplicants: 133, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大田桜台', area: '大田', department: 'ビジネスコミュニケーション科', quota: 117, finalApplicants: 66, finalRate: 0.56, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '千早', area: '豊島', department: 'ビジネスコミュニケーション科', quota: 126, finalApplicants: 187, finalRate: 1.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '工芸', area: '文京', department: '工業科', quota: 125, finalApplicants: 221, finalRate: 1.77, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '蔵前工科', area: '台東', department: '工業科', quota: 101, finalApplicants: 66, finalRate: 0.65, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '墨田工科', area: '江東', department: '工業科', quota: 116, finalApplicants: 68, finalRate: 0.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '総合工科', area: '世田谷', department: '工業科', quota: 105, finalApplicants: 62, finalRate: 0.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '中野工科', area: '中野', department: '工業科', quota: 72, finalApplicants: 39, finalRate: 0.54, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉並工科', area: '杉並', department: '工業科', quota: 108, finalApplicants: 44, finalRate: 0.41, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '荒川工科', area: '荒川', department: '工業科', quota: 108, finalApplicants: 73, finalRate: 0.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '北豊島工科', area: '板橋', department: '工業科', quota: 97, finalApplicants: 45, finalRate: 0.46, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '練馬工科', area: '練馬', department: '工業科', quota: 88, finalApplicants: 104, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '足立工科', area: '足立', department: '工業科', quota: 92, finalApplicants: 74, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '葛西工科', area: '江戸川', department: '工業科', quota: 109, finalApplicants: 104, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '府中工科', area: '府中', department: '工業科', quota: 105, finalApplicants: 109, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '町田工科', area: '町田', department: '工業科', quota: 105, finalApplicants: 91, finalRate: 0.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '多摩工科', area: '福生', department: '工業科', quota: 105, finalApplicants: 121, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '田無工科', area: '西東京', department: '工業科', quota: 105, finalApplicants: 91, finalRate: 0.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '六郷工科', area: '大田', department: '工業科（単位制）', quota: 110, finalApplicants: 67, finalRate: 0.61, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '科学技術', area: '江東', department: '科学技術科', quota: 126, finalApplicants: 235, finalRate: 1.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '多摩科学技術', area: '小金井', department: '科学技術科', quota: 147, finalApplicants: 304, finalRate: 2.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '園芸', area: '世田谷', department: '農業科', quota: 99, finalApplicants: 154, finalRate: 1.56, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '農芸', area: '杉並', department: '農業科', quota: 92, finalApplicants: 81, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '農産', area: '葛飾', department: '農業科', quota: 88, finalApplicants: 71, finalRate: 0.81, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '農業', area: '府中', department: '農業科', quota: 69, finalApplicants: 75, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '瑞穂農芸', area: '瑞穂', department: '農業科', quota: 75, finalApplicants: 81, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大島海洋国際', area: '大島', department: '水産科', quota: 49, finalApplicants: 65, finalRate: 1.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '赤羽北桜', area: '北', department: '家庭科', quota: 123, finalApplicants: 57, finalRate: 0.46, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '農業', area: '府中', department: '家庭科', quota: 50, finalApplicants: 61, finalRate: 1.22, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '瑞穂農芸', area: '瑞穂', department: '家庭科', quota: 49, finalApplicants: 26, finalRate: 0.53, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '忍岡', area: '台東', department: '家庭科（単位制）', quota: 49, finalApplicants: 30, finalRate: 0.61, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '赤羽北桜', area: '北', department: '福祉科', quota: 25, finalApplicants: 19, finalRate: 0.76, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '野津田', area: '町田', department: '福祉科', quota: 25, finalApplicants: 12, finalRate: 0.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '立川', area: '立川', department: '理数科', quota: 32, finalApplicants: 147, finalRate: 4.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '総合芸術', area: '新宿', department: '芸術科', quota: 112, finalApplicants: 242, finalRate: 2.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '駒場', area: '目黒', department: '体育科', quota: 28, finalApplicants: 41, finalRate: 1.46, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '野津田', area: '町田', department: '体育科', quota: 24, finalApplicants: 9, finalRate: 0.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '国際', area: '目黒', department: '国際科', quota: 138, finalApplicants: 325, finalRate: 2.36, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大島', area: '大島', department: '併合科（農林・家政）', quota: 35, finalApplicants: 5, finalRate: 0.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三宅', area: '三宅', department: '併合科（農業・家政）', quota: 35, finalApplicants: 5, finalRate: 0.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八丈', area: '八丈', department: '併合科（園芸・家政）', quota: 34, finalApplicants: 7, finalRate: 0.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '橘', area: '墨田', department: '産業科', quota: 147, finalApplicants: 151, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八王子桑志', area: '八王子', department: '産業科', quota: 148, finalApplicants: 181, finalRate: 1.22, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '晴海総合', area: '中央', department: '総合学科', quota: 192, finalApplicants: 339, finalRate: 1.77, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: 'つばさ総合', area: '大田', department: '総合学科', quota: 164, finalApplicants: 202, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '世田谷総合', area: '世田谷', department: '総合学科', quota: 164, finalApplicants: 186, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉並総合', area: '杉並', department: '総合学科', quota: 154, finalApplicants: 174, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '王子総合', area: '北', department: '総合学科', quota: 164, finalApplicants: 175, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '葛飾総合', area: '葛飾', department: '総合学科', quota: 136, finalApplicants: 116, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '青梅総合', area: '青梅', department: '総合学科', quota: 164, finalApplicants: 189, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '町田総合', area: '町田', department: '総合学科', quota: 164, finalApplicants: 156, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '東久留米総合', area: '東久留米', department: '総合学科', quota: 164, finalApplicants: 175, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '若葉総合', area: '稲城', department: '総合学科', quota: 164, finalApplicants: 148, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
  ],
};
