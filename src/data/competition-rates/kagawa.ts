...
export const KAGAWA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8: 2026-09-10に再取得して計測。既存の68件のquota/finalApplicants等は書き換えていない
      pdfSha256: 'cfb4eb76f72ead3da00749b03af47ebf10eab21d9c1d3ecf690154a714bc9e10',
    },
    {
  ...
  records: [
    { schoolName: '小豆島中央', department: '特進コース', quota: 30, finalApplicants: 31, finalRate: 1.03, page: 1, rowIndex: 0 },
    { schoolName: '小豆島中央', department: '普通コース', quota: 117, finalApplicants: 85, finalRate: 0.73, page: 1, rowIndex: 1 },
    { schoolName: '三本松', department: '普通・理数（くくり募集）', quota: 87, finalApplicants: 80, finalRate: 0.92, page: 1, rowIndex: 2 },
    { schoolName: '石田', department: '生産経済', quota: 12, finalApplicants: 11, finalRate: 0.92, page: 1, rowIndex: 3 },
    { schoolName: '石田', department: '園芸デザイン', quota: 12, finalApplicants: 11, finalRate: 0.92, page: 1, rowIndex: 4 },
    { schoolName: '石田', department: '農業土木', quota: 17, finalApplicants: 12, finalRate: 0.71, page: 1, rowIndex: 5 },
    { schoolName: '石田', department: '生活デザイン', quota: 16, finalApplicants: 6, finalRate: 0.38, page: 1, rowIndex: 6 },
    { schoolName: '志度', department: '電子機械', quota: 15, finalApplicants: 18, finalRate: 1.2, page: 1, rowIndex: 7 },
    { schoolName: '志度', department: '情報科学', quota: 15, finalApplicants: 16, finalRate: 1.07, page: 1, rowIndex: 8 },
    { schoolName: '志度', department: '商業', quota: 15, finalApplicants: 9, finalRate: 0.6, page: 1, rowIndex: 9 },
    { schoolName: '津田', department: '普通', quota: 57, finalApplicants: 52, finalRate: 0.91, page: 1, rowIndex: 10 },
    { schoolName: '三木', department: '文理', quota: 56, finalApplicants: 53, finalRate: 0.95, page: 1, rowIndex: 11 },
    { schoolName: '三木', department: '総合', quota: 49, finalApplicants: 54, finalRate: 1.1, page: 1, rowIndex: 12 },
    { schoolName: '高松', department: '普通', quota: 280, finalApplicants: 304, finalRate: 1.09, page: 1, rowIndex: 13 },
    { schoolName: '高松工芸', department: '機械', quota: 24, finalApplicants: 30, finalRate: 1.25, page: 1, rowIndex: 14 },
    { schoolName: '高松工芸', department: '電気', quota: 21, finalApplicants: 31, finalRate: 1.48, page: 1, rowIndex: 15 },
    { schoolName: '高松工芸', department: '工業化学', quota: 24, finalApplicants: 25, finalRate: 1.04, page: 1, rowIndex: 16 },
    { schoolName: '高松工芸', department: '建築', quota: 21, finalApplicants: 23, finalRate: 1.1, page: 1, rowIndex: 17 },
    { schoolName: '高松工芸', department: 'デザイン', quota: 15, finalApplicants: 21, finalRate: 1.4, page: 1, rowIndex: 18 },
    { schoolName: '高松工芸', department: '工芸', quota: 36, finalApplicants: 47, finalRate: 1.31, page: 1, rowIndex: 19 },
    { schoolName: '高松工芸', department: '美術', quota: 11, finalApplicants: 9, finalRate: 0.82, page: 1, rowIndex: 20 },
    { schoolName: '高松商業', department: '商業', quota: 126, finalApplicants: 154, finalRate: 1.22, page: 1, rowIndex: 21 },
    { schoolName: '高松商業', department: '情報数理', quota: 16, finalApplicants: 18, finalRate: 1.13, page: 1, rowIndex: 22 },
    { schoolName: '高松商業', department: '英語実務', quota: 17, finalApplicants: 18, finalRate: 1.06, page: 1, rowIndex: 23 },
    { schoolName: '高松東', department: '普通', quota: 166, finalApplicants: 157, finalRate: 0.95, page: 1, rowIndex: 24 },
    { schoolName: '高松南', department: '普通', quota: 101, finalApplicants: 146, finalRate: 1.45, page: 1, rowIndex: 25 },
    { schoolName: '高松南', department: '環境科学', quota: 24, finalApplicants: 25, finalRate: 1.04, page: 1, rowIndex: 26 },
    { schoolName: '高松南', department: '生活デザイン', quota: 21, finalApplicants: 33, finalRate: 1.57, page: 1, rowIndex: 27 },
    { schoolName: '高松南', department: '看護', quota: 21, finalApplicants: 20, finalRate: 0.95, page: 1, rowIndex: 28 },
    { schoolName: '高松南', department: '福祉', quota: 21, finalApplicants: 18, finalRate: 0.86, page: 1, rowIndex: 29 },
    { schoolName: '高松西', department: '普通', quota: 189, finalApplicants: 182, finalRate: 0.96, page: 1, rowIndex: 30 },
    { schoolName: '高松北', department: '普通', quota: 93, finalApplicants: 72, finalRate: 0.77, page: 1, rowIndex: 31 },
    { schoolName: '香川中央', department: '普通', quota: 189, finalApplicants: 194, finalRate: 1.03, page: 1, rowIndex: 32 },
    { schoolName: '高松桜井', department: '普通', quota: 252, finalApplicants: 315, finalRate: 1.25, page: 1, rowIndex: 33 },
    { schoolName: '農業経営', department: '農業生産・環境園芸・動物科学・食農科学（くくり募集）', quota: 77, finalApplicants: 41, finalRate: 0.53, page: 1, rowIndex: 34 },
    { schoolName: '坂出商業', department: '商業', quota: 74, finalApplicants: 84, finalRate: 1.14, page: 1, rowIndex: 35 },
    { schoolName: '坂出商業', department: '情報技術', quota: 20, finalApplicants: 18, finalRate: 0.9, page: 1, rowIndex: 36 },
    { schoolName: '坂出', department: '普通', quota: 217, finalApplicants: 241, finalRate: 1.11, page: 1, rowIndex: 37 },
    { schoolName: '坂出', department: '音楽', quota: 10, finalApplicants: 5, finalRate: 0.5, page: 1, rowIndex: 38 },
    { schoolName: '坂出工業', department: '機械', quota: 15, finalApplicants: 21, finalRate: 1.4, page: 1, rowIndex: 39 },
    { schoolName: '坂出工業', department: '電気', quota: 15, finalApplicants: 10, finalRate: 0.67, page: 1, rowIndex: 40 },
    { schoolName: '坂出工業', department: '化学工学', quota: 21, finalApplicants: 13, finalRate: 0.62, page: 1, rowIndex: 41 },
    { schoolName: '坂出工業', department: '建築', quota: 15, finalApplicants: 14, finalRate: 0.93, page: 1, rowIndex: 42 },
    { schoolName: '丸亀', department: '普通', quota: 280, finalApplicants: 291, finalRate: 1.04, page: 1, rowIndex: 43 },
    { schoolName: '飯山', department: '看護', quota: 21, finalApplicants: 2, finalRate: 0.1, page: 1, rowIndex: 44 },
    { schoolName: '飯山', department: '総合', quota: 71, finalApplicants: 59, finalRate: 0.83, page: 1, rowIndex: 45 },
    { schoolName: '丸亀城西', department: '普通', quota: 136, finalApplicants: 146, finalRate: 1.07, page: 1, rowIndex: 46 },
    { schoolName: '善通寺第一', department: '普通', quota: 106, finalApplicants: 119, finalRate: 1.12, page: 1, rowIndex: 47 },
    { schoolName: '善通寺第一', department: 'デザイン', quota: 19, finalApplicants: 18, finalRate: 0.95, page: 1, rowIndex: 48 },
    { schoolName: '琴平', department: '普通', quota: 126, finalApplicants: 109, finalRate: 0.87, page: 1, rowIndex: 49 },
    { schoolName: '多度津', department: '機械', quota: 19, finalApplicants: 13, finalRate: 0.68, page: 1, rowIndex: 50 },
    { schoolName: '多度津', department: '電気', quota: 19, finalApplicants: 15, finalRate: 0.79, page: 1, rowIndex: 51 },
    { schoolName: '多度津', department: '土木', quota: 19, finalApplicants: 16, finalRate: 0.84, page: 1, rowIndex: 52 },
    { schoolName: '多度津', department: '建築', quota: 19, finalApplicants: 11, finalRate: 0.58, page: 1, rowIndex: 53 },
    { schoolName: '多度津', department: '海洋技術', quota: 16, finalApplicants: 13, finalRate: 0.81, page: 1, rowIndex: 54 },
    { schoolName: '多度津', department: '海洋生産', quota: 16, finalApplicants: 21, finalRate: 1.31, page: 1, rowIndex: 55 },
    { schoolName: '笠田', department: '農産科学', quota: 20, finalApplicants: 17, finalRate: 0.85, page: 1, rowIndex: 56 },
    { schoolName: '笠田', department: '植物科学', quota: 20, finalApplicants: 16, finalRate: 0.8, page: 1, rowIndex: 57 },
    { schoolName: '笠田', department: '食品科学', quota: 20, finalApplicants: 13, finalRate: 0.65, page: 1, rowIndex: 58 },
    { schoolName: '笠田', department: '生活デザイン', quota: 20, finalApplicants: 18, finalRate: 0.9, page: 1, rowIndex: 59 },
    { schoolName: '高瀬', department: '普通', quota: 87, finalApplicants: 77, finalRate: 0.89, page: 1, rowIndex: 60 },
    { schoolName: '観音寺第一', department: '普通・理数（くくり募集）', quota: 150, finalApplicants: 134, finalRate: 0.89, page: 1, rowIndex: 61 },
    { schoolName: '観音寺総合', department: '機械', quota: 18, finalApplicants: 12, finalRate: 0.67, page: 1, rowIndex: 62 },
    { schoolName: '観音寺総合', department: '電気', quota: 18, finalApplicants: 13, finalRate: 0.72, page: 1, rowIndex: 63 },
    { schoolName: '観音寺総合', department: '電子', quota: 18, finalApplicants: 16, finalRate: 0.89, page: 1, rowIndex: 64 },
    { schoolName: '観音寺総合', department: '総合', quota: 89, finalApplicants: 102, finalRate: 1.15, page: 1, rowIndex: 65 },
    { schoolName: '高松第一', department: '普通', quota: 240, finalApplicants: 316, finalRate: 1.32, page: 1, rowIndex: 66 },
    { schoolName: '高松第一', department: '音楽', quota: 11, finalApplicants: 2, finalRate: 0.18, page: 1, rowIndex: 67 },
