...
export const SHIMANE_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8: 2026-09-10に再取得して計測。既存の64件のquota/finalApplicants等は書き換えていない
      pdfSha256: '83562e6497151b0375505952a2b0d19a8ca95115ce1da3bcb49d380670a9c688',
    },
    {
  ...
  records: [
    { schoolName: '安来', department: '普通', quota: 81, finalApplicants: 48, finalRate: 0.59, page: 1, rowIndex: 0 },
    {
      schoolName: '情報科学',
    ...
    { schoolName: '松江北', department: '普通', quota: 192, finalApplicants: 201, finalRate: 1.05, page: 1, rowIndex: 4 },
    { schoolName: '松江北', department: '理数', quota: 36, finalApplicants: 35, finalRate: 0.97, page: 1, rowIndex: 5 },
    { schoolName: '松江南', department: '普通', quota: 163, finalApplicants: 201, finalRate: 1.23, page: 1, rowIndex: 6 },
    { schoolName: '松江南', department: '探究科学', quota: 24, finalApplicants: 19, finalRate: 0.79, page: 1, rowIndex: 7 },
    { schoolName: '松江東', department: '普通', quota: 109, finalApplicants: 121, finalRate: 1.11, page: 1, rowIndex: 8 },
    { schoolName: '松江工業', department: '機械', quota: 23, finalApplicants: 25, finalRate: 1.09, page: 1, rowIndex: 9 },
    { schoolName: '松江工業', department: '電子機械', quota: 19, finalApplicants: 20, finalRate: 1.05, page: 1, rowIndex: 10 },
    { schoolName: '松江工業', department: '電気電子工学', quota: 22, finalApplicants: 19, finalRate: 0.86, page: 1, rowIndex: 11 },
    { schoolName: '松江工業', department: '情報クリエイター学', quota: 27, finalApplicants: 22, finalRate: 0.81, page: 1, rowIndex: 12 },
    { schoolName: '松江工業', department: '建築都市工学', quota: 27, finalApplicants: 18, finalRate: 0.67, page: 1, rowIndex: 13 },
    {
      schoolName: '松江商業',
    ...
    { schoolName: '松江農林', department: '生物生産', quota: 24, finalApplicants: 30, finalRate: 1.25, page: 1, rowIndex: 17 },
    { schoolName: '松江農林', department: '環境土木', quota: 24, finalApplicants: 17, finalRate: 0.71, page: 1, rowIndex: 18 },
    { schoolName: '松江農林', department: '総合学科', quota: 44, finalApplicants: 49, finalRate: 1.11, page: 1, rowIndex: 19 },
    { schoolName: '大東', department: '普通', quota: 52, finalApplicants: 23, finalRate: 0.44, page: 1, rowIndex: 20 },
    { schoolName: '横田', department: '普通', quota: 67, finalApplicants: 37, finalRate: 0.55, page: 1, rowIndex: 21 },
    { schoolName: '三刀屋', department: '総合学科', quota: 89, finalApplicants: 52, finalRate: 0.58, page: 1, rowIndex: 22 },
    { schoolName: '掛合', department: '普通', quota: 33, finalApplicants: 23, finalRate: 0.7, page: 1, rowIndex: 23 },
    { schoolName: '飯南', department: '普通', quota: 34, finalApplicants: 19, finalRate: 0.56, page: 1, rowIndex: 24 },
    { schoolName: '平田', department: '普通', quota: 88, finalApplicants: 105, finalRate: 1.19, page: 1, rowIndex: 25 },
    { schoolName: '出雲', department: '普通', quota: 143, finalApplicants: 160, finalRate: 1.12, page: 1, rowIndex: 26 },
    { schoolName: '出雲', department: '理数', quota: 24, finalApplicants: 24, finalRate: 1.0, page: 1, rowIndex: 27 },
    { schoolName: '出雲工業', department: '機械', quota: 22, finalApplicants: 22, finalRate: 1.0, page: 1, rowIndex: 28 },
    { schoolName: '出雲工業', department: '電気', quota: 24, finalApplicants: 21, finalRate: 0.88, page: 1, rowIndex: 29 },
    { schoolName: '出雲工業', department: '電子機械', quota: 24, finalApplicants: 30, finalRate: 1.25, page: 1, rowIndex: 30 },
    { schoolName: '出雲工業', department: '建築', quota: 21, finalApplicants: 26, finalRate: 1.24, page: 1, rowIndex: 31 },
    { schoolName: '出雲商業', department: '商業', quota: 68, finalApplicants: 56, finalRate: 0.82, page: 1, rowIndex: 32 },
    { schoolName: '出雲商業', department: '情報処理', quota: 24, finalApplicants: 21, finalRate: 0.88, page: 1, rowIndex: 33 },
    { schoolName: '出雲農林', department: '植物科学', quota: 23, finalApplicants: 20, finalRate: 0.87, page: 1, rowIndex: 34 },
    { schoolName: '出雲農林', department: '環境科学', quota: 19, finalApplicants: 20, finalRate: 1.05, page: 1, rowIndex: 35 },
    { schoolName: '出雲農林', department: '食品科学', quota: 23, finalApplicants: 24, finalRate: 1.04, page: 1, rowIndex: 36 },
    { schoolName: '出雲農林', department: '動物科学', quota: 23, finalApplicants: 29, finalRate: 1.26, page: 1, rowIndex: 37 },
    { schoolName: '大社', department: '普通', quota: 140, finalApplicants: 163, finalRate: 1.16, page: 1, rowIndex: 38 },
    { schoolName: '大社', department: '体育', quota: 12, finalApplicants: 16, finalRate: 1.33, page: 1, rowIndex: 39 },
    { schoolName: '大田', department: '普通', quota: 92, finalApplicants: 76, finalRate: 0.83, page: 1, rowIndex: 40 },
    { schoolName: '大田', department: '理数', quota: 30, finalApplicants: 7, finalRate: 0.23, page: 1, rowIndex: 41 },
    { schoolName: '邇摩', department: '総合学科', quota: 68, finalApplicants: 24, finalRate: 0.35, page: 1, rowIndex: 42 },
    { schoolName: '島根中央', department: '普通', quota: 55, finalApplicants: 22, finalRate: 0.4, page: 1, rowIndex: 43 },
    { schoolName: '矢上', department: '普通', quota: 41, finalApplicants: 11, finalRate: 0.27, page: 1, rowIndex: 44 },
    { schoolName: '矢上', department: '産業技術', quota: 20, finalApplicants: 18, finalRate: 0.9, page: 1, rowIndex: 45 },
    { schoolName: '江津', department: '普通', quota: 49, finalApplicants: 13, finalRate: 0.27, page: 1, rowIndex: 46 },
    { schoolName: '江津工業', department: '機械・ロボット', quota: 33, finalApplicants: 5, finalRate: 0.15, page: 1, rowIndex: 47 },
    { schoolName: '江津工業', department: '建築・電気', quota: 22, finalApplicants: 27, finalRate: 1.23, page: 1, rowIndex: 48 },
    { schoolName: '浜田', department: '普通', quota: 92, finalApplicants: 68, finalRate: 0.74, page: 1, rowIndex: 49 },
    { schoolName: '浜田', department: '理数', quota: 29, finalApplicants: 8, finalRate: 0.28, page: 1, rowIndex: 50 },
    { schoolName: '浜田商業', department: '商業(商業・情報処理)', quota: 44, finalApplicants: 29, finalRate: 0.66, page: 1, rowIndex: 51 },
    { schoolName: '浜田水産', department: '海洋技術', quota: 22, finalApplicants: 10, finalRate: 0.45, page: 1, rowIndex: 53 },
    { schoolName: '浜田水産', department: '食品流通', quota: 30, finalApplicants: 4, finalRate: 0.13, page: 1, rowIndex: 54 },
    { schoolName: '益田', department: '普通', quota: 106, finalApplicants: 101, finalRate: 0.95, page: 1, rowIndex: 55 },
    { schoolName: '益田', department: '理数', quota: 38, finalApplicants: 14, finalRate: 0.37, page: 1, rowIndex: 56 },
    { schoolName: '益田翔陽', department: '電子機械', quota: 24, finalApplicants: 6, finalRate: 0.25, page: 1, rowIndex: 57 },
    { schoolName: '益田翔陽', department: '電気', quota: 22, finalApplicants: 8, finalRate: 0.36, page: 1, rowIndex: 58 },
    { schoolName: '益田翔陽', department: '生物環境工学', quota: 22, finalApplicants: 12, finalRate: 0.55, page: 1, rowIndex: 59 },
    { schoolName: '益田翔陽', department: '総合学科', quota: 22, finalApplicants: 12, finalRate: 0.55, page: 1, rowIndex: 60 },
    { schoolName: '吉賀', department: '普通', quota: 18, finalApplicants: 3, finalRate: 0.17, page: 1, rowIndex: 61 },
    { schoolName: '津和野', department: '未来共創', quota: 44, finalApplicants: 20, finalRate: 0.45, page: 1, rowIndex: 62 },
    { schoolName: '隠岐', department: '普通', quota: 38, finalApplicants: 4, finalRate: 0.11, page: 1, rowIndex: 63 },
    { schoolName: '隠岐', department: '商業', quota: 24, finalApplicants: 10, finalRate: 0.42, page: 1, rowIndex: 64 },
    {
      schoolName: '隠岐島前',
    ...
    { schoolName: '隠岐水産', department: '海洋システム', quota: 26, finalApplicants: 14, finalRate: 0.54, page: 1, rowIndex: 67 },
    { schoolName: '隠岐水産', department: '海洋生産', quota: 28, finalApplicants: 9, finalRate: 0.32, page: 1, rowIndex: 68 },
    { schoolName: '皆美が丘女子', department: '普通', quota: 53, finalApplicants: 46, finalRate: 0.87, page: 1, rowIndex: 69 },
