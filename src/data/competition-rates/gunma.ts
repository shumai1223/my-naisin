...
export const GUNMA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8（出典ロケータ）: 2026-09-10にPDFを再取得しSHA-256を計測（全3頁・
      // 241,464バイト）。学校別詳細表は物理ページ1〜2（3頁目は詳細表対象外）。106件全レコード
      // のpage/rowIndexは`bairitsu-ingest/parsers/gunma.ts`の`parseGunma()`
      // （`__fixtures__/gunma-r8-geometry.json`を再実行）で機械算出し、既存のquota/
      // finalApplicants/finalRateと全106件一致することを確認した上でバックフィルした
      // （既存データの値自体は一切書き換えていない）。
      pdfSha256: '242bfa16ee0687ff90ab0c5dd7bb91e42030d2e24aacfd88fbd08a5b149b42d3',
    },
    {
  ...
  officialSubtotals: [],
  records: [
    { schoolName: '前橋', department: '普通', quota: 280, finalApplicants: 314, finalRate: 1.12, page: 1, rowIndex: 0 },
    { schoolName: '前橋南', department: '普通', quota: 200, finalApplicants: 209, finalRate: 1.05, page: 1, rowIndex: 1 },
    { schoolName: '前橋西', department: '普通', quota: 160, finalApplicants: 138, finalRate: 0.86, page: 1, rowIndex: 2 },
    { schoolName: '前橋女子', department: '普通', quota: 280, finalApplicants: 294, finalRate: 1.05, page: 1, rowIndex: 3 },
    { schoolName: '前橋東', department: '総合', quota: 200, finalApplicants: 217, finalRate: 1.09, page: 1, rowIndex: 4 },
    { schoolName: '勢多農林', department: '植物科学', quota: 80, finalApplicants: 78, finalRate: 0.98, page: 1, rowIndex: 5 },
    { schoolName: '勢多農林', department: '動物科学（資源動物）', quota: 20, finalApplicants: 19, finalRate: 0.95, page: 1, rowIndex: 6 },
    { schoolName: '勢多農林', department: '動物科学（応用動物）', quota: 20, finalApplicants: 22, finalRate: 1.1, page: 1, rowIndex: 7 },
    { schoolName: '勢多農林', department: '緑地土木', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 1, rowIndex: 8 },
    { schoolName: '勢多農林', department: '食品科学', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 1, rowIndex: 9 },
    { schoolName: '前橋工業', department: '機械', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 1, rowIndex: 10 },
    { schoolName: '前橋工業', department: '電子機械', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 1, rowIndex: 11 },
    { schoolName: '前橋工業', department: '電気', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 1, rowIndex: 12 },
    { schoolName: '前橋工業', department: '電子', quota: 40, finalApplicants: 31, finalRate: 0.78, page: 1, rowIndex: 13 },
    { schoolName: '前橋工業', department: '建築', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 1, rowIndex: 14 },
    { schoolName: '前橋工業', department: '土木', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 1, rowIndex: 15 },
    { schoolName: '前橋商業', department: '商業', quota: 280, finalApplicants: 307, finalRate: 1.1, page: 1, rowIndex: 16 },
    { schoolName: '前橋清陵', department: '普通（昼間部）', quota: 80, finalApplicants: 68, finalRate: 0.85, page: 1, rowIndex: 17 },
    { schoolName: '前橋清陵', department: '普通（夜間部）', quota: 80, finalApplicants: 48, finalRate: 0.6, page: 1, rowIndex: 18 },
    { schoolName: '高崎', department: '普通', quota: 280, finalApplicants: 354, finalRate: 1.26, page: 1, rowIndex: 19 },
    { schoolName: '高崎東', department: '普通', quota: 160, finalApplicants: 144, finalRate: 0.9, page: 1, rowIndex: 20 },
    { schoolName: '高崎北', department: '普通', quota: 240, finalApplicants: 251, finalRate: 1.05, page: 1, rowIndex: 21 },
    { schoolName: '榛名', department: '普通', quota: 72, finalApplicants: 28, finalRate: 0.39, page: 1, rowIndex: 22 },
    { schoolName: '高崎女子', department: '普通', quota: 280, finalApplicants: 298, finalRate: 1.06, page: 1, rowIndex: 23 },
    { schoolName: '吉井', department: '総合', quota: 120, finalApplicants: 79, finalRate: 0.66, page: 1, rowIndex: 24 },
    { schoolName: '高崎工業', department: '機械', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 1, rowIndex: 25 },
    { schoolName: '高崎工業', department: '電気', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 1, rowIndex: 26 },
    { schoolName: '高崎工業', department: '情報技術', quota: 40, finalApplicants: 58, finalRate: 1.45, page: 1, rowIndex: 27 },
    { schoolName: '高崎工業', department: '建築', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 1, rowIndex: 28 },
    { schoolName: '高崎工業', department: '土木', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 1, rowIndex: 29 },
    { schoolName: '高崎工業', department: '工業化学', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 1, rowIndex: 30 },
    { schoolName: '高崎商業', department: '商業（グローバル/会計/情報/総合ビジネス）', quota: 280, finalApplicants: 295, finalRate: 1.05, page: 1, rowIndex: 31 },
    { schoolName: '桐生', department: '普通', quota: 240, finalApplicants: 272, finalRate: 1.13, page: 1, rowIndex: 32 },
    { schoolName: '桐生', department: '理数', quota: 80, finalApplicants: 112, finalRate: 1.4, page: 1, rowIndex: 33 },
    { schoolName: '桐生清桜', department: '普通', quota: 160, finalApplicants: 144, finalRate: 0.9, page: 1, rowIndex: 34 },
    { schoolName: '桐生清桜', department: '普通（アドバンスト探究）', quota: 80, finalApplicants: 88, finalRate: 1.1, page: 1, rowIndex: 35 },
    { schoolName: '桐生工業', department: '機械', quota: 80, finalApplicants: 55, finalRate: 0.69, page: 1, rowIndex: 36 },
    { schoolName: '桐生工業', department: '建設', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 1, rowIndex: 37 },
    { schoolName: '桐生工業', department: '創造技術（電気）', quota: 20, finalApplicants: 19, finalRate: 0.95, page: 1, rowIndex: 38 },
    { schoolName: '桐生工業', department: '創造技術（染織デザイン）', quota: 20, finalApplicants: 14, finalRate: 0.7, page: 1, rowIndex: 39 },
    { schoolName: '伊勢崎', department: '普通', quota: 280, finalApplicants: 344, finalRate: 1.23, page: 1, rowIndex: 40 },
    { schoolName: '伊勢崎清明', department: '普通', quota: 200, finalApplicants: 230, finalRate: 1.15, page: 1, rowIndex: 41 },
    { schoolName: '伊勢崎興陽', department: '総合', quota: 200, finalApplicants: 212, finalRate: 1.06, page: 1, rowIndex: 42 },
    { schoolName: '伊勢崎工業', department: '機械', quota: 80, finalApplicants: 84, finalRate: 1.05, page: 1, rowIndex: 43 },
    { schoolName: '伊勢崎工業', department: '電子機械', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 1, rowIndex: 44 },
    { schoolName: '伊勢崎工業', department: '電気', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 1, rowIndex: 45 },
    { schoolName: '伊勢崎工業', department: '工業化学', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 1, rowIndex: 46 },
    { schoolName: '伊勢崎商業', department: '商業', quota: 200, finalApplicants: 196, finalRate: 0.98, page: 1, rowIndex: 47 },
    { schoolName: '太田', department: '普通', quota: 240, finalApplicants: 247, finalRate: 1.03, page: 1, rowIndex: 48 },
    { schoolName: '太田東', department: '普通', quota: 240, finalApplicants: 253, finalRate: 1.05, page: 1, rowIndex: 49 },
    { schoolName: '太田女子', department: '普通', quota: 240, finalApplicants: 236, finalRate: 0.98, page: 1, rowIndex: 50 },
    { schoolName: '新田暁', department: '総合', quota: 160, finalApplicants: 151, finalRate: 0.94, page: 1, rowIndex: 51 },
    { schoolName: '太田工業', department: '機械', quota: 80, finalApplicants: 76, finalRate: 0.95, page: 1, rowIndex: 52 },
    { schoolName: '太田工業', department: '電気情報', quota: 40, finalApplicants: 30, finalRate: 0.75, page: 1, rowIndex: 53 },
    { schoolName: '太田フレックス', department: '普通（Ⅰ部・昼）', quota: 80, finalApplicants: 71, finalRate: 0.89, page: 1, rowIndex: 54 },
    { schoolName: '太田フレックス', department: '普通（Ⅱ部・昼）', quota: 80, finalApplicants: 71, finalRate: 0.89, page: 1, rowIndex: 55 },
    { schoolName: '太田フレックス', department: '普通（Ⅲ部・夜）', quota: 80, finalApplicants: 18, finalRate: 0.23, page: 1, rowIndex: 56 },
    { schoolName: '沼田', department: '普通', quota: 160, finalApplicants: 131, finalRate: 0.82, page: 1, rowIndex: 57 },
    { schoolName: '沼田', department: '文理探究', quota: 40, finalApplicants: 61, finalRate: 1.53, page: 1, rowIndex: 58 },
    { schoolName: '利根実業', department: '生物生産', quota: 80, finalApplicants: 68, finalRate: 0.85, page: 1, rowIndex: 59 },
    { schoolName: '利根実業', department: '創生工学（機械）', quota: 20, finalApplicants: 22, finalRate: 1.1, page: 1, rowIndex: 60 },
    { schoolName: '利根実業', department: '創生工学（建設）', quota: 20, finalApplicants: 27, finalRate: 1.35, page: 1, rowIndex: 61 },
    { schoolName: '館林', department: '普通', quota: 160, finalApplicants: 140, finalRate: 0.88, page: 2, rowIndex: 0 },
    { schoolName: '館林女子', department: '普通', quota: 160, finalApplicants: 189, finalRate: 1.18, page: 2, rowIndex: 1 },
    { schoolName: '渋川', department: '普通', quota: 160, finalApplicants: 164, finalRate: 1.03, page: 2, rowIndex: 2 },
    { schoolName: '渋川女子', department: '普通', quota: 200, finalApplicants: 196, finalRate: 0.98, page: 2, rowIndex: 3 },
    { schoolName: '渋川青翠', department: '総合', quota: 120, finalApplicants: 103, finalRate: 0.86, page: 2, rowIndex: 4 },
    { schoolName: '渋川工業', department: '機械', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 2, rowIndex: 5 },
    { schoolName: '渋川工業', department: '自動車', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 2, rowIndex: 6 },
    { schoolName: '渋川工業', department: '電気', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 2, rowIndex: 7 },
    { schoolName: '渋川工業', department: '情報システム', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 2, rowIndex: 8 },
    { schoolName: '藤岡中央', department: '普通', quota: 160, finalApplicants: 135, finalRate: 0.84, page: 2, rowIndex: 9 },
    { schoolName: '藤岡北', department: '生物生産', quota: 120, finalApplicants: 111, finalRate: 0.93, page: 2, rowIndex: 10 },
    { schoolName: '藤岡工業', department: 'ものづくり創造', quota: 80, finalApplicants: 44, finalRate: 0.55, page: 2, rowIndex: 11 },
    { schoolName: '富岡', department: '普通', quota: 200, finalApplicants: 169, finalRate: 0.85, page: 2, rowIndex: 12 },
    { schoolName: '富岡実業', department: '生物生産', quota: 120, finalApplicants: 116, finalRate: 0.97, page: 2, rowIndex: 13 },
    { schoolName: '松井田', department: '普通', quota: 72, finalApplicants: 34, finalRate: 0.47, page: 2, rowIndex: 14 },
    { schoolName: '安中総合学園', department: '総合', quota: 200, finalApplicants: 168, finalRate: 0.84, page: 2, rowIndex: 15 },
    { schoolName: '大間々', department: '普通', quota: 120, finalApplicants: 94, finalRate: 0.78, page: 2, rowIndex: 16 },
    { schoolName: '下仁田', department: '普通', quota: 44, finalApplicants: 17, finalRate: 0.39, page: 2, rowIndex: 17 },
    { schoolName: '吾妻中央', department: '普通', quota: 72, finalApplicants: 45, finalRate: 0.63, page: 2, rowIndex: 18 },
    { schoolName: '吾妻中央', department: '生物生産', quota: 40, finalApplicants: 48, finalRate: 1.2, page: 2, rowIndex: 19 },
    { schoolName: '吾妻中央', department: '環境工学', quota: 40, finalApplicants: 19, finalRate: 0.48, page: 2, rowIndex: 20 },
    { schoolName: '吾妻中央', department: '福祉', quota: 40, finalApplicants: 19, finalRate: 0.48, page: 2, rowIndex: 21 },
    { schoolName: '長野原', department: '普通', quota: 44, finalApplicants: 29, finalRate: 0.66, page: 2, rowIndex: 22 },
    { schoolName: '玉村', department: '普通', quota: 80, finalApplicants: 43, finalRate: 0.54, page: 2, rowIndex: 23 },
    { schoolName: '板倉', department: '普通', quota: 72, finalApplicants: 44, finalRate: 0.61, page: 2, rowIndex: 24 },
    { schoolName: '館林商工', department: '生産システム', quota: 80, finalApplicants: 54, finalRate: 0.68, page: 2, rowIndex: 25 },
    { schoolName: '館林商工', department: '総合ビジネス', quota: 80, finalApplicants: 59, finalRate: 0.74, page: 2, rowIndex: 26 },
    { schoolName: '西邑楽', department: '普通', quota: 120, finalApplicants: 106, finalRate: 0.88, page: 2, rowIndex: 27 },
    { schoolName: '西邑楽', department: 'スポーツ', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 2, rowIndex: 28 },
    { schoolName: '西邑楽', department: '芸術（音楽）', quota: 12, finalApplicants: 1, finalRate: 0.08, page: 2, rowIndex: 29 },
    { schoolName: '西邑楽', department: '芸術（美術）', quota: 20, finalApplicants: 18, finalRate: 0.9, page: 2, rowIndex: 30 },
    { schoolName: '大泉', department: '普通', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 2, rowIndex: 31 },
    { schoolName: '大泉', department: '生物生産', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 2, rowIndex: 32 },
    { schoolName: '大泉', department: 'グリーンサイエンス', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 2, rowIndex: 33 },
    { schoolName: '大泉', department: '食品科学', quota: 40, finalApplicants: 48, finalRate: 1.2, page: 2, rowIndex: 34 },
    { schoolName: '市立前橋', department: '普通', quota: 240, finalApplicants: 270, finalRate: 1.13, page: 2, rowIndex: 35 },
    { schoolName: '高崎経済大学附属', department: '普通', quota: 245, finalApplicants: 312, finalRate: 1.27, page: 2, rowIndex: 36 },
    { schoolName: '高崎経済大学附属', department: '芸術（音楽系）', quota: 15, finalApplicants: 9, finalRate: 0.6, page: 2, rowIndex: 37 },
    { schoolName: '高崎経済大学附属', department: '芸術（美術系）', quota: 20, finalApplicants: 26, finalRate: 1.3, page: 2, rowIndex: 38 },
    { schoolName: '桐生市立商業', department: '商業', quota: 200, finalApplicants: 207, finalRate: 1.04, page: 2, rowIndex: 39 },
    { schoolName: '市立太田', department: '商業', quota: 153, finalApplicants: 158, finalRate: 1.03, page: 2, rowIndex: 40 },
    { schoolName: '利根商業', department: '普通', quota: 30, finalApplicants: 7, finalRate: 0.23, page: 2, rowIndex: 41 },
    { schoolName: '利根商業', department: '総合ビジネス', quota: 56, finalApplicants: 13, finalRate: 0.23, page: 2, rowIndex: 42 },
    { schoolName: '利根商業', department: '情報ビジネス', quota: 34, finalApplicants: 16, finalRate: 0.47, page: 2, rowIndex: 43 },
