 ...
 * 令和6年度(2024年度)の「一般選抜志願状況（志願変更後）」告知ページ(`kiji003101127`)は現行
 * サイトが404・Wayback CDXでは2件のスナップショット(2024-04-13/2024-08-15)のHTML自体は取得
 * できた（2026-09-14にInternet Archive復旧後に再確認・両方とも同一PDF `3_101127_308541_
 * up_a4spvixc.pdf`を指す）が、**そのPDF本体自体がWayback CDXに1件も存在しない**（HTMLページは
 * クロールされたがリンク先PDFはクロールされなかった）。現行サイトも同PDF・ページとも404。
 * 推測で埋めず、R6は本ファイルへ未収録のまま「取得不能」として最終確定する。この経路の再試行は
 * 不要（Waybackの復旧待ちではなく、そもそもPDF自体がアーカイブされていないことが確定したため）。
 */
...
export const SAGA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      pdfSha256: '4f8537257f150458c79e90edf49e46eca3c54fa290437b4180455d9e9a06b6f2',
    },
    {
  ...
  records: [
    { schoolName: '鳥栖', department: '普通科', quota: 117, finalApplicants: 125, finalRate: 1.07, page: 1, rowIndex: 0 },
    { schoolName: '三養基', department: '普通科', quota: 178, finalApplicants: 183, finalRate: 1.03, page: 1, rowIndex: 1 },
    { schoolName: '神埼', department: '普通科・こども教育進学コース（くくり募集）', quota: 84, finalApplicants: 54, finalRate: 0.64, page: 1, rowIndex: 2 },
    { schoolName: '佐賀東', department: '普通科・スポーツ科（くくり募集）', quota: 184, finalApplicants: 130, finalRate: 0.71, page: 1, rowIndex: 3 },
    { schoolName: '佐賀西', department: '普通科', quota: 280, finalApplicants: 337, finalRate: 1.2, page: 1, rowIndex: 4 },
    { schoolName: '佐賀北', department: '普通科', quota: 197, finalApplicants: 314, finalRate: 1.59, page: 1, rowIndex: 5 },
    { schoolName: '佐賀北', department: '芸術科', quota: 19, finalApplicants: 24, finalRate: 1.26, page: 1, rowIndex: 6 },
    { schoolName: '致遠館', department: '普通科', quota: 64, finalApplicants: 91, finalRate: 1.42, page: 1, rowIndex: 7 },
    { schoolName: '致遠館', department: '理数科', quota: 60, finalApplicants: 68, finalRate: 1.13, page: 1, rowIndex: 8 },
    { schoolName: '小城', department: '普通科', quota: 181, finalApplicants: 228, finalRate: 1.26, page: 1, rowIndex: 9 },
    { schoolName: '唐津東', department: '普通科', quota: 123, finalApplicants: 143, finalRate: 1.16, page: 1, rowIndex: 10 },
    {
      schoolName: '唐津西',
    ...
    { schoolName: '厳木', department: '普通科（総合評価枠）', quota: 32, finalApplicants: 36, finalRate: 1.13, page: 1, rowIndex: 12 },
    { schoolName: '厳木', department: '普通科（重点評価枠）', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 1, rowIndex: 13 },
    { schoolName: '伊万里', department: '普通科・MIRAI進学科（くくり募集）', quota: 133, finalApplicants: 117, finalRate: 0.88, page: 1, rowIndex: 14 },
    { schoolName: '武雄', department: '普通科', quota: 117, finalApplicants: 122, finalRate: 1.04, page: 1, rowIndex: 15 },
    { schoolName: '白石', department: '普通科', quota: 102, finalApplicants: 81, finalRate: 0.79, page: 1, rowIndex: 16 },
    ...
    { schoolName: '鹿島', department: '商業科', quota: 35, finalApplicants: 28, finalRate: 0.8, page: 1, rowIndex: 18 },
    { schoolName: '鹿島', department: '食品調理科', quota: 22, finalApplicants: 15, finalRate: 0.68, page: 1, rowIndex: 19 },
    { schoolName: '太良', department: '普通科（総合評価枠）', quota: 29, finalApplicants: 19, finalRate: 0.66, page: 1, rowIndex: 20 },
    { schoolName: '太良', department: '普通科（重点評価枠）', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 1, rowIndex: 21 },
    { schoolName: '牛津', department: '生活経営科', quota: 23, finalApplicants: 16, finalRate: 0.7, page: 1, rowIndex: 22 },
    { schoolName: '牛津', department: '服飾デザイン科', quota: 26, finalApplicants: 9, finalRate: 0.35, page: 1, rowIndex: 23 },
    { schoolName: '牛津', department: '食品調理科', quota: 18, finalApplicants: 23, finalRate: 1.28, page: 1, rowIndex: 24 },
    { schoolName: '高志館', department: '食品流通科', quota: 38, finalApplicants: 30, finalRate: 0.79, page: 1, rowIndex: 25 },
    { schoolName: '高志館', department: '園芸科学科', quota: 36, finalApplicants: 28, finalRate: 0.78, page: 1, rowIndex: 26 },
    { schoolName: '高志館', department: '環境緑地科', quota: 35, finalApplicants: 12, finalRate: 0.34, page: 1, rowIndex: 27 },
    { schoolName: '唐津南', department: '生産技術科', quota: 19, finalApplicants: 18, finalRate: 0.95, page: 1, rowIndex: 28 },
    { schoolName: '唐津南', department: '食品流通科', quota: 21, finalApplicants: 24, finalRate: 1.14, page: 1, rowIndex: 29 },
    { schoolName: '唐津南', department: '生活教養科', quota: 23, finalApplicants: 26, finalRate: 1.13, page: 1, rowIndex: 30 },
    { schoolName: '伊万里実業', department: '生物科学科', quota: 29, finalApplicants: 24, finalRate: 0.83, page: 1, rowIndex: 31 },
    { schoolName: '伊万里実業', department: '森林環境科', quota: 16, finalApplicants: 15, finalRate: 0.94, page: 1, rowIndex: 32 },
    { schoolName: '伊万里実業', department: 'フードビジネス科', quota: 26, finalApplicants: 24, finalRate: 0.92, page: 1, rowIndex: 33 },
    { schoolName: '伊万里実業', department: '商業科', quota: 26, finalApplicants: 26, finalRate: 1.0, page: 1, rowIndex: 34 },
    { schoolName: '伊万里実業', department: '情報処理科', quota: 25, finalApplicants: 16, finalRate: 0.64, page: 1, rowIndex: 35 },
    { schoolName: '佐賀農業', department: '農業科学科', quota: 23, finalApplicants: 29, finalRate: 1.26, page: 1, rowIndex: 36 },
    { schoolName: '佐賀農業', department: '食品科学科', quota: 30, finalApplicants: 24, finalRate: 0.8, page: 1, rowIndex: 37 },
    { schoolName: '佐賀農業', department: '環境工学科', quota: 25, finalApplicants: 28, finalRate: 1.12, page: 1, rowIndex: 38 },
    { schoolName: '鳥栖工業', department: '機械科', quota: 46, finalApplicants: 50, finalRate: 1.09, page: 2, rowIndex: 0 },
    { schoolName: '鳥栖工業', department: '電子機械科', quota: 29, finalApplicants: 26, finalRate: 0.9, page: 2, rowIndex: 1 },
    { schoolName: '鳥栖工業', department: '電気科', quota: 23, finalApplicants: 22, finalRate: 0.96, page: 2, rowIndex: 2 },
    { schoolName: '鳥栖工業', department: '建築科', quota: 39, finalApplicants: 31, finalRate: 0.79, page: 2, rowIndex: 3 },
    { schoolName: '鳥栖工業', department: '土木科', quota: 12, finalApplicants: 16, finalRate: 1.33, page: 2, rowIndex: 4 },
    { schoolName: '佐賀工業', department: '機械科', quota: 29, finalApplicants: 37, finalRate: 1.28, page: 2, rowIndex: 5 },
    { schoolName: '佐賀工業', department: '機械システム科', quota: 28, finalApplicants: 28, finalRate: 1.0, page: 2, rowIndex: 6 },
    { schoolName: '佐賀工業', department: '電気科', quota: 34, finalApplicants: 46, finalRate: 1.35, page: 2, rowIndex: 7 },
    { schoolName: '佐賀工業', department: '電子科', quota: 37, finalApplicants: 43, finalRate: 1.16, page: 2, rowIndex: 8 },
    { schoolName: '佐賀工業', department: '情報システム科', quota: 33, finalApplicants: 44, finalRate: 1.33, page: 2, rowIndex: 9 },
    { schoolName: '佐賀工業', department: '建築科', quota: 35, finalApplicants: 40, finalRate: 1.14, page: 2, rowIndex: 10 },
    { schoolName: '唐津工業', department: '機械科', quota: 32, finalApplicants: 39, finalRate: 1.22, page: 2, rowIndex: 11 },
    { schoolName: '唐津工業', department: '電気科', quota: 39, finalApplicants: 32, finalRate: 0.82, page: 2, rowIndex: 12 },
    { schoolName: '唐津工業', department: '建築科', quota: 38, finalApplicants: 28, finalRate: 0.74, page: 2, rowIndex: 13 },
    { schoolName: '唐津工業', department: '土木科', quota: 39, finalApplicants: 14, finalRate: 0.36, page: 2, rowIndex: 14 },
    { schoolName: '有田工業', department: '機械科', quota: 36, finalApplicants: 35, finalRate: 0.97, page: 2, rowIndex: 15 },
    { schoolName: '有田工業', department: '電気科', quota: 35, finalApplicants: 32, finalRate: 0.91, page: 2, rowIndex: 16 },
    { schoolName: '有田工業', department: 'セラミック科', quota: 22, finalApplicants: 18, finalRate: 0.82, page: 2, rowIndex: 17 },
    { schoolName: '有田工業', department: 'デザイン科', quota: 24, finalApplicants: 17, finalRate: 0.71, page: 2, rowIndex: 18 },
    { schoolName: '嬉野', department: '機械科', quota: 23, finalApplicants: 24, finalRate: 1.04, page: 2, rowIndex: 19 },
    { schoolName: '嬉野', department: '電気科・建築科（くくり募集）', quota: 25, finalApplicants: 20, finalRate: 0.8, page: 2, rowIndex: 20 },
    { schoolName: '嬉野', department: '総合学科', quota: 64, finalApplicants: 38, finalRate: 0.59, page: 2, rowIndex: 21 },
    { schoolName: '鳥栖商業', department: '商業科・流通経済科（くくり募集）', quota: 105, finalApplicants: 84, finalRate: 0.8 },
    { schoolName: '鳥栖商業', department: '情報管理科', quota: 34, finalApplicants: 37, finalRate: 1.09, page: 2, rowIndex: 22 },
    { schoolName: '佐賀商業', department: '商業科・グローバルビジネス科（くくり募集）', quota: 144, finalApplicants: 186, finalRate: 1.29 },
    { schoolName: '佐賀商業', department: '情報処理科', quota: 30, finalApplicants: 35, finalRate: 1.17, page: 2, rowIndex: 23 },
    { schoolName: '唐津商業', department: '商業科・会計科（くくり募集）', quota: 140, finalApplicants: 158, finalRate: 1.13 },
    { schoolName: '神埼清明', department: '総合学科', quota: 66, finalApplicants: 82, finalRate: 1.24, page: 2, rowIndex: 24 },
    { schoolName: '多久', department: '総合学科', quota: 103, finalApplicants: 80, finalRate: 0.78, page: 2, rowIndex: 25 },
    { schoolName: '唐津青翔', department: '総合学科', quota: 43, finalApplicants: 39, finalRate: 0.91, page: 2, rowIndex: 26 },
    { schoolName: '唐津青翔', department: 'eスポーツ学科', quota: 12, finalApplicants: 15, finalRate: 1.25, page: 2, rowIndex: 27 },
