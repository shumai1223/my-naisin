...
export const HOKKAIDO_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8: 全14頁(空知〜根室の14管内)をpdftoppm 150dpiでレンダリングし
      // Read toolで全頁目視確認。各頁内は印字順=データ配列順と完全一致(連携型テーブル・
      // 定時制・見送り分[滝川西「情報マネジメント科」]はスコープ外またはtsに対応レコードが
      // 無いためrowIndexのカウント対象外)。ビジョン11県で唯一「1PDF内の物理頁=各管内の
      // 印刷ページそのもの」という素直な構造で、aichi/tokyo型のアノマリーや複雑な
      // source分割は無かった。
      pdfSha256: '61b040f3c4e08a89187f8f3c914d6d791981a647f5bd1a2a16b435291c32285c',
    },
    {
  ...
  coverage: {
    ...
    note:
      ...
      'を行順突合した(結合セルなし)。' +
      '⚠️2026-08-07追記15(掛-1第12弾): 釧路地区のR7分21レコード(普通9+専門/総合12)も追加した' +
      '(PDF内部頁13=印字ページ21)。学校・学科構成はR8と完全一致(普通9校=釧路湖陵文理探究・釧路江南・' +
      ...
      '⚠️2026-08-24追記(3年度目・掛-1第14弾・空知地区のみ着手): R6(令和6年度)報告書ページ' +
      '(dokyoi.pref.hokkaido.lg.jp/hk/gks/193247.html)から同一シリーズのp9-22_gakkoubetu.pdf' +
      '(全14頁)を発見し、まず空知地区(PDF内部頁1)の32レコード(普通12+専門/総合20)を追加した。' +
      '300dpiビジョン解析で2回精読しR7(31レコード)と突合したところ、実際の年度差3件を検出した' +
      '(誤読ではなく2回の独立読み取りで再現・確定): ①岩見沢西「普通」(quota120)がR6のみ存在し' +
      'R7/R8には無い(募集停止または統合の可能性) ②岩見沢東「文理探究」(quota80)はR7で新設され' +
      'R6には無い(R6は普通quota200のみ・R7で普通quota160+文理探究80に再編) ③深川東「総合ビジネス」' +
      '(quota40)はR6のみでR7には無い。pdftotext -layoutは数値列を正確抽出できたが学科名欄の' +
      'CJKラベルは他頁同様読めず、学校名・学科名は300dpiビジョン解析で確認し数値列と行順突合した' +
      '(結合セルなし・空知R7と同水準の確度)。' +
      '⚠️2026-08-24追記2(掛-1第15弾): 石狩地区のR6分57レコード(普通31+専門/総合26)も追加した' +
      '(PDF内部頁2〜3=印字ページ10〜11)。R7(普通31+専門/総合26=57)と学校名・学科構成が完全一致' +
      '(空知と異なり年度差なし)。300dpiビジョン解析で数値列を確認し、pdftotext -layoutの数値列とも' +
      '突合した(結合セルなし)。' +
      ...
      '⚠️2026-08-24追記11(掛-1第24弾): オホーツク地区のR6分31レコード(普通16+専門/総合15)も' +
      '追加した(印字ページ19に普通・専門/総合の両テーブルが1頁で収まっていた)。R7(普通16+専門/総合15' +
      '=31)と学校名・学科構成が完全一致(普通16校=北見北斗・北見柏陽・北見緑陵・常呂・美幌・津別・' +
      '訓子府・佐呂間・網走南ケ丘・網走桂陽・清里・遠軽・湧別・紋別・興部・雄武、専門/総合15レコード=' +
      '北見北斗理数・美幌未来農業・北見工業(電子機械・電気・建設)・紋別電子機械・北見商業(商業・' +
      '流通経済・情報処理)・網走桂陽(商業・事務情報)・紋別総合ビジネス・置戸福祉・斜里総合・大空総合・' +
      '年度差なし。ただし大空総合のquotaはR7=36(半端値)に対しR6画像は40(20)と読め、受検者数43との' +
      ...
      '11レコード(普通5+専門6)を追加し、**これでhokkaido全14管内(空知/石狩/札幌市/後志/胆振/日高/' +
      '渡島/檜山/上川/留萌/宗谷/オホーツク/十勝/釧路/根室)のR6完走を達成した**(R6合計329レコード・' +
      ...
      '**掛-1(学校別×多年度)のR6(3年度目)全14管内完走はこれで達成**。' +
      '⚠️2026-08-24追記15: 同一シリーズのR5(4年度目)版ページの有無を調査した結果、教委サイトの' +
      '一覧ページ(hk/gks/koukounyuusenn.html)には「公立高等学校入学者選抜実施状況報告書」として' +
      '**R8/R7/R6の3年度分のみが掲載されており、R5版へのリンクは存在しない**ことを確認した' +
      '(WebFetchで一覧ページ本文を直接精読・R5への言及なし)。**このシリーズは常に直近3年度分のみを' +
      '公開するローリングウィンドウ方式と推定され、hokkaidoの多年度化はこの一次ソース単体では' +
      'R6(3年度分)が実質的な上限**（新しい年度が追加されるたびに最古の年度が既に非公開化されている' +
      '可能性が高く、過去に遡ってR5等を取得する経路は無い）。' +
      '⚠️2026-08-24追記16(訂正): 直前の追記15で書いた「②他県への多年度化技法の横展開」は誤り' +
      'だったと判明した。`ops/tasks/T-A1-school-multiyear.md`を確認したところ、多年度**表示**機能' +
      '(`buildSchoolHistoryForPrefecture`)は特定県ごとの実装が不要な汎用関数として既に全47県に' +
      'ライブ提供済み(2026-08-12完了)。「技法の横展開」という作業自体が存在しない。同ファイルに' +
      'よれば、新規データ収集が必要だったのはhokkaido/nara/niigata/oita/sagaの5県のみで、' +
      'nara・niigataは既に別セッションで3年度化済み、hokkaidoは本セッションで完走、oita・sagaは' +
      '別途Wayback・現行サイトとも取得不可と確定済み(2026-08-24 15:5x台の同セッション内調査)。' +
      '**つまりT-A1(学校ページ多年度化)は事実上全47県で決着済み(45県ライブ・2県は恒久的にソース欠如)**。' +
      'この一次ソースを起点とする「掛-1(学校別×多年度)」タスク系列に、これ以上の水平展開先は無い。' +
      '次回セッションはLOOP_CONTRACT §0の他候補（AA/S13-A追撃・DEADWIRE/PROPOSALS残項目等）から選ぶこと。' +
      '(coverage.statusは既存の\'partial\'のまま・全14管内の普通/専門を収録も、連携型のみスコープ外のためpartialを維持)。',
  },
  officialSubtotals: [],
  records: [
    { schoolName: '岩見沢東', department: '普通', quota: 160, finalApplicants: 134, finalRate: 0.84, page: 1, rowIndex: 0 },
    { schoolName: '岩見沢東', department: '文理探究', quota: 80, finalApplicants: 79, finalRate: 0.99, page: 1, rowIndex: 1 },
    { schoolName: '月形', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.42, page: 1, rowIndex: 2 },
    { schoolName: '夕張', department: '普通', quota: 40, finalApplicants: 18, finalRate: 0.45, page: 1, rowIndex: 3 },
    { schoolName: '長沼', department: '普通', quota: 80, finalApplicants: 35, finalRate: 0.44, page: 1, rowIndex: 4 },
    { schoolName: '栗山', department: '普通', quota: 80, finalApplicants: 30, finalRate: 0.38, page: 1, rowIndex: 5 },
    { schoolName: '岩見沢緑陵', department: '普通', quota: 160, finalApplicants: 161, finalRate: 1.01, page: 1, rowIndex: 6 },
    { schoolName: '滝川', department: '普通', quota: 160, finalApplicants: 168, finalRate: 1.05, page: 1, rowIndex: 7 },
    { schoolName: '砂川', department: '普通', quota: 80, finalApplicants: 70, finalRate: 0.88, page: 1, rowIndex: 8 },
    { schoolName: '芦別', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.42, page: 1, rowIndex: 9 },
    { schoolName: '深川西', department: '普通', quota: 80, finalApplicants: 53, finalRate: 0.66, page: 1, rowIndex: 10 },
    { schoolName: '滝川西', department: '普通', quota: 120, finalApplicants: 126, finalRate: 1.05, page: 1, rowIndex: 11 },
    { schoolName: '滝川', department: '理数', quota: 40, finalApplicants: 33, finalRate: 0.82, page: 1, rowIndex: 12 },
    { schoolName: '岩見沢農業', department: '酪農科学', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 1, rowIndex: 13 },
    { schoolName: '岩見沢農業', department: '畜産科学', quota: 40, finalApplicants: 30, finalRate: 0.75, page: 1, rowIndex: 14 },
    { schoolName: '岩見沢農業', department: '食品科学', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 1, rowIndex: 15 },
    { schoolName: '岩見沢農業', department: '農業土木工学', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 1, rowIndex: 16 },
    { schoolName: '岩見沢農業', department: '環境造園科', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 1, rowIndex: 17 },
    { schoolName: '岩見沢農業', department: '森林科学科', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 1, rowIndex: 18 },
    { schoolName: '岩見沢農業', department: '生活科学', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 1, rowIndex: 19 },
    { schoolName: '深川東', department: '生産科学', quota: 40, finalApplicants: 23, finalRate: 0.57, page: 1, rowIndex: 20 },
    { schoolName: '新十津川農業', department: '農業・生活', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 1, rowIndex: 21 },
    { schoolName: '滝川工業', department: '電子機械', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 1, rowIndex: 22 },
    { schoolName: '滝川工業', department: '電気', quota: 40, finalApplicants: 8, finalRate: 0.2, page: 1, rowIndex: 23 },
    { schoolName: '岩見沢緑陵', department: 'みらい設計', quota: 80, finalApplicants: 84, finalRate: 1.05, page: 1, rowIndex: 24 },
    { schoolName: '三笠', department: '調理師', quota: 20, finalApplicants: 27, finalRate: 1.35, page: 1, rowIndex: 25 },
    { schoolName: '三笠', department: '製菓', quota: 20, finalApplicants: 25, finalRate: 1.25, page: 1, rowIndex: 26 },
    { schoolName: '美唄聖華', department: '衛生看護', quota: 80, finalApplicants: 44, finalRate: 0.55, page: 1, rowIndex: 27 },
    { schoolName: '美唄尚栄', department: '総合', quota: 80, finalApplicants: 37, finalRate: 0.46, page: 1, rowIndex: 28 },
    { schoolName: '札幌東', department: '普通', quota: 320, finalApplicants: 416, finalRate: 1.3, page: 2, rowIndex: 0 },
    { schoolName: '札幌西', department: '普通', quota: 320, finalApplicants: 454, finalRate: 1.42, page: 2, rowIndex: 1 },
    { schoolName: '札幌南', department: '普通', quota: 320, finalApplicants: 412, finalRate: 1.29, page: 2, rowIndex: 2 },
    { schoolName: '札幌北', department: '普通', quota: 320, finalApplicants: 391, finalRate: 1.22, page: 2, rowIndex: 3 },
    { schoolName: '札幌月寒', department: '普通', quota: 320, finalApplicants: 414, finalRate: 1.29, page: 2, rowIndex: 4 },
    { schoolName: '札幌啓成', department: '普通', quota: 280, finalApplicants: 317, finalRate: 1.13, page: 2, rowIndex: 5 },
    { schoolName: '札幌北陵', department: '普通', quota: 320, finalApplicants: 364, finalRate: 1.14, page: 2, rowIndex: 6 },
    { schoolName: '札幌手稲', department: '普通', quota: 320, finalApplicants: 340, finalRate: 1.06, page: 2, rowIndex: 7 },
    { schoolName: '札幌丘珠', department: '普通', quota: 280, finalApplicants: 235, finalRate: 0.84, page: 2, rowIndex: 8 },
    { schoolName: '札幌西陵', department: '普通', quota: 240, finalApplicants: 194, finalRate: 0.81, page: 2, rowIndex: 9 },
    { schoolName: '札幌白石', department: '普通', quota: 280, finalApplicants: 360, finalRate: 1.29, page: 2, rowIndex: 10 },
    { schoolName: '札幌東陵', department: '普通', quota: 280, finalApplicants: 329, finalRate: 1.18, page: 2, rowIndex: 11 },
    { schoolName: '札幌南陵', department: '普通', quota: 80, finalApplicants: 64, finalRate: 0.8, page: 2, rowIndex: 12 },
    { schoolName: '札幌東豊', department: '普通', quota: 80, finalApplicants: 66, finalRate: 0.83, page: 2, rowIndex: 13 },
    { schoolName: '札幌真栄', department: '普通', quota: 200, finalApplicants: 162, finalRate: 0.81, page: 2, rowIndex: 14 },
    { schoolName: '札幌あすかぜ', department: '普通', quota: 80, finalApplicants: 59, finalRate: 0.74, page: 2, rowIndex: 15 },
    { schoolName: '札幌稲雲', department: '普通', quota: 280, finalApplicants: 313, finalRate: 1.12, page: 2, rowIndex: 16 },
    { schoolName: '札幌英藍', department: '普通', quota: 280, finalApplicants: 261, finalRate: 0.93, page: 2, rowIndex: 17 },
    { schoolName: '札幌平岡', department: '普通', quota: 240, finalApplicants: 315, finalRate: 1.31, page: 2, rowIndex: 18 },
    { schoolName: '札幌白陵', department: '普通', quota: 80, finalApplicants: 41, finalRate: 0.51, page: 2, rowIndex: 19 },
    { schoolName: '札幌国際情報', department: '普通', quota: 80, finalApplicants: 118, finalRate: 1.48, page: 2, rowIndex: 20 },
    { schoolName: '江別', department: '普通', quota: 200, finalApplicants: 225, finalRate: 1.13, page: 2, rowIndex: 21 },
    { schoolName: '野幌', department: '普通', quota: 120, finalApplicants: 68, finalRate: 0.57, page: 2, rowIndex: 22 },
    { schoolName: '大麻', department: '普通', quota: 280, finalApplicants: 274, finalRate: 0.98, page: 2, rowIndex: 23 },
    { schoolName: '千歳', department: '普通', quota: 200, finalApplicants: 254, finalRate: 1.27, page: 2, rowIndex: 24 },
    { schoolName: '北広島', department: '普通', quota: 280, finalApplicants: 317, finalRate: 1.13, page: 2, rowIndex: 25 },
    { schoolName: '北広島西', department: '普通', quota: 160, finalApplicants: 88, finalRate: 0.55, page: 2, rowIndex: 26 },
    { schoolName: '石狩南', department: '普通', quota: 280, finalApplicants: 319, finalRate: 1.14, page: 2, rowIndex: 27 },
    { schoolName: '当別', department: '普通', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 2, rowIndex: 28 },
    { schoolName: '恵庭南', department: '普通', quota: 200, finalApplicants: 130, finalRate: 0.65, page: 2, rowIndex: 29 },
    { schoolName: '恵庭北', department: '普通', quota: 240, finalApplicants: 204, finalRate: 0.85, page: 2, rowIndex: 30 },
    { schoolName: '札幌啓成', department: '理数', quota: 40, finalApplicants: 69, finalRate: 1.73, page: 3, rowIndex: 0 },
    { schoolName: '恵庭南', department: '体育', quota: 80, finalApplicants: 76, finalRate: 0.95, page: 3, rowIndex: 1 },
    { schoolName: '札幌国際情報', department: '国際文化', quota: 80, finalApplicants: 95, finalRate: 1.19, page: 3, rowIndex: 2 },
    { schoolName: '千歳', department: '国際教養', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 3, rowIndex: 3 },
    { schoolName: '当別', department: '園芸デザイン', quota: 40, finalApplicants: 23, finalRate: 0.58, page: 3, rowIndex: 4 },
    { schoolName: '札幌工業', department: '機械', quota: 80, finalApplicants: 87, finalRate: 1.09, page: 3, rowIndex: 5 },
    { schoolName: '札幌工業', department: '電気', quota: 80, finalApplicants: 86, finalRate: 1.08, page: 3, rowIndex: 6 },
    { schoolName: '札幌工業', department: '建築', quota: 80, finalApplicants: 76, finalRate: 0.95, page: 3, rowIndex: 7 },
    { schoolName: '札幌工業', department: '土木', quota: 80, finalApplicants: 58, finalRate: 0.73, page: 3, rowIndex: 8 },
    { schoolName: '札幌琴似工業', department: '電子機械', quota: 80, finalApplicants: 83, finalRate: 1.04, page: 3, rowIndex: 9 },
    { schoolName: '札幌琴似工業', department: '電気', quota: 80, finalApplicants: 72, finalRate: 0.9, page: 3, rowIndex: 10 },
    { schoolName: '札幌琴似工業', department: '情報技術', quota: 80, finalApplicants: 67, finalRate: 0.84, page: 3, rowIndex: 11 },
    { schoolName: '札幌琴似工業', department: '環境化学', quota: 80, finalApplicants: 57, finalRate: 0.71, page: 3, rowIndex: 12 },
    { schoolName: '札幌国際情報', department: '理数工学', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 3, rowIndex: 13 },
    { schoolName: '札幌東商業', department: '流通経済', quota: 80, finalApplicants: 102, finalRate: 1.28, page: 3, rowIndex: 14 },
    { schoolName: '札幌東商業', department: '国際経済', quota: 80, finalApplicants: 89, finalRate: 1.11, page: 3, rowIndex: 15 },
    { schoolName: '札幌東商業', department: '会計ビジネス', quota: 80, finalApplicants: 76, finalRate: 0.95, page: 3, rowIndex: 16 },
    { schoolName: '札幌東商業', department: '情報処理', quota: 80, finalApplicants: 94, finalRate: 1.18, page: 3, rowIndex: 17 },
    { schoolName: '札幌国際情報', department: 'グローバルビジネス', quota: 120, finalApplicants: 137, finalRate: 1.14, page: 3, rowIndex: 18 },
    { schoolName: '江別', department: '事務情報', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 3, rowIndex: 19 },
    { schoolName: '千歳', department: '国際流通', quota: 80, finalApplicants: 83, finalRate: 1.04, page: 3, rowIndex: 20 },
    { schoolName: '江別', department: '生活デザイン', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 3, rowIndex: 21 },
    { schoolName: '当別', department: '家政', quota: 40, finalApplicants: 19, finalRate: 0.48, page: 3, rowIndex: 22 },
    { schoolName: '石狩翔陽', department: '総合', quota: 320, finalApplicants: 348, finalRate: 1.09, page: 3, rowIndex: 23 },
    { schoolName: '札幌厚別', department: '総合', quota: 280, finalApplicants: 293, finalRate: 1.05, page: 3, rowIndex: 24 },
    { schoolName: '千歳北陽', department: '総合', quota: 160, finalApplicants: 121, finalRate: 0.76, page: 3, rowIndex: 25 },
    { schoolName: '市立札幌旭丘', department: '普通', quota: 240, finalApplicants: 351, finalRate: 1.46, page: 4, rowIndex: 0 },
    { schoolName: '市立札幌藻岩', department: '普通', quota: 240, finalApplicants: 301, finalRate: 1.25, page: 4, rowIndex: 1 },
    { schoolName: '市立札幌平岸', department: '普通', quota: 280, finalApplicants: 388, finalRate: 1.39, page: 4, rowIndex: 2 },
    { schoolName: '市立札幌平岸', department: 'デザインアート', quota: 40, finalApplicants: 50, finalRate: 1.25, page: 4, rowIndex: 3 },
    { schoolName: '市立札幌清田', department: '普通', quota: 200, finalApplicants: 251, finalRate: 1.25, page: 4, rowIndex: 4 },
    { schoolName: '市立札幌清田', department: 'グローバル', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 4, rowIndex: 5 },
    { schoolName: '市立札幌新川', department: '普通', quota: 320, finalApplicants: 403, finalRate: 1.26, page: 4, rowIndex: 6 },
    { schoolName: '市立札幌旭丘', department: '数理データサイエンス', quota: 80, finalApplicants: 90, finalRate: 1.13, page: 4, rowIndex: 7 },
    { schoolName: '市立札幌啓北商業', department: '未来商学', quota: 240, finalApplicants: 191, finalRate: 0.8, page: 4, rowIndex: 8 },
    { schoolName: '小樽潮陵', department: '普通', quota: 200, finalApplicants: 205, finalRate: 1.02, page: 5, rowIndex: 0 },
    { schoolName: '小樽桜陽', department: '普通', quota: 200, finalApplicants: 176, finalRate: 0.88, page: 5, rowIndex: 1 },
    { schoolName: '岩内', department: '普通', quota: 80, finalApplicants: 61, finalRate: 0.76, page: 5, rowIndex: 2 },
    { schoolName: '寿都', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 5, rowIndex: 3 },
    { schoolName: '蘭越', department: '普通', quota: 40, finalApplicants: 23, finalRate: 0.57, page: 5, rowIndex: 4 },
    { schoolName: '倶知安', department: '普通', quota: 160, finalApplicants: 108, finalRate: 0.68, page: 5, rowIndex: 5 },
    { schoolName: '倶知安農業', department: '生産科学', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 5, rowIndex: 6 },
    { schoolName: '小樽未来創造', department: '機械電気システム', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 5, rowIndex: 7 },
    { schoolName: '小樽未来創造', department: '建設システム', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 5, rowIndex: 8 },
    { schoolName: '小樽未来創造', department: '流通マネジメント', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 5, rowIndex: 9 },
    { schoolName: '小樽未来創造', department: '情報会計マネジメント', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 5, rowIndex: 10 },
    { schoolName: '岩内', department: '地域産業ビジネス', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 5, rowIndex: 11 },
    { schoolName: '小樽水産', department: '海洋漁業', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 5, rowIndex: 12 },
    { schoolName: '小樽水産', department: '水産食品', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 5, rowIndex: 13 },
    { schoolName: '小樽水産', department: '栽培漁業', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 5, rowIndex: 14 },
    { schoolName: '小樽水産', department: '情報通信', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 5, rowIndex: 15 },
    { schoolName: '余市紅志', department: '総合', quota: 40, finalApplicants: 29, finalRate: 0.73, page: 5, rowIndex: 16 },
    { schoolName: 'ニセコ国際', department: '総合', quota: 70, finalApplicants: 59, finalRate: 0.84, page: 5, rowIndex: 17 },
    { schoolName: '室蘭栄', department: '普通', quota: 120, finalApplicants: 134, finalRate: 1.12, page: 5, rowIndex: 18 },
    { schoolName: '室蘭清水丘', department: '普通', quota: 160, finalApplicants: 132, finalRate: 0.83, page: 5, rowIndex: 19 },
    { schoolName: '登別青嶺', department: '普通', quota: 120, finalApplicants: 62, finalRate: 0.52, page: 5, rowIndex: 20 },
    { schoolName: '伊達開来', department: '普通', quota: 160, finalApplicants: 119, finalRate: 0.74, page: 5, rowIndex: 21 },
    { schoolName: '苫小牧東', department: '普通', quota: 240, finalApplicants: 312, finalRate: 1.3, page: 5, rowIndex: 22 },
    { schoolName: '苫小牧西', department: '普通', quota: 160, finalApplicants: 182, finalRate: 1.14, page: 5, rowIndex: 23 },
    { schoolName: '苫小牧南', department: '普通', quota: 160, finalApplicants: 184, finalRate: 1.15, page: 5, rowIndex: 24 },
    { schoolName: '白老東', department: '普通', quota: 80, finalApplicants: 31, finalRate: 0.39, page: 5, rowIndex: 25 },
    { schoolName: '追分', department: '普通', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 5, rowIndex: 26 },
    { schoolName: '厚真', department: '普通', quota: 40, finalApplicants: 16, finalRate: 0.4, page: 5, rowIndex: 27 },
    { schoolName: '鵡川', department: '普通', quota: 80, finalApplicants: 49, finalRate: 0.61, page: 5, rowIndex: 28 },
    { schoolName: '室蘭栄', department: '理数', quota: 80, finalApplicants: 69, finalRate: 0.86, page: 6, rowIndex: 0 },
    { schoolName: '壮瞥', department: '地域農業', quota: 40, finalApplicants: 23, finalRate: 0.58, page: 6, rowIndex: 1 },
    { schoolName: '室蘭工業', department: '電子機械', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 6, rowIndex: 2 },
    { schoolName: '室蘭工業', department: '電気', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 6, rowIndex: 3 },
    { schoolName: '室蘭工業', department: '建設', quota: 40, finalApplicants: 31, finalRate: 0.78, page: 6, rowIndex: 4 },
    { schoolName: '苫小牧工業', department: '電子機械', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 6, rowIndex: 5 },
    { schoolName: '苫小牧工業', department: '電気', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 6, rowIndex: 6 },
    { schoolName: '苫小牧工業', department: '情報技術', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 6, rowIndex: 7 },
    { schoolName: '苫小牧工業', department: '建築', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 6, rowIndex: 8 },
    { schoolName: '苫小牧工業', department: '土木', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 6, rowIndex: 9 },
    { schoolName: '苫小牧工業', department: '環境化学', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 6, rowIndex: 10 },
    { schoolName: '虻田', department: '事務情報', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 6, rowIndex: 11 },
    { schoolName: '苫小牧総合経済', department: '流通経済', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 6, rowIndex: 12 },
    { schoolName: '苫小牧総合経済', department: '国際経済', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 6, rowIndex: 13 },
    { schoolName: '苫小牧総合経済', department: '情報処理', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 6, rowIndex: 14 },
    { schoolName: '室蘭東翔', department: '総合', quota: 160, finalApplicants: 155, finalRate: 0.97, page: 6, rowIndex: 15 },
    { schoolName: '平取', department: '普通', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 6, rowIndex: 16 },
    { schoolName: '富川', department: '普通', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 6, rowIndex: 17 },
    { schoolName: '静内', department: '普通', quota: 200, finalApplicants: 152, finalRate: 0.76, page: 6, rowIndex: 18 },
    { schoolName: 'えりも', department: '普通', quota: 70, finalApplicants: 28, finalRate: 0.4, page: 6, rowIndex: 19 },
    { schoolName: '静内農業', department: '食品科学', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 7, rowIndex: 0 },
    { schoolName: '静内農業', department: '生産科学', quota: 40, finalApplicants: 46, finalRate: 1.15, page: 7, rowIndex: 1 },
    { schoolName: '浦河総合', department: '総合', quota: 120, finalApplicants: 87, finalRate: 0.73, page: 7, rowIndex: 2 },
    { schoolName: '函館中部', department: '普通', quota: 160, finalApplicants: 186, finalRate: 1.16, page: 7, rowIndex: 3 },
    { schoolName: '函館西', department: '普通', quota: 240, finalApplicants: 301, finalRate: 1.25, page: 7, rowIndex: 4 },
    { schoolName: '南茅部', department: '普通', quota: 40, finalApplicants: 9, finalRate: 0.23, page: 7, rowIndex: 5 },
    { schoolName: '上磯', department: '普通', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 7, rowIndex: 6 },
    { schoolName: '七飯', department: '普通', quota: 120, finalApplicants: 100, finalRate: 0.83, page: 7, rowIndex: 7 },
    { schoolName: '松前', department: '普通', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 7, rowIndex: 8 },
    { schoolName: '八雲', department: '普通', quota: 80, finalApplicants: 65, finalRate: 0.81, page: 7, rowIndex: 9 },
    { schoolName: '長万部', department: '普通', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 7, rowIndex: 10 },
    { schoolName: '市立函館', department: '普通', quota: 200, finalApplicants: 283, finalRate: 1.42, page: 7, rowIndex: 11 },
    { schoolName: '知内', department: '普通', quota: 80, finalApplicants: 71, finalRate: 0.89, page: 7, rowIndex: 12 },
    { schoolName: '函館中部', department: '理数', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 8, rowIndex: 0 },
    { schoolName: '大野農業', department: '農業科学', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 8, rowIndex: 1 },
    { schoolName: '大野農業', department: '園芸福祉', quota: 40, finalApplicants: 18, finalRate: 0.45, page: 8, rowIndex: 2 },
    { schoolName: '大野農業', department: '食品科学', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 8, rowIndex: 3 },
    { schoolName: '函館工業', department: '電子機械', quota: 40, finalApplicants: 50, finalRate: 1.25, page: 8, rowIndex: 4 },
    { schoolName: '函館工業', department: '電気情報工学', quota: 40, finalApplicants: 47, finalRate: 1.18, page: 8, rowIndex: 5 },
    { schoolName: '函館工業', department: '建築', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 8, rowIndex: 6 },
    { schoolName: '函館工業', department: '環境土木', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 8, rowIndex: 7 },
    { schoolName: '函館工業', department: '工業化学', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 8, rowIndex: 8 },
    { schoolName: '函館商業', department: '流通ビジネス', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 8, rowIndex: 9 },
    { schoolName: '函館商業', department: '国際経済', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 8, rowIndex: 10 },
    { schoolName: '函館商業', department: '会計ビジネス', quota: 40, finalApplicants: 46, finalRate: 1.15, page: 8, rowIndex: 11 },
    { schoolName: '函館商業', department: '情報処理', quota: 40, finalApplicants: 56, finalRate: 1.4, page: 8, rowIndex: 12 },
    { schoolName: '福島商業', department: '商業', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 8, rowIndex: 13 },
    { schoolName: '八雲', department: '総合ビジネス', quota: 40, finalApplicants: 5, finalRate: 0.13, page: 8, rowIndex: 14 },
    { schoolName: '函館水産', department: '海洋技術', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 8, rowIndex: 15 },
    { schoolName: '函館水産', department: '食品創造', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 8, rowIndex: 16 },
    { schoolName: '函館水産', department: '機関工学', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 8, rowIndex: 17 },
    { schoolName: '森', department: '総合', quota: 40, finalApplicants: 31, finalRate: 0.78, page: 8, rowIndex: 18 },
    { schoolName: '江差', department: '普通', quota: 80, finalApplicants: 35, finalRate: 0.44, page: 8, rowIndex: 19 },
    { schoolName: '上ノ国', department: '普通', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 8, rowIndex: 20 },
    { schoolName: '奥尻', department: '普通', quota: 40, finalApplicants: 11, finalRate: 0.28, page: 8, rowIndex: 21 },
    { schoolName: '檜山北', department: '総合', quota: 80, finalApplicants: 55, finalRate: 0.69, page: 8, rowIndex: 22 },
    { schoolName: '旭川東', department: '普通', quota: 240, finalApplicants: 286, finalRate: 1.19, page: 9, rowIndex: 0 },
    { schoolName: '旭川西', department: '普通', quota: 160, finalApplicants: 217, finalRate: 1.36, page: 9, rowIndex: 1 },
    { schoolName: '旭川北', department: '普通', quota: 200, finalApplicants: 230, finalRate: 1.15, page: 9, rowIndex: 2 },
    { schoolName: '旭川永嶺', department: '普通', quota: 200, finalApplicants: 224, finalRate: 1.12, page: 9, rowIndex: 3 },
    { schoolName: '鷹栖', department: '普通', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 9, rowIndex: 4 },
    { schoolName: '東川', department: '普通', quota: 80, finalApplicants: 72, finalRate: 0.9, page: 9, rowIndex: 5 },
    { schoolName: '美瑛', department: '普通', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 9, rowIndex: 6 },
    { schoolName: '上川', department: '普通', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 9, rowIndex: 7 },
    { schoolName: '富良野', department: '普通', quota: 120, finalApplicants: 94, finalRate: 0.78, page: 9, rowIndex: 8 },
    { schoolName: '上富良野', department: '普通', quota: 40, finalApplicants: 22, finalRate: 0.55, page: 9, rowIndex: 9 },
    { schoolName: '南富良野', department: '普通', quota: 40, finalApplicants: 22, finalRate: 0.55, page: 9, rowIndex: 10 },
    { schoolName: '士別翔雲', department: '普通', quota: 120, finalApplicants: 73, finalRate: 0.61, page: 9, rowIndex: 11 },
    { schoolName: '名寄', department: '普通', quota: 160, finalApplicants: 124, finalRate: 0.78, page: 9, rowIndex: 12 },
    { schoolName: '美深', department: '普通', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 9, rowIndex: 13 },
    { schoolName: '旭川西', department: '理数', quota: 40, finalApplicants: 57, finalRate: 1.43, page: 9, rowIndex: 14 },
    { schoolName: 'おといねっぷ美術工芸', department: '工芸', quota: 40, finalApplicants: 37, finalRate: 0.93, page: 9, rowIndex: 15 },
    { schoolName: '旭川農業', department: '農業科学', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 9, rowIndex: 16 },
    { schoolName: '旭川農業', department: '食品科学', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 9, rowIndex: 17 },
    { schoolName: '旭川農業', department: '森林科学', quota: 40, finalApplicants: 30, finalRate: 0.75, page: 9, rowIndex: 18 },
    { schoolName: '旭川農業', department: '生活科学', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 9, rowIndex: 19 },
    { schoolName: '富良野', department: '園芸観光デザイン', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 9, rowIndex: 20 },
    { schoolName: '旭川工業', department: '電子機械', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 9, rowIndex: 21 },
    { schoolName: '旭川工業', department: '電気', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 9, rowIndex: 22 },
    { schoolName: '旭川工業', department: '情報技術', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 9, rowIndex: 23 },
    { schoolName: '旭川工業', department: '建築', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 9, rowIndex: 24 },
    { schoolName: '旭川工業', department: '土木', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 9, rowIndex: 25 },
    { schoolName: '旭川工業', department: '工業化学', quota: 40, finalApplicants: 16, finalRate: 0.4, page: 9, rowIndex: 26 },
    { schoolName: '名寄', department: '情報技術', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 9, rowIndex: 27 },
    { schoolName: '富良野', department: '電気情報システム', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 9, rowIndex: 28 },
    { schoolName: '旭川商業', department: '流通ビジネス', quota: 80, finalApplicants: 73, finalRate: 0.91, page: 9, rowIndex: 29 },
    { schoolName: '旭川商業', department: '国際ビジネス', quota: 40, finalApplicants: 29, finalRate: 0.73, page: 9, rowIndex: 30 },
    { schoolName: '旭川商業', department: '会計', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 9, rowIndex: 31 },
    { schoolName: '旭川商業', department: '情報処理', quota: 40, finalApplicants: 37, finalRate: 0.93, page: 9, rowIndex: 32 },
    { schoolName: '士別翔雲', department: '総合ビジネス', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 9, rowIndex: 33 },
    { schoolName: '下川商業', department: '商業', quota: 40, finalApplicants: 11, finalRate: 0.28, page: 9, rowIndex: 34 },
    { schoolName: '旭川南', department: '総合', quota: 200, finalApplicants: 196, finalRate: 0.98, page: 9, rowIndex: 35 },
    { schoolName: '剣淵', department: '総合', quota: 40, finalApplicants: 11, finalRate: 0.28, page: 9, rowIndex: 36 },
    { schoolName: '留萌', department: '普通', quota: 160, finalApplicants: 108, finalRate: 0.68, page: 10, rowIndex: 0 },
    { schoolName: '羽幌', department: '普通', quota: 80, finalApplicants: 66, finalRate: 0.83, page: 10, rowIndex: 1 },
    { schoolName: '天塩', department: '普通', quota: 40, finalApplicants: 18, finalRate: 0.45, page: 10, rowIndex: 2 },
    { schoolName: '遠別農業', department: '生産科学', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 10, rowIndex: 3 },
    { schoolName: '留萌', department: '電気・建築', quota: 40, finalApplicants: 8, finalRate: 0.2, page: 10, rowIndex: 4 },
    { schoolName: '留萌', department: '情報ビジネス', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 10, rowIndex: 5 },
    { schoolName: '苫前商業', department: '商業', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 10, rowIndex: 6 },
    { schoolName: '稚内', department: '普通', quota: 120, finalApplicants: 95, finalRate: 0.79, page: 10, rowIndex: 7 },
    { schoolName: '豊富', department: '普通', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 10, rowIndex: 8 },
    { schoolName: '浜頓別', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 10, rowIndex: 9 },
    { schoolName: '枝幸', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 10, rowIndex: 10 },
    { schoolName: '利尻', department: '普通', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 10, rowIndex: 11 },
    { schoolName: '礼文', department: '普通', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 10, rowIndex: 12 },
    { schoolName: '稚内商業', department: '商業', quota: 40, finalApplicants: 37, finalRate: 0.93, page: 10, rowIndex: 13 },
    { schoolName: '稚内', department: '衛生看護', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 10, rowIndex: 14 },
    { schoolName: '北見北斗', department: '普通', quota: 200, finalApplicants: 192, finalRate: 0.96, page: 11, rowIndex: 0 },
    { schoolName: '北見柏陽', department: '普通', quota: 200, finalApplicants: 248, finalRate: 1.24, page: 11, rowIndex: 1 },
    { schoolName: '北見緑陵', department: '普通', quota: 120, finalApplicants: 147, finalRate: 1.23, page: 11, rowIndex: 2 },
    { schoolName: '常呂', department: '普通', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 11, rowIndex: 3 },
    { schoolName: '美幌', department: '普通', quota: 80, finalApplicants: 32, finalRate: 0.4, page: 11, rowIndex: 4 },
    { schoolName: '津別', department: '普通', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 11, rowIndex: 5 },
    { schoolName: '訓子府', department: '普通', quota: 40, finalApplicants: 48, finalRate: 1.2, page: 11, rowIndex: 6 },
    { schoolName: '佐呂間', department: '普通', quota: 40, finalApplicants: 18, finalRate: 0.45, page: 11, rowIndex: 7 },
    { schoolName: '網走南ケ丘', department: '普通', quota: 160, finalApplicants: 175, finalRate: 1.09, page: 11, rowIndex: 8 },
    { schoolName: '網走桂陽', department: '普通', quota: 80, finalApplicants: 61, finalRate: 0.76, page: 11, rowIndex: 9 },
    { schoolName: '清里', department: '普通', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 11, rowIndex: 10 },
    { schoolName: '遠軽', department: '普通', quota: 200, finalApplicants: 163, finalRate: 0.82, page: 11, rowIndex: 11 },
    { schoolName: '湧別', department: '普通', quota: 80, finalApplicants: 51, finalRate: 0.64, page: 11, rowIndex: 12 },
    { schoolName: '紋別', department: '普通', quota: 120, finalApplicants: 73, finalRate: 0.61, page: 11, rowIndex: 13 },
    { schoolName: '興部', department: '普通', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 11, rowIndex: 14 },
    { schoolName: '雄武', department: '普通', quota: 40, finalApplicants: 19, finalRate: 0.48, page: 11, rowIndex: 15 },
    { schoolName: '北見北斗', department: '理数', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 11, rowIndex: 16 },
    { schoolName: '美幌', department: '未来農業', quota: 40, finalApplicants: 3, finalRate: 0.08, page: 11, rowIndex: 17 },
    { schoolName: '北見工業', department: '電子機械', quota: 40, finalApplicants: 37, finalRate: 0.93, page: 11, rowIndex: 18 },
    { schoolName: '北見工業', department: '電気', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 11, rowIndex: 19 },
    { schoolName: '北見工業', department: '建設', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 11, rowIndex: 20 },
    { schoolName: '紋別', department: '電子機械', quota: 40, finalApplicants: 14, finalRate: 0.35, page: 11, rowIndex: 21 },
    { schoolName: '北見商業', department: '商業', quota: 40, finalApplicants: 30, finalRate: 0.75, page: 11, rowIndex: 22 },
    { schoolName: '北見商業', department: '流通経済', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 11, rowIndex: 23 },
    { schoolName: '北見商業', department: '情報処理', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 11, rowIndex: 24 },
    { schoolName: '網走桂陽', department: '商業', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 11, rowIndex: 25 },
    { schoolName: '網走桂陽', department: '事務情報', quota: 40, finalApplicants: 4, finalRate: 0.1, page: 11, rowIndex: 26 },
    { schoolName: '紋別', department: '総合ビジネス', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 11, rowIndex: 27 },
    { schoolName: '置戸', department: '福祉', quota: 40, finalApplicants: 25, finalRate: 0.63, page: 11, rowIndex: 28 },
    { schoolName: '斜里', department: '総合', quota: 40, finalApplicants: 9, finalRate: 0.23, page: 11, rowIndex: 29 },
    { schoolName: '大空', department: '総合', quota: 36, finalApplicants: 45, finalRate: 1.25, page: 11, rowIndex: 30 },
    { schoolName: '帯広柏葉', department: '普通', quota: 240, finalApplicants: 280, finalRate: 1.17, page: 12, rowIndex: 0 },
    { schoolName: '帯広三条', department: '普通', quota: 240, finalApplicants: 263, finalRate: 1.1, page: 12, rowIndex: 1 },
    { schoolName: '帯広緑陽', department: '普通', quota: 160, finalApplicants: 195, finalRate: 1.22, page: 12, rowIndex: 2 },
    { schoolName: '音更', department: '普通', quota: 120, finalApplicants: 60, finalRate: 0.5, page: 12, rowIndex: 3 },
    { schoolName: '上士幌', department: '普通', quota: 80, finalApplicants: 60, finalRate: 0.75, page: 12, rowIndex: 4 },
    { schoolName: '芽室', department: '普通', quota: 160, finalApplicants: 218, finalRate: 1.36, page: 12, rowIndex: 5 },
    { schoolName: '幕別清陵', department: '普通', quota: 120, finalApplicants: 112, finalRate: 0.93, page: 12, rowIndex: 6 },
    { schoolName: '鹿追', department: '普通', quota: 80, finalApplicants: 50, finalRate: 0.63, page: 12, rowIndex: 7 },
    { schoolName: '大樹', department: '地域探究', quota: 40, finalApplicants: 19, finalRate: 0.48, page: 12, rowIndex: 8 },
    { schoolName: '広尾', department: '普通', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 12, rowIndex: 9 },
    { schoolName: '本別', department: '普通', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 12, rowIndex: 10 },
    { schoolName: '足寄', department: '普通', quota: 80, finalApplicants: 46, finalRate: 0.58, page: 12, rowIndex: 11 },
    { schoolName: '帯広農業', department: '農業科学', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 12, rowIndex: 12 },
    { schoolName: '帯広農業', department: '酪農科学', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 12, rowIndex: 13 },
    { schoolName: '帯広農業', department: '食品科学', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 12, rowIndex: 14 },
    { schoolName: '帯広農業', department: '農業土木工学', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 12, rowIndex: 15 },
    { schoolName: '帯広農業', department: '森林科学', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 12, rowIndex: 16 },
    { schoolName: '更別農業', department: '農業', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 12, rowIndex: 17 },
    { schoolName: '更別農業', department: '生活科学', quota: 40, finalApplicants: 6, finalRate: 0.15, page: 12, rowIndex: 18 },
    { schoolName: '士幌', department: 'アグリビジネス', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 12, rowIndex: 19 },
    { schoolName: '士幌', department: 'フードシステム', quota: 40, finalApplicants: 26, finalRate: 0.65, page: 12, rowIndex: 20 },
    { schoolName: '帯広工業', department: '電子機械', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 12, rowIndex: 21 },
    { schoolName: '帯広工業', department: '電気', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 12, rowIndex: 22 },
    { schoolName: '帯広工業', department: '建築', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 12, rowIndex: 23 },
    { schoolName: '帯広工業', department: '環境土木', quota: 40, finalApplicants: 51, finalRate: 1.28, page: 12, rowIndex: 24 },
    { schoolName: '帯広南商業', department: '商業', quota: 200, finalApplicants: 246, finalRate: 1.23, page: 12, rowIndex: 25 },
    { schoolName: '清水', department: '総合', quota: 120, finalApplicants: 63, finalRate: 0.53, page: 12, rowIndex: 26 },
    { schoolName: '池田', department: '総合', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 12, rowIndex: 27 },
    { schoolName: '釧路湖陵', department: '文理探究', quota: 160, finalApplicants: 187, finalRate: 1.17, page: 13, rowIndex: 0 },
    { schoolName: '釧路江南', department: '普通', quota: 200, finalApplicants: 206, finalRate: 1.03, page: 13, rowIndex: 1 },
    { schoolName: '釧路東', department: '普通', quota: 80, finalApplicants: 61, finalRate: 0.76, page: 13, rowIndex: 2 },
    { schoolName: '阿寒', department: '普通', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 13, rowIndex: 3 },
    { schoolName: '白糠', department: '普通', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 13, rowIndex: 4 },
    { schoolName: '弟子屈', department: '普通', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 13, rowIndex: 5 },
    { schoolName: '厚岸翔洋', department: '普通', quota: 40, finalApplicants: 9, finalRate: 0.23, page: 13, rowIndex: 6 },
    { schoolName: '釧路北陽', department: '普通', quota: 200, finalApplicants: 204, finalRate: 1.02, page: 13, rowIndex: 7 },
    { schoolName: '霧多布', department: '普通', quota: 60, finalApplicants: 15, finalRate: 0.25, page: 13, rowIndex: 8 },
    { schoolName: '釧路湖陵', department: '理数探究', quota: 40, finalApplicants: 46, finalRate: 1.15, page: 13, rowIndex: 9 },
    { schoolName: '釧路工業', department: '電子機械', quota: 40, finalApplicants: 47, finalRate: 1.18, page: 13, rowIndex: 10 },
    { schoolName: '釧路工業', department: '電気', quota: 40, finalApplicants: 18, finalRate: 0.45, page: 13, rowIndex: 11 },
    { schoolName: '釧路工業', department: '建築', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 13, rowIndex: 12 },
    { schoolName: '釧路工業', department: '土木', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 13, rowIndex: 13 },
    { schoolName: '釧路工業', department: '工業化学', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 13, rowIndex: 14 },
    { schoolName: '釧路商業', department: '流通マネジメント', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 13, rowIndex: 15 },
    { schoolName: '釧路商業', department: '会計マネジメント', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 13, rowIndex: 16 },
    { schoolName: '釧路商業', department: '情報マネジメント', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 13, rowIndex: 17 },
    { schoolName: '厚岸翔洋', department: '海洋資源', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 13, rowIndex: 18 },
    { schoolName: '釧路明輝', department: '総合', quota: 160, finalApplicants: 198, finalRate: 1.24, page: 13, rowIndex: 19 },
    { schoolName: '標茶', department: '総合', quota: 80, finalApplicants: 43, finalRate: 0.54, page: 13, rowIndex: 20 },
    { schoolName: '根室', department: '普通', quota: 120, finalApplicants: 84, finalRate: 0.7, page: 14, rowIndex: 0 },
    { schoolName: '別海', department: '普通', quota: 120, finalApplicants: 61, finalRate: 0.51, page: 14, rowIndex: 1 },
    { schoolName: '中標津', department: '普通', quota: 160, finalApplicants: 121, finalRate: 0.76, page: 14, rowIndex: 2 },
    { schoolName: '標津', department: '普通', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 14, rowIndex: 3 },
    { schoolName: '羅臼', department: '普通', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 14, rowIndex: 4 },
    { schoolName: '別海', department: '酪農経営', quota: 40, finalApplicants: 11, finalRate: 0.28, page: 14, rowIndex: 5 },
    { schoolName: '中標津農業', department: '生産技術', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 14, rowIndex: 6 },
    { schoolName: '中標津農業', department: '食品ビジネス', quota: 40, finalApplicants: 10, finalRate: 0.25, page: 14, rowIndex: 7 },
    { schoolName: '根室', department: '商業', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 14, rowIndex: 8 },
    { schoolName: '根室', department: '事務情報', quota: 40, finalApplicants: 5, finalRate: 0.13, page: 14, rowIndex: 9 },
    { schoolName: '中標津', department: '総合ビジネス', quota: 40, finalApplicants: 23, finalRate: 0.58, page: 14, rowIndex: 10 },
    ...
    // 掛-1第12弾: 釧路地区・全日制普通科・令和7年度（2025年度）分。
    { schoolName: '釧路湖陵', department: '文理探究', quota: 160, finalApplicants: 154, finalRate: 0.96, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路江南', department: '普通', quota: 200, finalApplicants: 201, finalRate: 1.01, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路東', department: '普通', quota: 80, finalApplicants: 58, finalRate: 0.73, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '阿寒', department: '普通', quota: 40, finalApplicants: 21, finalRate: 0.53, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '白糠', department: '普通', quota: 40, finalApplicants: 29, finalRate: 0.73, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '弟子屈', department: '普通', quota: 40, finalApplicants: 16, finalRate: 0.4, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '厚岸翔洋', department: '普通', quota: 40, finalApplicants: 6, finalRate: 0.15, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路北陽', department: '普通', quota: 200, finalApplicants: 221, finalRate: 1.11, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '霧多布', department: '普通', quota: 60, finalApplicants: 15, finalRate: 0.25, fiscalYear: '令和7年度（2025年度）' },
    // 掛-1第12弾: 釧路地区・専門教育を主とする学科及び総合学科・令和7年度（2025年度）分。
    { schoolName: '釧路湖陵', department: '理数探究', quota: 40, finalApplicants: 50, finalRate: 1.25, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路工業', department: '電子機械', quota: 40, finalApplicants: 40, finalRate: 1.0, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路工業', department: '電気', quota: 40, finalApplicants: 27, finalRate: 0.68, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路工業', department: '建築', quota: 40, finalApplicants: 38, finalRate: 0.95, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路工業', department: '土木', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路工業', department: '工業化学', quota: 40, finalApplicants: 20, finalRate: 0.5, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路商業', department: '流通マネジメント', quota: 40, finalApplicants: 41, finalRate: 1.03, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路商業', department: '会計マネジメント', quota: 40, finalApplicants: 44, finalRate: 1.1, fiscalYear: '令和7年度（2025年度）' },
    { schoolName: '釧路商業', department: '情報マネジメント', quota: 40, finalApplicants: 54, finalRate: 1.35, fiscalYear: '令和7年度（2025年度）' },
    ...
    { schoolName: '岩見沢東', department: '普通', quota: 200, finalApplicants: 149, finalRate: 0.75, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢西', department: '普通', quota: 120, finalApplicants: 64, finalRate: 0.53, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '月形', department: '普通', quota: 40, finalApplicants: 18, finalRate: 0.45, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '夕張', department: '普通', quota: 40, finalApplicants: 26, finalRate: 0.65, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '長沼', department: '普通', quota: 80, finalApplicants: 44, finalRate: 0.55, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '栗山', department: '普通', quota: 80, finalApplicants: 49, finalRate: 0.61, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢緑陵', department: '普通', quota: 120, finalApplicants: 114, finalRate: 0.95, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川', department: '普通', quota: 160, finalApplicants: 147, finalRate: 0.92, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '砂川', department: '普通', quota: 80, finalApplicants: 51, finalRate: 0.64, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '芦別', department: '普通', quota: 80, finalApplicants: 26, finalRate: 0.33, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '深川西', department: '普通', quota: 120, finalApplicants: 74, finalRate: 0.62, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川西', department: '普通', quota: 120, finalApplicants: 91, finalRate: 0.76, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川', department: '理数', quota: 40, finalApplicants: 30, finalRate: 0.75, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '農業科学', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '畜産科学', quota: 40, finalApplicants: 16, finalRate: 0.4, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '食品科学', quota: 40, finalApplicants: 36, finalRate: 0.9, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '農業土木工学', quota: 40, finalApplicants: 36, finalRate: 0.9, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '環境造園', quota: 40, finalApplicants: 22, finalRate: 0.55, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '森林科学', quota: 40, finalApplicants: 39, finalRate: 0.98, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢農業', department: '生活科学', quota: 40, finalApplicants: 28, finalRate: 0.7, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '深川東', department: '生産科学', quota: 40, finalApplicants: 10, finalRate: 0.25, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '新十津川農業', department: '農業・生活', quota: 40, finalApplicants: 39, finalRate: 0.98, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川工業', department: '電子機械', quota: 40, finalApplicants: 19, finalRate: 0.48, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川工業', department: '電気', quota: 40, finalApplicants: 34, finalRate: 0.85, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '深川東', department: '総合ビジネス', quota: 40, finalApplicants: 18, finalRate: 0.45, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '奈井江商業', department: '情報処理', quota: 40, finalApplicants: 9, finalRate: 0.23, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '岩見沢緑陵', department: '情報コミュニケーション', quota: 80, finalApplicants: 68, finalRate: 0.85, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '滝川西', department: '情報マネジメント', quota: 120, finalApplicants: 106, finalRate: 0.88, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '三笠', department: '調理師', quota: 20, finalApplicants: 23, finalRate: 1.15, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '三笠', department: '製菓', quota: 20, finalApplicants: 20, finalRate: 1.0, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '美唄聖華', department: '衛生看護', quota: 80, finalApplicants: 44, finalRate: 0.55, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '美唄尚栄', department: '総合', quota: 80, finalApplicants: 52, finalRate: 0.65, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東', department: '普通', quota: 320, finalApplicants: 436, finalRate: 1.36, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌西', department: '普通', quota: 320, finalApplicants: 480, finalRate: 1.5, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌南', department: '普通', quota: 320, finalApplicants: 382, finalRate: 1.19, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌北', department: '普通', quota: 320, finalApplicants: 407, finalRate: 1.27, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌月寒', department: '普通', quota: 320, finalApplicants: 475, finalRate: 1.48, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌啓成', department: '普通', quota: 280, finalApplicants: 307, finalRate: 1.1, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌北陵', department: '普通', quota: 320, finalApplicants: 405, finalRate: 1.27, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌手稲', department: '普通', quota: 320, finalApplicants: 366, finalRate: 1.14, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌丘珠', department: '普通', quota: 280, finalApplicants: 279, finalRate: 1.0, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌西陵', department: '普通', quota: 280, finalApplicants: 242, finalRate: 0.86, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌白石', department: '普通', quota: 280, finalApplicants: 385, finalRate: 1.38, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東陵', department: '普通', quota: 280, finalApplicants: 314, finalRate: 1.12, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌南陵', department: '普通', quota: 80, finalApplicants: 57, finalRate: 0.71, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東豊', department: '普通', quota: 120, finalApplicants: 113, finalRate: 0.94, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌真栄', department: '普通', quota: 200, finalApplicants: 238, finalRate: 1.19, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌あすかぜ', department: '普通', quota: 120, finalApplicants: 82, finalRate: 0.68, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌稲雲', department: '普通', quota: 280, finalApplicants: 280, finalRate: 1.0, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌英藍', department: '普通', quota: 280, finalApplicants: 304, finalRate: 1.09, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌平岡', department: '普通', quota: 240, finalApplicants: 338, finalRate: 1.41, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌白陵', department: '普通', quota: 80, finalApplicants: 65, finalRate: 0.81, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌国際情報', department: '普通', quota: 80, finalApplicants: 96, finalRate: 1.2, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '江別', department: '普通', quota: 200, finalApplicants: 199, finalRate: 1.0, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '野幌', department: '普通', quota: 120, finalApplicants: 88, finalRate: 0.73, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '大麻', department: '普通', quota: 280, finalApplicants: 286, finalRate: 1.02, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '千歳', department: '普通', quota: 200, finalApplicants: 229, finalRate: 1.15, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北広島', department: '普通', quota: 280, finalApplicants: 312, finalRate: 1.11, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北広島西', department: '普通', quota: 160, finalApplicants: 129, finalRate: 0.81, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '石狩南', department: '普通', quota: 280, finalApplicants: 372, finalRate: 1.33, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '当別', department: '普通', quota: 40, finalApplicants: 40, finalRate: 1.0, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '恵庭南', department: '普通', quota: 200, finalApplicants: 170, finalRate: 0.85, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '恵庭北', department: '普通', quota: 240, finalApplicants: 233, finalRate: 0.97, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌啓成', department: '理数', quota: 40, finalApplicants: 61, finalRate: 1.53, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '恵庭南', department: '体育', quota: 80, finalApplicants: 103, finalRate: 1.29, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌国際情報', department: '国際文化', quota: 80, finalApplicants: 95, finalRate: 1.19, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '千歳', department: '国際教養', quota: 40, finalApplicants: 48, finalRate: 1.2, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '当別', department: '園芸デザイン', quota: 40, finalApplicants: 14, finalRate: 0.35, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌工業', department: '機械', quota: 80, finalApplicants: 87, finalRate: 1.09, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌工業', department: '電気', quota: 80, finalApplicants: 84, finalRate: 1.05, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌工業', department: '建築', quota: 80, finalApplicants: 75, finalRate: 0.94, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌工業', department: '土木', quota: 80, finalApplicants: 54, finalRate: 0.68, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌琴似工業', department: '電子機械', quota: 80, finalApplicants: 65, finalRate: 0.81, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌琴似工業', department: '電気', quota: 80, finalApplicants: 77, finalRate: 0.96, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌琴似工業', department: '情報技術', quota: 80, finalApplicants: 73, finalRate: 0.91, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌琴似工業', department: '環境化学', quota: 80, finalApplicants: 61, finalRate: 0.76, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌国際情報', department: '理数工学', quota: 40, finalApplicants: 59, finalRate: 1.48, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東商業', department: '流通経済', quota: 80, finalApplicants: 94, finalRate: 1.18, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東商業', department: '国際経済', quota: 80, finalApplicants: 104, finalRate: 1.3, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東商業', department: '会計ビジネス', quota: 80, finalApplicants: 93, finalRate: 1.16, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌東商業', department: '情報処理', quota: 80, finalApplicants: 101, finalRate: 1.26, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌国際情報', department: 'グローバルビジネス', quota: 120, finalApplicants: 128, finalRate: 1.07, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '江別', department: '事務情報', quota: 40, finalApplicants: 33, finalRate: 0.83, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '千歳', department: '国際流通', quota: 80, finalApplicants: 105, finalRate: 1.31, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '江別', department: '生活デザイン', quota: 40, finalApplicants: 33, finalRate: 0.83, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '当別', department: '家政', quota: 40, finalApplicants: 27, finalRate: 0.68, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '石狩翔陽', department: '総合', quota: 320, finalApplicants: 391, finalRate: 1.22, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '札幌厚別', department: '総合', quota: 280, finalApplicants: 356, finalRate: 1.27, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '千歳北陽', department: '総合', quota: 160, finalApplicants: 118, finalRate: 0.74, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌旭丘', department: '普通', quota: 240, finalApplicants: 334, finalRate: 1.39, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌藻岩', department: '普通', quota: 240, finalApplicants: 300, finalRate: 1.25, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌平岸', department: '普通', quota: 280, finalApplicants: 452, finalRate: 1.61, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌平岸', department: 'デザインアート', quota: 40, finalApplicants: 55, finalRate: 1.38, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌清田', department: '普通', quota: 200, finalApplicants: 250, finalRate: 1.25, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '市立札幌清田', department: 'グローバル', quota: 40, finalApplicants: 52, finalRate: 1.3, fiscalYear: '令和6年度（2024年度）' },
    ...
    // 掛-1第24弾: オホーツク地区・全日制普通科・令和6年度（2024年度）分。
    { schoolName: '北見北斗', department: '普通', quota: 200, finalApplicants: 193, finalRate: 0.97, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見柏陽', department: '普通', quota: 200, finalApplicants: 213, finalRate: 1.07, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見緑陵', department: '普通', quota: 120, finalApplicants: 134, finalRate: 1.12, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '常呂', department: '普通', quota: 40, finalApplicants: 10, finalRate: 0.25, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '美幌', department: '普通', quota: 80, finalApplicants: 50, finalRate: 0.63, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '津別', department: '普通', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '訓子府', department: '普通', quota: 40, finalApplicants: 39, finalRate: 0.98, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '佐呂間', department: '普通', quota: 40, finalApplicants: 25, finalRate: 0.63, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '網走南ケ丘', department: '普通', quota: 160, finalApplicants: 170, finalRate: 1.06, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '網走桂陽', department: '普通', quota: 80, finalApplicants: 75, finalRate: 0.94, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '清里', department: '普通', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '遠軽', department: '普通', quota: 200, finalApplicants: 170, finalRate: 0.85, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '湧別', department: '普通', quota: 80, finalApplicants: 31, finalRate: 0.39, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '紋別', department: '普通', quota: 120, finalApplicants: 93, finalRate: 0.78, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '興部', department: '普通', quota: 40, finalApplicants: 17, finalRate: 0.43, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '雄武', department: '普通', quota: 40, finalApplicants: 19, finalRate: 0.48, fiscalYear: '令和6年度（2024年度）' },
    // 掛-1第24弾: オホーツク地区・専門教育を主とする学科及び総合学科・令和6年度（2024年度）分。
    { schoolName: '北見北斗', department: '理数', quota: 40, finalApplicants: 42, finalRate: 1.05, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '美幌', department: '未来農業', quota: 40, finalApplicants: 26, finalRate: 0.65, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見工業', department: '電子機械', quota: 40, finalApplicants: 29, finalRate: 0.73, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見工業', department: '電気', quota: 40, finalApplicants: 23, finalRate: 0.58, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見工業', department: '建設', quota: 40, finalApplicants: 14, finalRate: 0.35, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '紋別', department: '電子機械', quota: 40, finalApplicants: 14, finalRate: 0.35, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見商業', department: '商業', quota: 40, finalApplicants: 46, finalRate: 1.15, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見商業', department: '流通経済', quota: 40, finalApplicants: 51, finalRate: 1.28, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '北見商業', department: '情報処理', quota: 40, finalApplicants: 48, finalRate: 1.2, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '網走桂陽', department: '商業', quota: 40, finalApplicants: 19, finalRate: 0.48, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '網走桂陽', department: '事務情報', quota: 40, finalApplicants: 14, finalRate: 0.35, fiscalYear: '令和6年度（2024年度）' },
    { schoolName: '紋別', department: '総合ビジネス', quota: 40, finalApplicants: 13, finalRate: 0.33, fiscalYear: '令和6年度（2024年度）' },
