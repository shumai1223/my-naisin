 ...
 * +札幌市(市立高校・全日制)+後志地区(全日制普通科)+胆振地区(全日制普通科)のみ）。
 *
 ...
 * も室蘭工業・苫小牧工業・苫小牧総合経済が複数学科の結合セル形式のため同様に見送った。残り10
 * 地区（日高/渡島/檜山/上川/留萌/宗谷/オホーツク/十勝/釧路/根室）は次回以降のセッションで地区
...
export const HOKKAIDO_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  coverage: {
    ...
    pendingDepartments: [
      ...
      '日高地区・渡島地区・檜山地区・上川地区・留萌地区・宗谷地区・オホーツク地区・十勝地区・釧路地区・根室地区（いずれも未着手）',
