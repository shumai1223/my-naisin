...
export const SAITAMA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    {
      ...
      // T-Y11F §5順序#8: 2026-09-10に再取得して計測。既存の241件のquota/finalApplicants等は書き換えていない
      pdfSha256: '66bd7c1b4eb29a4e2c2e9981d1b5d7f7f5d3c1d42b7ca6cfbaf3c53835c08b1e',
    },
    {
  ...
  records: [
    // ===== 全日制 普通科 =====
    { schoolName: '上尾', department: '普通科', quota: 238, finalApplicants: 316, finalRate: 1.33, page: 1, rowIndex: 0 },
    { schoolName: '上尾鷹の台', department: '普通科', quota: 198, finalApplicants: 182, finalRate: 0.92, page: 1, rowIndex: 1 },
    { schoolName: '上尾橘', department: '普通科', quota: 118, finalApplicants: 53, finalRate: 0.45, page: 1, rowIndex: 2 },
    { schoolName: '上尾南', department: '普通科', quota: 238, finalApplicants: 247, finalRate: 1.04, page: 1, rowIndex: 3 },
    { schoolName: '朝霞', department: '普通科', quota: 318, finalApplicants: 305, finalRate: 0.96, page: 1, rowIndex: 4 },
    { schoolName: '朝霞西', department: '普通科', quota: 318, finalApplicants: 369, finalRate: 1.16, page: 1, rowIndex: 5 },
    { schoolName: '伊奈学園総合', department: '普通科（普通・スポーツ科学・芸術の合算）', quota: 718, finalApplicants: 789, finalRate: 1.1, page: 1, rowIndex: 6 },
    { schoolName: '入間向陽', department: '普通科', quota: 318, finalApplicants: 332, finalRate: 1.04, page: 1, rowIndex: 7 },
    { schoolName: '岩槻', department: '普通科', quota: 278, finalApplicants: 305, finalRate: 1.1, page: 1, rowIndex: 8 },
    { schoolName: '浦和', department: '普通科', quota: 358, finalApplicants: 434, finalRate: 1.21, page: 1, rowIndex: 9 },
    { schoolName: '浦和北', department: '普通科', quota: 318, finalApplicants: 334, finalRate: 1.05, page: 1, rowIndex: 10 },
    { schoolName: '浦和第一女子', department: '普通科', quota: 358, finalApplicants: 437, finalRate: 1.22, page: 1, rowIndex: 11 },
    { schoolName: '浦和西', department: '普通科', quota: 358, finalApplicants: 519, finalRate: 1.45, page: 1, rowIndex: 12 },
    { schoolName: '浦和東', department: '普通科', quota: 318, finalApplicants: 318, finalRate: 1.0, page: 1, rowIndex: 13 },
    { schoolName: '大宮', department: '普通科', quota: 318, finalApplicants: 507, finalRate: 1.59, page: 1, rowIndex: 14 },
    { schoolName: '大宮光陵', department: '普通科', quota: 198, finalApplicants: 203, finalRate: 1.03, page: 1, rowIndex: 15 },
    { schoolName: '大宮光陵', department: '外国語コース', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 1, rowIndex: 16 },
    { schoolName: '大宮東', department: '普通科', quota: 238, finalApplicants: 219, finalRate: 0.92, page: 1, rowIndex: 17 },
    { schoolName: '大宮南', department: '普通科', quota: 358, finalApplicants: 386, finalRate: 1.08, page: 1, rowIndex: 18 },
    { schoolName: '大宮武蔵野', department: '普通科', quota: 198, finalApplicants: 197, finalRate: 0.99, page: 1, rowIndex: 19 },
    { schoolName: '小川', department: '普通科', quota: 198, finalApplicants: 162, finalRate: 0.82, page: 1, rowIndex: 20 },
    { schoolName: '桶川', department: '普通科', quota: 278, finalApplicants: 265, finalRate: 0.95, page: 1, rowIndex: 21 },
    { schoolName: '桶川西', department: '普通科', quota: 118, finalApplicants: 102, finalRate: 0.86, page: 1, rowIndex: 22 },
    { schoolName: '越生翔桜', department: '普通科', quota: 118, finalApplicants: 51, finalRate: 0.43, page: 1, rowIndex: 23 },
    { schoolName: '春日部', department: '普通科', quota: 358, finalApplicants: 473, finalRate: 1.32, page: 1, rowIndex: 24 },
    { schoolName: '春日部女子', department: '普通科', quota: 238, finalApplicants: 243, finalRate: 1.02, page: 1, rowIndex: 25 },
    { schoolName: '春日部東', department: '普通科', quota: 318, finalApplicants: 323, finalRate: 1.02, page: 1, rowIndex: 26 },
    { schoolName: '川口', department: '普通科', quota: 318, finalApplicants: 356, finalRate: 1.12, page: 1, rowIndex: 27 },
    { schoolName: '川口北', department: '普通科', quota: 358, finalApplicants: 374, finalRate: 1.04, page: 1, rowIndex: 28 },
    { schoolName: '川口青陵', department: '普通科', quota: 278, finalApplicants: 277, finalRate: 0.99, page: 1, rowIndex: 29 },
    { schoolName: '川口東', department: '普通科', quota: 278, finalApplicants: 314, finalRate: 1.13, page: 1, rowIndex: 30 },
    { schoolName: '川越', department: '普通科', quota: 358, finalApplicants: 486, finalRate: 1.36, page: 1, rowIndex: 31 },
    { schoolName: '川越女子', department: '普通科', quota: 358, finalApplicants: 435, finalRate: 1.22, page: 1, rowIndex: 32 },
    { schoolName: '川越西', department: '普通科', quota: 278, finalApplicants: 302, finalRate: 1.09, page: 1, rowIndex: 33 },
    { schoolName: '川越初雁', department: '普通科', quota: 198, finalApplicants: 163, finalRate: 0.82, page: 1, rowIndex: 34 },
    { schoolName: '川越南', department: '普通科', quota: 358, finalApplicants: 431, finalRate: 1.2, page: 1, rowIndex: 35 },
    { schoolName: '北本', department: '普通科', quota: 118, finalApplicants: 113, finalRate: 0.96, page: 1, rowIndex: 36 },
    { schoolName: '久喜', department: '普通科', quota: 278, finalApplicants: 244, finalRate: 0.88, page: 1, rowIndex: 37 },
    { schoolName: '熊谷', department: '普通科', quota: 278, finalApplicants: 314, finalRate: 1.13, page: 1, rowIndex: 38 },
    { schoolName: '熊谷女子', department: '普通科', quota: 278, finalApplicants: 313, finalRate: 1.13, page: 1, rowIndex: 39 },
    { schoolName: '熊谷西', department: '普通科', quota: 278, finalApplicants: 324, finalRate: 1.17, page: 1, rowIndex: 40 },
    { schoolName: '栗橋北彩', department: '普通科', quota: 158, finalApplicants: 131, finalRate: 0.83, page: 1, rowIndex: 41 },
    { schoolName: '鴻巣', department: '普通科', quota: 198, finalApplicants: 172, finalRate: 0.87, page: 1, rowIndex: 42 },
    { schoolName: '鴻巣女子', department: '普通科', quota: 79, finalApplicants: 40, finalRate: 0.51, page: 1, rowIndex: 43 },
    { schoolName: '越ケ谷', department: '普通科', quota: 318, finalApplicants: 405, finalRate: 1.27, page: 1, rowIndex: 44 },
    { schoolName: '越谷北', department: '普通科', quota: 318, finalApplicants: 381, finalRate: 1.2, page: 1, rowIndex: 45 },
    { schoolName: '越谷西', department: '普通科', quota: 318, finalApplicants: 320, finalRate: 1.01, page: 1, rowIndex: 46 },
    { schoolName: '越谷東', department: '普通科', quota: 278, finalApplicants: 290, finalRate: 1.04, page: 1, rowIndex: 47 },
    { schoolName: '越谷南', department: '普通科', quota: 318, finalApplicants: 427, finalRate: 1.34, page: 1, rowIndex: 48 },
    { schoolName: '児玉', department: '普通科', quota: 79, finalApplicants: 27, finalRate: 0.34, page: 1, rowIndex: 49 },
    { schoolName: '坂戸', department: '普通科', quota: 318, finalApplicants: 366, finalRate: 1.15, page: 1, rowIndex: 50 },
    { schoolName: '坂戸西', department: '普通科', quota: 318, finalApplicants: 302, finalRate: 0.95, page: 1, rowIndex: 51 },
    { schoolName: '狭山清陵', department: '普通科', quota: 198, finalApplicants: 174, finalRate: 0.88, page: 1, rowIndex: 52 },
    { schoolName: '志木', department: '普通科', quota: 238, finalApplicants: 253, finalRate: 1.06, page: 1, rowIndex: 53 },
    { schoolName: '庄和', department: '普通科', quota: 158, finalApplicants: 157, finalRate: 0.99, page: 1, rowIndex: 54 },
    { schoolName: '白岡', department: '普通科', quota: 158, finalApplicants: 149, finalRate: 0.94, page: 1, rowIndex: 55 },
    { schoolName: '杉戸', department: '普通科', quota: 278, finalApplicants: 331, finalRate: 1.19, page: 2, rowIndex: 0 },
    { schoolName: '草加', department: '普通科', quota: 358, finalApplicants: 356, finalRate: 0.99, page: 2, rowIndex: 1 },
    { schoolName: '草加西', department: '普通科', quota: 238, finalApplicants: 241, finalRate: 1.01, page: 2, rowIndex: 2 },
    { schoolName: '草加東', department: '普通科', quota: 318, finalApplicants: 329, finalRate: 1.03, page: 2, rowIndex: 3 },
    { schoolName: '草加南', department: '普通科', quota: 238, finalApplicants: 242, finalRate: 1.02, page: 2, rowIndex: 4 },
    { schoolName: '秩父', department: '普通科', quota: 158, finalApplicants: 140, finalRate: 0.89, page: 2, rowIndex: 5 },
    { schoolName: '鶴ケ島清風', department: '普通科', quota: 198, finalApplicants: 131, finalRate: 0.66, page: 2, rowIndex: 6 },
    { schoolName: '所沢', department: '普通科', quota: 358, finalApplicants: 495, finalRate: 1.38, page: 2, rowIndex: 7 },
    { schoolName: '所沢北', department: '普通科', quota: 318, finalApplicants: 406, finalRate: 1.28, page: 2, rowIndex: 8 },
    { schoolName: '所沢中央', department: '普通科', quota: 318, finalApplicants: 322, finalRate: 1.01, page: 2, rowIndex: 9 },
    { schoolName: '所沢西', department: '普通科', quota: 318, finalApplicants: 346, finalRate: 1.09, page: 2, rowIndex: 10 },
    { schoolName: '豊岡', department: '普通科', quota: 318, finalApplicants: 338, finalRate: 1.06, page: 2, rowIndex: 11 },
    { schoolName: '南稜', department: '普通科', quota: 318, finalApplicants: 370, finalRate: 1.16, page: 2, rowIndex: 12 },
    { schoolName: '新座', department: '普通科', quota: 198, finalApplicants: 162, finalRate: 0.82, page: 2, rowIndex: 13 },
    { schoolName: '新座柳瀬', department: '普通科', quota: 198, finalApplicants: 215, finalRate: 1.09, page: 2, rowIndex: 14 },
    { schoolName: '蓮田松韻', department: '普通科', quota: 158, finalApplicants: 146, finalRate: 0.92, page: 2, rowIndex: 15 },
    { schoolName: '鳩ケ谷', department: '普通科', quota: 158, finalApplicants: 165, finalRate: 1.04, page: 2, rowIndex: 16 },
    { schoolName: '羽生第一', department: '普通科', quota: 158, finalApplicants: 128, finalRate: 0.81, page: 2, rowIndex: 17 },
    { schoolName: '飯能', department: '普通科', quota: 278, finalApplicants: 242, finalRate: 0.87, page: 2, rowIndex: 18 },
    { schoolName: '日高', department: '普通科', quota: 118, finalApplicants: 92, finalRate: 0.78, page: 2, rowIndex: 19 },
    { schoolName: '日高', department: '情報コース', quota: 40, finalApplicants: 15, finalRate: 0.38, page: 2, rowIndex: 20 },
    { schoolName: '深谷', department: '普通科', quota: 198, finalApplicants: 149, finalRate: 0.75, page: 2, rowIndex: 21 },
    { schoolName: '深谷第一', department: '普通科', quota: 278, finalApplicants: 280, finalRate: 1.01, page: 2, rowIndex: 22 },
    { schoolName: '富士見', department: '普通科', quota: 198, finalApplicants: 207, finalRate: 1.05, page: 2, rowIndex: 23 },
    { schoolName: 'ふじみ野', department: '普通科', quota: 118, finalApplicants: 108, finalRate: 0.92, page: 2, rowIndex: 24 },
    { schoolName: '不動岡', department: '普通科', quota: 358, finalApplicants: 482, finalRate: 1.35, page: 2, rowIndex: 25 },
    { schoolName: '本庄', department: '普通科', quota: 318, finalApplicants: 347, finalRate: 1.09, page: 2, rowIndex: 26 },
    { schoolName: '松伏', department: '普通科', quota: 118, finalApplicants: 116, finalRate: 0.98, page: 2, rowIndex: 27 },
    { schoolName: '松伏', department: '情報ビジネスコース', quota: 40, finalApplicants: 37, finalRate: 0.93, page: 2, rowIndex: 28 },
    { schoolName: '松山', department: '普通科', quota: 278, finalApplicants: 226, finalRate: 0.81, page: 2, rowIndex: 29 },
    { schoolName: '松山女子', department: '普通科', quota: 318, finalApplicants: 309, finalRate: 0.97, page: 2, rowIndex: 30 },
    { schoolName: '三郷', department: '普通科', quota: 198, finalApplicants: 123, finalRate: 0.62, page: 2, rowIndex: 31 },
    { schoolName: '三郷北', department: '普通科', quota: 238, finalApplicants: 254, finalRate: 1.07, page: 2, rowIndex: 32 },
    { schoolName: '宮代', department: '普通科', quota: 198, finalApplicants: 184, finalRate: 0.93, page: 2, rowIndex: 33 },
    { schoolName: '妻沼', department: '普通科', quota: 118, finalApplicants: 79, finalRate: 0.67, page: 2, rowIndex: 34 },
    { schoolName: '八潮フロンティア', department: '普通科', quota: 119, finalApplicants: 112, finalRate: 0.94, page: 2, rowIndex: 35 },
    { schoolName: '与野', department: '普通科', quota: 358, finalApplicants: 370, finalRate: 1.03, page: 2, rowIndex: 36 },
    { schoolName: '和光国際', department: '普通科', quota: 238, finalApplicants: 309, finalRate: 1.3, page: 2, rowIndex: 37 },
    { schoolName: '鷲宮', department: '普通科', quota: 278, finalApplicants: 301, finalRate: 1.08, page: 2, rowIndex: 38 },
    { schoolName: '蕨', department: '普通科', quota: 318, finalApplicants: 376, finalRate: 1.18, page: 2, rowIndex: 39 },
    { schoolName: '市立川越', department: '普通科', quota: 140, finalApplicants: 178, finalRate: 1.27, page: 2, rowIndex: 40 },
    { schoolName: '市立浦和', department: '普通科', quota: 240, finalApplicants: 461, finalRate: 1.92, page: 2, rowIndex: 41 },
    { schoolName: '市立浦和南', department: '普通科', quota: 320, finalApplicants: 446, finalRate: 1.39, page: 2, rowIndex: 42 },
    { schoolName: '市立大宮北', department: '普通科', quota: 280, finalApplicants: 342, finalRate: 1.22, page: 2, rowIndex: 43 },
    { schoolName: '川口市立', department: '普通科', quota: 240, finalApplicants: 382, finalRate: 1.59, page: 2, rowIndex: 44 },
    { schoolName: '川口市立', department: 'スポーツ科学コース', quota: 80, finalApplicants: 133, finalRate: 1.66, page: 2, rowIndex: 45 },

    // ===== 全日制 専門学科：農業に関する学科 =====
    { schoolName: '熊谷農業', department: '食品科学科', quota: 40, finalApplicants: 47, finalRate: 1.18, page: 3, rowIndex: 0 },
    { schoolName: '熊谷農業', department: '生物生産工学科', quota: 79, finalApplicants: 71, finalRate: 0.9, page: 3, rowIndex: 1 },
    { schoolName: '熊谷農業', department: '生活技術科', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 3, rowIndex: 2 },
    { schoolName: '熊谷農業', department: '生物生産技術科', quota: 80, finalApplicants: 74, finalRate: 0.93, page: 3, rowIndex: 3 },
    { schoolName: '児玉', department: '生物資源科', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 3, rowIndex: 4 },
    { schoolName: '児玉', department: '環境デザイン科', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 3, rowIndex: 5 },
    { schoolName: '杉戸農業', department: '生物生産工学科', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 3, rowIndex: 6 },
    { schoolName: '杉戸農業', department: '園芸科', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 3, rowIndex: 7 },
    { schoolName: '杉戸農業', department: '造園科', quota: 39, finalApplicants: 36, finalRate: 0.92, page: 3, rowIndex: 8 },
    { schoolName: '杉戸農業', department: '食品流通科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 3, rowIndex: 9 },
    { schoolName: '杉戸農業', department: '生活技術科', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 3, rowIndex: 10 },
    { schoolName: '杉戸農業', department: '生物生産技術科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 3, rowIndex: 11 },
    { schoolName: '秩父農工科学', department: '農業科', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 3, rowIndex: 12 },
    { schoolName: '秩父農工科学', department: '食品化学科', quota: 39, finalApplicants: 11, finalRate: 0.28, page: 3, rowIndex: 13 },
    { schoolName: '秩父農工科学', department: '森林科学科', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 3, rowIndex: 14 },
    { schoolName: '鳩ケ谷', department: '園芸デザイン科', quota: 40, finalApplicants: 36, finalRate: 0.9, page: 3, rowIndex: 15 },
    { schoolName: '羽生実業', department: '園芸科', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 3, rowIndex: 16 },
    { schoolName: '羽生実業', department: '農業経済科', quota: 40, finalApplicants: 24, finalRate: 0.6, page: 3, rowIndex: 17 },

    // ===== 全日制 専門学科：工業に関する学科 =====
    { schoolName: '大宮科学技術', department: '機械工学科', quota: 80, finalApplicants: 62, finalRate: 0.78, page: 4, rowIndex: 0 },
    ...
    { schoolName: '大宮科学技術', department: '電気工学科', quota: 40, finalApplicants: 23, finalRate: 0.58, page: 4, rowIndex: 1 },
    { schoolName: '大宮科学技術', department: 'ロボット工学科', quota: 39, finalApplicants: 23, finalRate: 0.59, page: 4, rowIndex: 2 },
    { schoolName: '大宮科学技術', department: '建築デザイン工学科', quota: 79, finalApplicants: 61, finalRate: 0.77, page: 4, rowIndex: 3 },
    { schoolName: '春日部工業', department: '機械科', quota: 79, finalApplicants: 78, finalRate: 0.99, page: 4, rowIndex: 4 },
    { schoolName: '春日部工業', department: '電気科', quota: 79, finalApplicants: 77, finalRate: 0.97, page: 4, rowIndex: 5 },
    { schoolName: '春日部工業', department: '建築科', quota: 80, finalApplicants: 69, finalRate: 0.86, page: 4, rowIndex: 6 },
    { schoolName: '川口工業', department: '機械科', quota: 80, finalApplicants: 82, finalRate: 1.03, page: 4, rowIndex: 7 },
    { schoolName: '川口工業', department: '電気科', quota: 79, finalApplicants: 84, finalRate: 1.06, page: 4, rowIndex: 8 },
    { schoolName: '川口工業', department: '情報通信科', quota: 79, finalApplicants: 81, finalRate: 1.03, page: 4, rowIndex: 9 },
    { schoolName: '川越工業', department: 'デザイン科', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 4, rowIndex: 10 },
    { schoolName: '川越工業', department: '機械科', quota: 79, finalApplicants: 78, finalRate: 0.99, page: 4, rowIndex: 11 },
    { schoolName: '川越工業', department: '電気科', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 4, rowIndex: 12 },
    { schoolName: '川越工業', department: '建築科', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 4, rowIndex: 13 },
    { schoolName: '川越工業', department: '化学科', quota: 79, finalApplicants: 72, finalRate: 0.91, page: 4, rowIndex: 14 },
    { schoolName: '久喜工業', department: '機械科', quota: 80, finalApplicants: 82, finalRate: 1.03, page: 4, rowIndex: 15 },
    { schoolName: '久喜工業', department: '電気科', quota: 39, finalApplicants: 30, finalRate: 0.77, page: 4, rowIndex: 16 },
    { schoolName: '久喜工業', department: '工業化学科', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 4, rowIndex: 17 },
    { schoolName: '久喜工業', department: '環境科学科', quota: 40, finalApplicants: 9, finalRate: 0.23, page: 4, rowIndex: 18 },
    { schoolName: '久喜工業', department: '情報技術科', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 4, rowIndex: 19 },
    { schoolName: '熊谷工業', department: '機械科', quota: 79, finalApplicants: 70, finalRate: 0.89, page: 4, rowIndex: 20 },
    { schoolName: '熊谷工業', department: '電気科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 4, rowIndex: 21 },
    { schoolName: '熊谷工業', department: '建築科', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 4, rowIndex: 22 },
    { schoolName: '熊谷工業', department: '土木科', quota: 40, finalApplicants: 31, finalRate: 0.78, page: 4, rowIndex: 23 },
    { schoolName: '熊谷工業', department: '情報技術科', quota: 40, finalApplicants: 46, finalRate: 1.15, page: 4, rowIndex: 24 },
    { schoolName: '越谷総合技術', department: '電子機械科', quota: 39, finalApplicants: 29, finalRate: 0.74, page: 4, rowIndex: 25 },
    { schoolName: '越谷総合技術', department: '情報技術科', quota: 40, finalApplicants: 38, finalRate: 0.95, page: 4, rowIndex: 26 },
    { schoolName: '児玉', department: '機械科', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 4, rowIndex: 27 },
    { schoolName: '児玉', department: '電子機械科', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 4, rowIndex: 28 },
    { schoolName: '狭山工業', department: '機械科', quota: 80, finalApplicants: 61, finalRate: 0.76, page: 4, rowIndex: 29 },
    { schoolName: '狭山工業', department: '電気科', quota: 39, finalApplicants: 27, finalRate: 0.69, page: 4, rowIndex: 30 },
    { schoolName: '狭山工業', department: '電子機械科', quota: 80, finalApplicants: 46, finalRate: 0.58, page: 4, rowIndex: 31 },
    { schoolName: '進修館', department: '電気システム科', quota: 39, finalApplicants: 11, finalRate: 0.28, page: 4, rowIndex: 32 },
    { schoolName: '進修館', department: '情報メディア科', quota: 40, finalApplicants: 29, finalRate: 0.73, page: 4, rowIndex: 33 },
    { schoolName: '進修館', department: 'ものづくり科', quota: 40, finalApplicants: 29, finalRate: 0.73, page: 4, rowIndex: 34 },
    { schoolName: '秩父農工科学', department: '電気システム科', quota: 39, finalApplicants: 27, finalRate: 0.69, page: 4, rowIndex: 35 },
    { schoolName: '秩父農工科学', department: '機械システム科', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 4, rowIndex: 36 },
    { schoolName: '新座総合技術', department: 'デザイン科', quota: 40, finalApplicants: 48, finalRate: 1.2, page: 4, rowIndex: 37 },
    { schoolName: '新座総合技術', department: '電子機械科', quota: 39, finalApplicants: 36, finalRate: 0.92, page: 4, rowIndex: 38 },
    { schoolName: '新座総合技術', department: '情報技術科', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 4, rowIndex: 39 },
    { schoolName: '三郷工業技術', department: '機械科', quota: 39, finalApplicants: 39, finalRate: 1.0, page: 4, rowIndex: 40 },
    ...
    { schoolName: '三郷工業技術', department: '電気科', quota: 39, finalApplicants: 32, finalRate: 0.82, page: 4, rowIndex: 41 },
    { schoolName: '三郷工業技術', department: '電子機械科', quota: 40, finalApplicants: 20, finalRate: 0.5, page: 4, rowIndex: 42 },
    { schoolName: '三郷工業技術', department: '情報技術科', quota: 40, finalApplicants: 21, finalRate: 0.53, page: 4, rowIndex: 43 },
    { schoolName: '三郷工業技術', department: '情報電子科', quota: 40, finalApplicants: 34, finalRate: 0.85, page: 4, rowIndex: 44 },

    // ===== 全日制 専門学科：商業に関する学科 =====
    { schoolName: '上尾', department: '商業科', quota: 120, finalApplicants: 154, finalRate: 1.28, page: 5, rowIndex: 0 },
    { schoolName: '岩槻商業', department: '商業科', quota: 39, finalApplicants: 23, finalRate: 0.59, page: 5, rowIndex: 1 },
    { schoolName: '岩槻商業', department: '情報処理科', quota: 80, finalApplicants: 74, finalRate: 0.93, page: 5, rowIndex: 2 },
    { schoolName: '浦和商業', department: '商業科', quota: 198, finalApplicants: 194, finalRate: 0.98, page: 5, rowIndex: 3 },
    { schoolName: '浦和商業', department: '情報処理科', quota: 80, finalApplicants: 86, finalRate: 1.08, page: 5, rowIndex: 4 },
    { schoolName: '大宮商業', department: '商業科', quota: 198, finalApplicants: 148, finalRate: 0.75, page: 5, rowIndex: 5 },
    { schoolName: '熊谷商業', department: '総合ビジネス科', quota: 199, finalApplicants: 161, finalRate: 0.81, page: 5, rowIndex: 6 },
    { schoolName: '鴻巣', department: '商業科', quota: 80, finalApplicants: 78, finalRate: 0.98, page: 5, rowIndex: 7 },
    { schoolName: '越谷総合技術', department: '流通経済科', quota: 40, finalApplicants: 29, finalRate: 0.73, page: 5, rowIndex: 8 },
    { schoolName: '越谷総合技術', department: '情報処理科', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 5, rowIndex: 9 },
    { schoolName: '狭山経済', department: '流通経済科', quota: 79, finalApplicants: 73, finalRate: 0.92, page: 5, rowIndex: 10 },
    { schoolName: '狭山経済', department: '会計科', quota: 40, finalApplicants: 30, finalRate: 0.75, page: 5, rowIndex: 11 },
    { schoolName: '狭山経済', department: '情報処理科', quota: 80, finalApplicants: 75, finalRate: 0.94, page: 5, rowIndex: 12 },
    { schoolName: '所沢商業', department: '情報処理科', quota: 79, finalApplicants: 57, finalRate: 0.72, page: 5, rowIndex: 13 },
    { schoolName: '所沢商業', department: '国際流通科', quota: 79, finalApplicants: 44, finalRate: 0.56, page: 5, rowIndex: 14 },
    { schoolName: '所沢商業', department: 'ビジネス会計科', quota: 40, finalApplicants: 12, finalRate: 0.3, page: 5, rowIndex: 15 },
    { schoolName: '新座総合技術', department: '総合ビジネス科', quota: 39, finalApplicants: 39, finalRate: 1.0, page: 5, rowIndex: 16 },
    { schoolName: '鳩ケ谷', department: '情報処理科', quota: 80, finalApplicants: 78, finalRate: 0.98, page: 5, rowIndex: 17 },
    { schoolName: '羽生実業', department: '商業科', quota: 39, finalApplicants: 5, finalRate: 0.13, page: 5, rowIndex: 18 },
    { schoolName: '羽生実業', department: '情報処理科', quota: 40, finalApplicants: 10, finalRate: 0.25, page: 5, rowIndex: 19 },
    { schoolName: '深谷商業', department: '商業科', quota: 158, finalApplicants: 160, finalRate: 1.01, page: 5, rowIndex: 20 },
    { schoolName: '深谷商業', department: '会計科', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 5, rowIndex: 21 },
    { schoolName: '深谷商業', department: '情報処理科', quota: 80, finalApplicants: 83, finalRate: 1.04, page: 5, rowIndex: 22 },
    { schoolName: '八潮フロンティア', department: 'ビジネス探究科', quota: 119, finalApplicants: 132, finalRate: 1.11, page: 5, rowIndex: 23 },
    { schoolName: '市立川越', department: '国際経済科', quota: 70, finalApplicants: 109, finalRate: 1.56, page: 5, rowIndex: 24 },
    { schoolName: '市立川越', department: '情報処理科', quota: 70, finalApplicants: 84, finalRate: 1.2, page: 5, rowIndex: 25 },

    // ===== 全日制 専門学科：家庭に関する学科 =====
    { schoolName: '鴻巣女子', department: '保育科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 6, rowIndex: 0 },
    { schoolName: '鴻巣女子', department: '家政科学科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 6, rowIndex: 1 },
    { schoolName: '越谷総合技術', department: '服飾デザイン科', quota: 39, finalApplicants: 28, finalRate: 0.72, page: 6, rowIndex: 2 },
    ...
    { schoolName: '越谷総合技術', department: '食物調理科', quota: 40, finalApplicants: 42, finalRate: 1.05, page: 6, rowIndex: 3 },
    { schoolName: '秩父農工科学', department: 'ライフデザイン科', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 6, rowIndex: 4 },
    { schoolName: '秩父農工科学', department: 'フードデザイン科', quota: 40, finalApplicants: 33, finalRate: 0.83, page: 6, rowIndex: 5 },
    { schoolName: '新座総合技術', department: '服飾デザイン科', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 6, rowIndex: 6 },
    { schoolName: '新座総合技術', department: '食物調理科', quota: 40, finalApplicants: 56, finalRate: 1.4, page: 6, rowIndex: 7 },

    // ===== 全日制 専門学科：看護に関する学科 =====
    { schoolName: '常盤', department: '看護科', quota: 80, finalApplicants: 88, finalRate: 1.1, page: 6, rowIndex: 8 },

    // ===== 全日制 専門学科：外国語に関する学科 =====
    { schoolName: '春日部女子', department: '外国語科', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 6, rowIndex: 9 },
    // ⚠️2026-09-05訂正(T-Y11D・👤裁定2026-09-03): 学校名「越谷北」→「越谷南」。
    // 越谷北=理数科・越谷南=外国語科がR5/R7を通じて安定した学校特性で、外国語科が2校間を
    // 年ごとに行き来することはない。R8のこのレコードだけが誤っており、PDF原本も「越谷南」。
    { schoolName: '越谷南', department: '外国語科', quota: 40, finalApplicants: 52, finalRate: 1.3, page: 6, rowIndex: 10 },
    { schoolName: '坂戸', department: '外国語科', quota: 40, finalApplicants: 32, finalRate: 0.8, page: 6, rowIndex: 11 },
    { schoolName: '草加南', department: '外国語科', quota: 40, finalApplicants: 40, finalRate: 1.0, page: 6, rowIndex: 12 },
    { schoolName: '南稜', department: '外国語科', quota: 40, finalApplicants: 54, finalRate: 1.35, page: 6, rowIndex: 13 },
    { schoolName: '蕨', department: '外国語科', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 6, rowIndex: 14 },

    // ===== 全日制 専門学科：美術に関する学科 =====
    { schoolName: '大宮光陵', department: '美術科', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 6, rowIndex: 15 },
    { schoolName: '越生翔桜', department: '美術表現科', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 6, rowIndex: 16 },
    { schoolName: '芸術総合', department: '美術科', quota: 40, finalApplicants: 65, finalRate: 1.63, page: 6, rowIndex: 17 },

    // ===== 全日制 専門学科：音楽に関する学科 =====
    { schoolName: '大宮光陵', department: '音楽科', quota: 40, finalApplicants: 45, finalRate: 1.13, page: 6, rowIndex: 18 },
    { schoolName: '芸術総合', department: '音楽科', quota: 40, finalApplicants: 17, finalRate: 0.43, page: 6, rowIndex: 19 },
    { schoolName: '松伏', department: '音楽科', quota: 40, finalApplicants: 27, finalRate: 0.68, page: 6, rowIndex: 20 },

    // ===== 全日制 専門学科：書道に関する学科 =====
    { schoolName: '大宮光陵', department: '書道科', quota: 40, finalApplicants: 28, finalRate: 0.7, page: 6, rowIndex: 21 },

    // ===== 全日制 専門学科：体育に関する学科 =====
    { schoolName: '大宮東', department: '体育科', quota: 80, finalApplicants: 97, finalRate: 1.21, page: 6, rowIndex: 22 },
    { schoolName: 'ふじみ野', department: 'スポーツサイエンス科', quota: 80, finalApplicants: 83, finalRate: 1.04, page: 6, rowIndex: 23 },

    // ===== 全日制 専門学科：理数に関する学科 =====
    { schoolName: '大宮', department: '理数科', quota: 40, finalApplicants: 81, finalRate: 2.03, page: 7, rowIndex: 0 },
    { schoolName: '熊谷西', department: '理数科', quota: 40, finalApplicants: 35, finalRate: 0.88, page: 7, rowIndex: 1 },
    { schoolName: '越谷北', department: '理数科', quota: 40, finalApplicants: 61, finalRate: 1.53, page: 7, rowIndex: 2 },
    { schoolName: '所沢北', department: '理数科', quota: 40, finalApplicants: 73, finalRate: 1.83, page: 7, rowIndex: 3 },
    { schoolName: '松山', department: '理数科', quota: 40, finalApplicants: 41, finalRate: 1.03, page: 7, rowIndex: 4 },
    { schoolName: '市立大宮北', department: '理数科', quota: 40, finalApplicants: 49, finalRate: 1.23, page: 7, rowIndex: 5 },
    { schoolName: '川口市立', department: '理数科', quota: 40, finalApplicants: 60, finalRate: 1.5, page: 7, rowIndex: 6 },

    // ===== 全日制 専門学科：情報に関する学科 =====
    { schoolName: '大宮科学技術', department: '情報サイエンス科', quota: 80, finalApplicants: 96, finalRate: 1.2, page: 7, rowIndex: 7 },

    // ===== 全日制 専門学科：福祉に関する学科 =====
    { schoolName: '誠和福祉', department: '福祉科', quota: 80, finalApplicants: 27, finalRate: 0.34, page: 7, rowIndex: 8 },

    // ===== 全日制 専門学科：人文に関する学科 =====
    { schoolName: '春日部東', department: '人文科', quota: 40, finalApplicants: 39, finalRate: 0.98, page: 7, rowIndex: 9 },

    // ===== 全日制 専門学科：国際関係に関する学科 =====
    { schoolName: '岩槻', department: '国際教養科', quota: 40, finalApplicants: 47, finalRate: 1.18, page: 7, rowIndex: 10 },
    { schoolName: '秩父', department: '国際教養科', quota: 40, finalApplicants: 13, finalRate: 0.33, page: 7, rowIndex: 11 },
    { schoolName: '和光国際', department: '国際科', quota: 79, finalApplicants: 92, finalRate: 1.16, page: 7, rowIndex: 12 },

    // ===== 全日制 専門学科：映像芸術に関する学科 =====
    { schoolName: '芸術総合', department: '映像芸術科', quota: 40, finalApplicants: 43, finalRate: 1.08, page: 7, rowIndex: 13 },

    // ===== 全日制 専門学科：舞台芸術に関する学科 =====
    { schoolName: '芸術総合', department: '舞台芸術科', quota: 40, finalApplicants: 44, finalRate: 1.1, page: 7, rowIndex: 14 },

    // ===== 全日制 専門学科：生物・環境に関する系 =====
    { schoolName: 'いずみ', department: '生物系', quota: 119, finalApplicants: 133, finalRate: 1.12, page: 7, rowIndex: 15 },
    { schoolName: 'いずみ', department: '環境系', quota: 119, finalApplicants: 120, finalRate: 1.01, page: 7, rowIndex: 16 },

    // ===== 全日制 総合学科 =====
    { schoolName: '小鹿野', department: '総合学科', quota: 79, finalApplicants: 27, finalRate: 0.34, page: 8, rowIndex: 0 },
    { schoolName: '川越総合', department: '総合学科', quota: 238, finalApplicants: 280, finalRate: 1.18, page: 8, rowIndex: 1 },
    { schoolName: '久喜北陽', department: '総合学科', quota: 318, finalApplicants: 283, finalRate: 0.89, page: 8, rowIndex: 2 },
    { schoolName: '幸手桜', department: '総合学科', quota: 198, finalApplicants: 181, finalRate: 0.91, page: 8, rowIndex: 3 },
    { schoolName: '進修館', department: '総合学科', quota: 198, finalApplicants: 152, finalRate: 0.77, page: 8, rowIndex: 4 },
    { schoolName: '誠和福祉', department: '総合学科', quota: 79, finalApplicants: 25, finalRate: 0.32, page: 8, rowIndex: 5 },
    { schoolName: '滑川総合', department: '総合学科', quota: 278, finalApplicants: 266, finalRate: 0.96, page: 8, rowIndex: 6 },
    { schoolName: '吉川美南', department: '総合学科', quota: 118, finalApplicants: 115, finalRate: 0.97, page: 8, rowIndex: 7 },
    { schoolName: '寄居城北', department: '総合学科', quota: 198, finalApplicants: 196, finalRate: 0.99, page: 8, rowIndex: 8 },
