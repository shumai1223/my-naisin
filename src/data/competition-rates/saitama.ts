 ...
 *
 * **2026-09-12追記(掛-1・saitama横展開5年度目・T-Y11F §11払底時の逃げ場)**: 令和4年度一次資料
 * 「令和4年度埼玉県公立高等学校入学者選抜志願確定者数」（令和4年2月28日修正・全11頁、全日制は
 * 1〜9頁）を県サイト現行ページ（f2208/r4nyuushi-jouhou.html）から直接取得した（削除されておらず
 * ライブ200）。R5-R8と全く同じ書式（列は募集人員/入学許可予定者数(A)/志願確定者数(B)/倍率(B÷A)）
 * だったため、pdftoppm 200dpiビジョン解析で全日制を学校粒度まで展開した。254レコードを転記し、
 * 「全日制 普通・専門・総合学科　計」行（quota36,721・applicants40,265・倍率1.10）とnode.js
 * 機械集計が初回転記で完全一致した（誤差ゼロ）。内訳は普通科110レコード（quota27,200・
 * applicants31,004）・専門学科135レコード（quota7,775・applicants7,642）・総合学科9レコード
 * （quota1,746・applicants1,619）で、専門学科は農業・工業・商業・家庭・看護・外国語・美術・
 * 音楽・書道・体育・理数・福祉・人文・国際文化・映像芸術・舞台芸術・生物環境の17区分すべてに
 * それぞれ独立した印字済み小計があり、全て完全一致を確認した。伊奈学園総合の department は
 * R5と同じ表記「普通科（普通・スポーツ科学・芸術の合算）」に統一。浦和工業（4学科）・鳩山
 * （2学科）・皆野（商業系）はR4時点でも実在しており（R5と同一構成）、これらの学校がR6以降に
 * 姿を消す前の最終年度以前からの継続的な実在記録であることが確認できた。国際文化科も岩槻1校
 * のみでR5と同一構成。これでsaitamaはR4〜R8の5年度が学校別データで揃った。
 */
...
export const SAITAMA_COMPETITION_RATES: PrefectureCompetitionRateFile = {
  ...
  sources: [
    ...
    {
      url: 'https://www.pref.saitama.lg.jp/documents/196588/r4teisei_sigankakuteisya_2.pdf',
      docTitle: '埼玉県教育委員会 令和4年度埼玉県公立高等学校入学者選抜志願確定者数（令和4年2月28日修正）（1〜9/11頁・全日制が完結・定時制はスコープ外・掛-1・saitama横展開5年度目・T-Y11F §11払底時の逃げ場）',
  ...
  records: [
    ...
    // --- 全日制 普通科 ---
    { schoolName: '上尾', department: '普通科', quota: 238, finalApplicants: 252, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上尾鷹の台', department: '普通科', quota: 238, finalApplicants: 251, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上尾橘', department: '普通科', quota: 159, finalApplicants: 127, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上尾南', department: '普通科', quota: 238, finalApplicants: 251, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '朝霞', department: '普通科', quota: 358, finalApplicants: 352, finalRate: 0.98, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '朝霞西', department: '普通科', quota: 358, finalApplicants: 403, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '伊奈学園総合', department: '普通科（普通・スポーツ科学・芸術の合算）', quota: 716, finalApplicants: 852, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '入間向陽', department: '普通科', quota: 318, finalApplicants: 392, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岩槻', department: '普通科', quota: 278, finalApplicants: 267, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岩槻北陵', department: '普通科', quota: 159, finalApplicants: 120, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和', department: '普通科', quota: 358, finalApplicants: 466, finalRate: 1.3, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和北', department: '普通科', quota: 358, finalApplicants: 398, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和第一女子', department: '普通科', quota: 358, finalApplicants: 528, finalRate: 1.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和西', department: '普通科', quota: 358, finalApplicants: 558, finalRate: 1.56, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和東', department: '普通科', quota: 318, finalApplicants: 405, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮', department: '普通科', quota: 318, finalApplicants: 468, finalRate: 1.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮光陵', department: '普通科', quota: 198, finalApplicants: 229, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮光陵', department: '外国語コース', quota: 40, finalApplicants: 27, finalRate: 0.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮東', department: '普通科', quota: 278, finalApplicants: 244, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮南', department: '普通科', quota: 358, finalApplicants: 396, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮武蔵野', department: '普通科', quota: 238, finalApplicants: 253, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '小川', department: '普通科', quota: 198, finalApplicants: 182, finalRate: 0.92, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '桶川', department: '普通科', quota: 318, finalApplicants: 318, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '桶川西', department: '普通科', quota: 159, finalApplicants: 128, finalRate: 0.81, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越生', department: '普通科', quota: 79, finalApplicants: 47, finalRate: 0.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部', department: '普通科', quota: 358, finalApplicants: 451, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部女子', department: '普通科', quota: 278, finalApplicants: 280, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部東', department: '普通科', quota: 318, finalApplicants: 336, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口', department: '普通科', quota: 358, finalApplicants: 416, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口北', department: '普通科', quota: 358, finalApplicants: 453, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口青陵', department: '普通科', quota: 278, finalApplicants: 288, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口東', department: '普通科', quota: 278, finalApplicants: 284, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越', department: '普通科', quota: 358, finalApplicants: 519, finalRate: 1.45, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越女子', department: '普通科', quota: 358, finalApplicants: 484, finalRate: 1.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越西', department: '普通科', quota: 358, finalApplicants: 347, finalRate: 0.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越初雁', department: '普通科', quota: 198, finalApplicants: 193, finalRate: 0.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越南', department: '普通科', quota: 358, finalApplicants: 503, finalRate: 1.41, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '北本', department: '普通科', quota: 159, finalApplicants: 151, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜', department: '普通科', quota: 278, finalApplicants: 303, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷', department: '普通科', quota: 318, finalApplicants: 350, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷女子', department: '普通科', quota: 318, finalApplicants: 342, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷西', department: '普通科', quota: 278, finalApplicants: 313, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '栗橋北彩', department: '普通科', quota: 198, finalApplicants: 193, finalRate: 0.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鴻巣', department: '普通科', quota: 198, finalApplicants: 214, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鴻巣女子', department: '普通科', quota: 79, finalApplicants: 54, finalRate: 0.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越ケ谷', department: '普通科', quota: 358, finalApplicants: 490, finalRate: 1.37, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷北', department: '普通科', quota: 318, finalApplicants: 461, finalRate: 1.45, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷西', department: '普通科', quota: 318, finalApplicants: 370, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷東', department: '普通科', quota: 278, finalApplicants: 278, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷南', department: '普通科', quota: 318, finalApplicants: 445, finalRate: 1.4, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉', department: '普通科', quota: 39, finalApplicants: 34, finalRate: 0.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉', department: '体育コース', quota: 40, finalApplicants: 21, finalRate: 0.53, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '坂戸', department: '普通科', quota: 318, finalApplicants: 339, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '坂戸西', department: '普通科', quota: 318, finalApplicants: 334, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山清陵', department: '普通科', quota: 198, finalApplicants: 224, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '志木', department: '普通科', quota: 278, finalApplicants: 300, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '庄和', department: '普通科', quota: 198, finalApplicants: 178, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '白岡', department: '普通科', quota: 159, finalApplicants: 131, finalRate: 0.82, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸', department: '普通科', quota: 278, finalApplicants: 289, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '草加', department: '普通科', quota: 358, finalApplicants: 374, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '草加西', department: '普通科', quota: 238, finalApplicants: 247, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '草加東', department: '普通科', quota: 318, finalApplicants: 345, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '草加南', department: '普通科', quota: 278, finalApplicants: 302, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父', department: '普通科', quota: 199, finalApplicants: 208, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鶴ケ島清風', department: '普通科', quota: 198, finalApplicants: 199, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢', department: '普通科', quota: 358, finalApplicants: 471, finalRate: 1.32, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢北', department: '普通科', quota: 318, finalApplicants: 455, finalRate: 1.43, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢中央', department: '普通科', quota: 318, finalApplicants: 363, finalRate: 1.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢西', department: '普通科', quota: 358, finalApplicants: 394, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '豊岡', department: '普通科', quota: 318, finalApplicants: 385, finalRate: 1.21, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '南稜', department: '普通科', quota: 318, finalApplicants: 418, finalRate: 1.31, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座', department: '普通科', quota: 198, finalApplicants: 185, finalRate: 0.93, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座柳瀬', department: '普通科', quota: 198, finalApplicants: 225, finalRate: 1.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '蓮田松韻', department: '普通科', quota: 198, finalApplicants: 135, finalRate: 0.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鳩ケ谷', department: '普通科', quota: 158, finalApplicants: 199, finalRate: 1.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鳩山', department: '普通科', quota: 119, finalApplicants: 50, finalRate: 0.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽生第一', department: '普通科', quota: 159, finalApplicants: 165, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '飯能', department: '普通科', quota: 238, finalApplicants: 242, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '飯能南', department: '普通科', quota: 119, finalApplicants: 83, finalRate: 0.7, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '飯能南', department: 'スポーツコース', quota: 40, finalApplicants: 8, finalRate: 0.2, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日高', department: '普通科', quota: 119, finalApplicants: 123, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '日高', department: '情報コース', quota: 40, finalApplicants: 37, finalRate: 0.93, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深谷', department: '普通科', quota: 199, finalApplicants: 187, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深谷第一', department: '普通科', quota: 278, finalApplicants: 319, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '富士見', department: '普通科', quota: 238, finalApplicants: 228, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: 'ふじみ野', department: '普通科', quota: 118, finalApplicants: 126, finalRate: 1.07, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '不動岡', department: '普通科', quota: 358, finalApplicants: 441, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '本庄', department: '普通科', quota: 318, finalApplicants: 359, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松伏', department: '普通科', quota: 118, finalApplicants: 117, finalRate: 0.99, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松伏', department: '情報ビジネスコース', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松山', department: '普通科', quota: 278, finalApplicants: 280, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松山女子', department: '普通科', quota: 318, finalApplicants: 345, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷', department: '普通科', quota: 198, finalApplicants: 122, finalRate: 0.62, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷北', department: '普通科', quota: 238, finalApplicants: 246, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '宮代', department: '普通科', quota: 198, finalApplicants: 188, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '妻沼', department: '普通科', quota: 119, finalApplicants: 121, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮', department: '普通科', quota: 119, finalApplicants: 112, finalRate: 0.94, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮', department: '体育コース', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮南', department: '普通科', quota: 79, finalApplicants: 78, finalRate: 0.99, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '与野', department: '普通科', quota: 358, finalApplicants: 442, finalRate: 1.23, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '和光', department: '普通科', quota: 159, finalApplicants: 137, finalRate: 0.86, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '和光国際', department: '普通科', quota: 238, finalApplicants: 340, finalRate: 1.43, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鷲宮', department: '普通科', quota: 278, finalApplicants: 272, finalRate: 0.98, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '蕨', department: '普通科', quota: 318, finalApplicants: 471, finalRate: 1.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立川越', department: '普通科', quota: 140, finalApplicants: 207, finalRate: 1.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立浦和', department: '普通科', quota: 240, finalApplicants: 512, finalRate: 2.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立浦和南', department: '普通科', quota: 320, finalApplicants: 470, finalRate: 1.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立大宮北', department: '普通科', quota: 280, finalApplicants: 312, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口市立', department: '普通科', quota: 280, finalApplicants: 513, finalRate: 1.83, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口市立', department: 'スポーツ科学コース', quota: 80, finalApplicants: 100, finalRate: 1.25, fiscalYear: '令和4年度（2022年度）' },
    // --- 全日制 専門学科 ---
    { schoolName: '熊谷農業', department: '食品科学科', quota: 40, finalApplicants: 46, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷農業', department: '生物生産工学科', quota: 79, finalApplicants: 80, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷農業', department: '生活技術科', quota: 40, finalApplicants: 32, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷農業', department: '生物生産技術科', quota: 80, finalApplicants: 81, finalRate: 1.01, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉白楊', department: '生物資源科', quota: 39, finalApplicants: 37, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉白楊', department: '環境デザイン科', quota: 40, finalApplicants: 30, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '生物生産技術科', quota: 40, finalApplicants: 52, finalRate: 1.3, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '園芸科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '造園科', quota: 39, finalApplicants: 29, finalRate: 0.74, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '食品流通科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '生活技術科', quota: 40, finalApplicants: 41, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '杉戸農業', department: '生物生産工学科', quota: 40, finalApplicants: 29, finalRate: 0.73, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: '農業科', quota: 40, finalApplicants: 45, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: '食品化学科', quota: 39, finalApplicants: 30, finalRate: 0.77, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: '森林科学科', quota: 40, finalApplicants: 29, finalRate: 0.73, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鳩ケ谷', department: '園芸デザイン科', quota: 40, finalApplicants: 44, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽生実業', department: '園芸科', quota: 40, finalApplicants: 19, finalRate: 0.48, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽生実業', department: '農業経済科', quota: 39, finalApplicants: 32, finalRate: 0.82, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和工業', department: '電気科', quota: 39, finalApplicants: 30, finalRate: 0.77, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和工業', department: '機械科', quota: 79, finalApplicants: 46, finalRate: 0.58, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和工業', department: '設備システム科', quota: 40, finalApplicants: 30, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和工業', department: '情報技術科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮工業', department: '機械科', quota: 80, finalApplicants: 57, finalRate: 0.71, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮工業', department: '電気科', quota: 40, finalApplicants: 33, finalRate: 0.83, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮工業', department: '建築科', quota: 79, finalApplicants: 66, finalRate: 0.84, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮工業', department: '電子機械科', quota: 79, finalApplicants: 76, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部工業', department: '機械科', quota: 79, finalApplicants: 81, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部工業', department: '建築科', quota: 80, finalApplicants: 84, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部工業', department: '電気科', quota: 79, finalApplicants: 63, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口工業', department: '機械科', quota: 80, finalApplicants: 77, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口工業', department: '電気科', quota: 79, finalApplicants: 71, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口工業', department: '情報通信科', quota: 79, finalApplicants: 84, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越工業', department: 'デザイン科', quota: 40, finalApplicants: 50, finalRate: 1.25, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越工業', department: '建築科', quota: 40, finalApplicants: 57, finalRate: 1.43, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越工業', department: '機械科', quota: 79, finalApplicants: 78, finalRate: 0.99, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越工業', department: '電気科', quota: 40, finalApplicants: 45, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越工業', department: '化学科', quota: 79, finalApplicants: 77, finalRate: 0.97, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜工業', department: '電気科', quota: 39, finalApplicants: 27, finalRate: 0.69, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜工業', department: '工業化学科', quota: 40, finalApplicants: 33, finalRate: 0.83, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜工業', department: '機械科', quota: 80, finalApplicants: 83, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜工業', department: '環境科学科', quota: 40, finalApplicants: 35, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜工業', department: '情報技術科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷工業', department: '電気科', quota: 40, finalApplicants: 34, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷工業', department: '建築科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷工業', department: '土木科', quota: 40, finalApplicants: 32, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷工業', department: '機械科', quota: 79, finalApplicants: 76, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷工業', department: '情報技術科', quota: 40, finalApplicants: 42, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '電子機械科', quota: 39, finalApplicants: 34, finalRate: 0.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '情報技術科', quota: 40, finalApplicants: 58, finalRate: 1.45, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉白楊', department: '機械科', quota: 40, finalApplicants: 31, finalRate: 0.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '児玉白楊', department: '電子機械科', quota: 40, finalApplicants: 43, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山工業', department: '機械科', quota: 80, finalApplicants: 64, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山工業', department: '電気科', quota: 39, finalApplicants: 25, finalRate: 0.64, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山工業', department: '電子機械科', quota: 79, finalApplicants: 64, finalRate: 0.81, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '進修館', department: '電気システム科', quota: 39, finalApplicants: 34, finalRate: 0.87, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '進修館', department: '情報メディア科', quota: 40, finalApplicants: 45, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '進修館', department: 'ものづくり科', quota: 40, finalApplicants: 34, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: '電気システム科', quota: 39, finalApplicants: 46, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: '機械システム科', quota: 40, finalApplicants: 32, finalRate: 0.8, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: '電子機械科', quota: 39, finalApplicants: 26, finalRate: 0.67, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: '情報技術科', quota: 40, finalApplicants: 43, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: 'デザイン科', quota: 40, finalApplicants: 55, finalRate: 1.38, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷工業技術', department: '機械科', quota: 39, finalApplicants: 35, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷工業技術', department: '電子機械科', quota: 40, finalApplicants: 30, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷工業技術', department: '電気科', quota: 39, finalApplicants: 33, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷工業技術', department: '情報技術科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '三郷工業技術', department: '情報電子科', quota: 40, finalApplicants: 53, finalRate: 1.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '上尾', department: '商業科', quota: 120, finalApplicants: 127, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岩槻商業', department: '商業科', quota: 79, finalApplicants: 75, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岩槻商業', department: '情報処理科', quota: 80, finalApplicants: 77, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和商業', department: '商業科', quota: 198, finalApplicants: 184, finalRate: 0.93, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '浦和商業', department: '情報処理科', quota: 80, finalApplicants: 92, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮商業', department: '商業科', quota: 198, finalApplicants: 183, finalRate: 0.92, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷商業', department: '総合ビジネス科', quota: 198, finalApplicants: 196, finalRate: 0.99, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鴻巣', department: '商業科', quota: 80, finalApplicants: 70, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '流通経済科', quota: 40, finalApplicants: 35, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '情報処理科', quota: 40, finalApplicants: 38, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山経済', department: '流通経済科', quota: 79, finalApplicants: 82, finalRate: 1.04, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山経済', department: '会計科', quota: 80, finalApplicants: 57, finalRate: 0.71, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '狭山経済', department: '情報処理科', quota: 80, finalApplicants: 89, finalRate: 1.11, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢商業', department: '情報処理科', quota: 79, finalApplicants: 90, finalRate: 1.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢商業', department: '国際流通科', quota: 80, finalApplicants: 47, finalRate: 0.59, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢商業', department: 'ビジネス会計科', quota: 79, finalApplicants: 28, finalRate: 0.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: '総合ビジネス科', quota: 39, finalApplicants: 36, finalRate: 0.92, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鳩ケ谷', department: '情報処理科', quota: 80, finalApplicants: 96, finalRate: 1.2, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鳩山', department: '情報管理科', quota: 40, finalApplicants: 44, finalRate: 1.1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽生実業', department: '商業科', quota: 39, finalApplicants: 10, finalRate: 0.26, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '羽生実業', department: '情報処理科', quota: 40, finalApplicants: 22, finalRate: 0.55, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深谷商業', department: '商業科', quota: 158, finalApplicants: 170, finalRate: 1.08, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深谷商業', department: '会計科', quota: 40, finalApplicants: 45, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '深谷商業', department: '情報処理科', quota: 80, finalApplicants: 90, finalRate: 1.13, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '皆野', department: '商業系', quota: 79, finalApplicants: 37, finalRate: 0.47, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮南', department: '商業科', quota: 79, finalApplicants: 67, finalRate: 0.85, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '八潮南', department: '情報処理科', quota: 80, finalApplicants: 91, finalRate: 1.14, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立川越', department: '国際経済科', quota: 70, finalApplicants: 113, finalRate: 1.61, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立川越', department: '情報処理科', quota: 70, finalApplicants: 105, finalRate: 1.5, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鴻巣女子', department: '保育科', quota: 40, finalApplicants: 31, finalRate: 0.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '鴻巣女子', department: '家政科学科', quota: 40, finalApplicants: 41, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '服飾デザイン科', quota: 39, finalApplicants: 31, finalRate: 0.79, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷総合技術', department: '食物調理科', quota: 40, finalApplicants: 31, finalRate: 0.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: 'ライフデザイン科', quota: 40, finalApplicants: 38, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '秩父農工科学', department: 'フードデザイン科', quota: 40, finalApplicants: 36, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: '服飾デザイン科', quota: 40, finalApplicants: 42, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '新座総合技術', department: '食物調理科', quota: 40, finalApplicants: 41, finalRate: 1.02, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '常盤', department: '看護科', quota: 80, finalApplicants: 95, finalRate: 1.19, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部女子', department: '外国語科', quota: 40, finalApplicants: 53, finalRate: 1.33, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷南', department: '外国語科', quota: 40, finalApplicants: 28, finalRate: 0.7, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '坂戸', department: '外国語科', quota: 40, finalApplicants: 42, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '草加南', department: '外国語科', quota: 40, finalApplicants: 35, finalRate: 0.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '南稜', department: '外国語科', quota: 40, finalApplicants: 51, finalRate: 1.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '和光国際', department: '外国語科', quota: 79, finalApplicants: 129, finalRate: 1.63, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '蕨', department: '外国語科', quota: 40, finalApplicants: 60, finalRate: 1.5, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮光陵', department: '美術科', quota: 40, finalApplicants: 42, finalRate: 1.05, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越生', department: '美術科', quota: 40, finalApplicants: 40, finalRate: 1, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '芸術総合', department: '美術科', quota: 40, finalApplicants: 46, finalRate: 1.15, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮光陵', department: '音楽科', quota: 40, finalApplicants: 23, finalRate: 0.57, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '芸術総合', department: '音楽科', quota: 40, finalApplicants: 16, finalRate: 0.4, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松伏', department: '音楽科', quota: 40, finalApplicants: 23, finalRate: 0.57, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮光陵', department: '書道科', quota: 40, finalApplicants: 24, finalRate: 0.6, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮東', department: '体育科', quota: 80, finalApplicants: 79, finalRate: 0.99, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: 'ふじみ野', department: 'スポーツサイエンス科', quota: 80, finalApplicants: 78, finalRate: 0.98, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '大宮', department: '理数科', quota: 40, finalApplicants: 98, finalRate: 2.45, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '熊谷西', department: '理数科', quota: 40, finalApplicants: 47, finalRate: 1.18, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '越谷北', department: '理数科', quota: 40, finalApplicants: 65, finalRate: 1.63, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '所沢北', department: '理数科', quota: 40, finalApplicants: 97, finalRate: 2.42, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '松山', department: '理数科', quota: 40, finalApplicants: 67, finalRate: 1.68, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '市立大宮北', department: '理数科', quota: 40, finalApplicants: 64, finalRate: 1.6, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川口市立', department: '理数科', quota: 40, finalApplicants: 75, finalRate: 1.88, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '誠和福祉', department: '福祉科', quota: 80, finalApplicants: 39, finalRate: 0.49, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '春日部東', department: '人文科', quota: 40, finalApplicants: 20, finalRate: 0.5, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '岩槻', department: '国際文化科', quota: 40, finalApplicants: 31, finalRate: 0.78, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '芸術総合', department: '映像芸術科', quota: 40, finalApplicants: 54, finalRate: 1.35, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '芸術総合', department: '舞台芸術科', quota: 40, finalApplicants: 38, finalRate: 0.95, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: 'いずみ', department: '生物系', quota: 119, finalApplicants: 126, finalRate: 1.06, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: 'いずみ', department: '環境系', quota: 119, finalApplicants: 122, finalRate: 1.03, fiscalYear: '令和4年度（2022年度）' },
    // --- 全日制 総合学科 ---
    { schoolName: '小鹿野', department: '総合学科', quota: 119, finalApplicants: 32, finalRate: 0.27, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '川越総合', department: '総合学科', quota: 238, finalApplicants: 275, finalRate: 1.16, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '久喜北陽', department: '総合学科', quota: 318, finalApplicants: 348, finalRate: 1.09, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '幸手桜', department: '総合学科', quota: 199, finalApplicants: 150, finalRate: 0.75, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '進修館', department: '総合学科', quota: 198, finalApplicants: 179, finalRate: 0.9, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '誠和福祉', department: '総合学科', quota: 79, finalApplicants: 55, finalRate: 0.7, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '滑川総合', department: '総合学科', quota: 278, finalApplicants: 267, finalRate: 0.96, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '吉川美南', department: '総合学科', quota: 119, finalApplicants: 133, finalRate: 1.12, fiscalYear: '令和4年度（2022年度）' },
    { schoolName: '寄居城北', department: '総合学科', quota: 198, finalApplicants: 180, finalRate: 0.91, fiscalYear: '令和4年度（2022年度）' },  ],
};
