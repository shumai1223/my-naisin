 ...
 *
 * 【2026-09-07追記・令和9年度分を追加】「令和9年度青森県立高等学校（全日制の課程及び定時制の
 * 課程）入学者選抜要項」（`nyuugakusyasenbatsuyoukou2027.pdf`・66頁）を新規収録。R8と同じく
 * ToUnicode欠落PDFのため目次オフセット(+2)を再実測（同一パターンで再確認）しビジョン解析で
 * 「6 出願の受付」「7 出願先変更の手続」「10 学力検査等」「青森県立高等学校入学者選抜追検査
 * 取扱要項」「13 選抜結果の通知」「14 再募集」の各節を直接転記。
 * ⚠️令和9年度から「WEB出願システム」が新規導入され、紙の願書提出から出願情報のオンライン
 * 登録に変わった（この要項1(2)冒頭に明記）。この結果、令和8年度は「受付時間9時〜16時(最終日は
 * 正午)・土日を除く」という営業日単位の窓口受付だったが、令和9年度は「2/12(金)9時から
 * 2/17(水)12時まで」という連続した1本の受付期間に変更されている（公表資料の記載どおり
 * 転記・独自に単純化しない）。
 */
...
export const AOMORI_EXAM_SCHEDULE: PrefectureExamScheduleFile = {
  ...
  years: [
    ...
    },
    {
      ...
      sourceUrl: 'https://www.pref.aomori.lg.jp/soshiki/kyoiku/e-gakyo/files/nyuugakusyasenbatsuyoukou2027.pdf',
      docTitle: '令和9年度青森県立高等学校（全日制の課程及び定時制の課程）入学者選抜要項',
      fetchedAt: '2026-09-07',
      events: [
        { label: '入学願書の受付期間', startDate: '2027-02-12', endDate: '2027-02-17', note: 'WEB出願システムでの受付(新規導入)・2/17は12時まで' },
        { label: '出願先変更 受付期限', startDate: '2027-02-25' },
        { label: '学力検査等 検査実施日', startDate: '2027-03-04' },
        { label: '追検査実施日', startDate: '2027-03-10' },
        { label: '合格者の発表', startDate: '2027-03-12', note: '9時' },
        { label: '再募集 募集人員発表', startDate: '2027-03-12', note: '9時' },
        { label: '再募集入学願書 受付期間', startDate: '2027-03-15', endDate: '2027-03-16', note: '9時〜12時' },
        { label: '再募集 学力検査等 検査実施日', startDate: '2027-03-17' },
        { label: '再募集 合格者の発表', startDate: '2027-03-18', note: '13時' },
      ],
    },
  ],
};
