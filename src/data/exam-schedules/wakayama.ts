 ...
 *
 * ⚠️令和9年度分（T-Y11F §5順序#2）: 一次ソース「令和9年度和歌山県立高等学校入学者選抜日程」
 * https://www.pref.wakayama.lg.jp/prefg/500200/d00221979_d/fil/09nyuusinittei.pdf
 * R8はテキスト抽出できたがR9はフォント欠落でpdftotextが失敗、pdftoppm 200dpi+Read toolの
 * ビジョン解析で全項目を直接転記した。区分構成（特色化選抜・一般選抜/スポーツ推薦・追募集）は
 * R8と同一。原資料に「県立高等学校の今後の在り方について検討中のため日程等の一部を変更する
 * 場合がある」旨の注記あり。塾選ジャーナルの独立した二次情報源と完全一致を確認済み
 * （2026-09-08）。
 */
...
export const WAKAYAMA_EXAM_SCHEDULE: PrefectureExamScheduleFile = {
  ...
  years: [
    ...
    },
    {
      ...
      sourceUrl: 'https://www.pref.wakayama.lg.jp/prefg/500200/d00221979_d/fil/09nyuusinittei.pdf',
      docTitle: '令和9年度和歌山県立高等学校入学者選抜日程',
      fetchedAt: '2026-09-08',
      events: [
        { label: '特色化選抜 出願受付', startDate: '2027-01-21' },
        { label: '特色化選抜 面接等', startDate: '2027-01-28' },
        { label: '特色化選抜 合格内定', startDate: '2027-02-05' },
        { label: '一般選抜・スポーツ推薦 一般出願受付', startDate: '2027-02-19' },
        { label: '一般選抜・スポーツ推薦 本出願受付', startDate: '2027-03-02', endDate: '2027-03-03' },
        { label: '一般選抜・スポーツ推薦 学力検査', startDate: '2027-03-10' },
        { label: '一般選抜・スポーツ推薦 面接、実技検査等', startDate: '2027-03-11' },
        { label: '一般選抜・スポーツ推薦 合格発表', startDate: '2027-03-18' },
        { label: '追募集 出願受付', startDate: '2027-03-24' },
        { label: '追募集 学力検査等', startDate: '2027-03-26' },
        { label: '追募集 合格発表', startDate: '2027-03-30' },
      ],
    },
  ],
};
