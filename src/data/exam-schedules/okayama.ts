 ...
 *
 * 令和9年度分（T-Y11F §5順序#2）: R8と同名の「令和9年度岡山県立中学校及び岡山県立
 * 中等教育学校並びに岡山県立高等学校入学者選抜日程について」（`1054600_10219041_
 * misc.pdf`・令和8年1月9日付・2頁・ToUnicode欠落のためpdftoppm+visionで転記）を
 * 新規収録。R8と同じ2段階（特別入学者選抜・一般入学者選抜）構造を維持しており制度
 * 変更は無い。追検査（インフルエンザ罹患等が対象・特別選抜2/19・一般選抜3/17）は
 * R8にも対応する事務日程の記載が無く同じ方針で対象外。
 */
...
export const OKAYAMA_EXAM_SCHEDULE: PrefectureExamScheduleFile = {
  ...
  years: [
    ...
    },
    {
      ...
      sourceUrl: 'https://www.pref.okayama.jp/uploaded/life/1054600_10219041_misc.pdf',
      docTitle: '令和9年度岡山県立中学校及び岡山県立中等教育学校並びに岡山県立高等学校入学者選抜日程について',
      fetchedAt: '2026-09-08',
      events: [
        { label: '特別入学者選抜 出願の期間', startDate: '2027-01-26', endDate: '2027-01-28' },
        { label: '特別入学者選抜 学力検査', startDate: '2027-02-09' },
        { label: '特別入学者選抜 選抜結果の通知', startDate: '2027-02-18' },
        { label: '特別入学者選抜 合格者の発表', startDate: '2027-03-17' },
        { label: '一般入学者選抜（全日制・定時制） 出願の期間', startDate: '2027-02-24', endDate: '2027-02-26' },
        { label: '一般入学者選抜（全日制・定時制） 学力検査', startDate: '2027-03-09' },
        { label: '一般入学者選抜（全日制・定時制） 面接・実技', startDate: '2027-03-10' },
        { label: '一般入学者選抜（全日制・定時制） 合格者の発表', startDate: '2027-03-17' },
      ],
    },
  ],
};
