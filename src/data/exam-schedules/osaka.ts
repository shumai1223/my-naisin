 ...
 *
 * 【2026-09-07追記・令和9年度分を追加】「令和9年度大阪府公立高等学校入学者選抜 日程表」
 * （`documents/129117/03_r9_hs_nittei.pdf`・1頁・埋め込みテキスト層がありRead toolで直接
 * 抽出できた）を新規収録。令和8年度分の一次ソースは詳細な手続き章（実施要項第7章）で
 * 「登録期間」「受理期間」の2段構造を記載していたが、今年入手できたのは1枚のサマリー
 * 日程表で、一般入学者選抜（全日制の課程）は単一の「出願期間」として記載されている
 * （2段構造の詳細章はR9では今回未発見のため、公表資料の項目名をそのまま転記した）。
 */
...
export const OSAKA_EXAM_SCHEDULE: PrefectureExamScheduleFile = {
  ...
  years: [
    ...
    },
    {
      ...
      sourceUrl: 'https://www.pref.osaka.lg.jp/documents/129117/03_r9_hs_nittei.pdf',
      docTitle: '令和9年度大阪府公立高等学校入学者選抜 日程表（一般入学者選抜・全日制の課程）',
      fetchedAt: '2026-09-07',
      events: [
        { label: '出願期間', startDate: '2027-03-03', endDate: '2027-03-05' },
        { label: '学力検査等', startDate: '2027-03-10' },
        { label: '合格発表', startDate: '2027-03-18' },
      ],
    },
  ],
};
