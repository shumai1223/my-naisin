...
const FAQS = [
  ...
  {
    question: '既卒者（一度中学校を卒業してから受験する場合）も調査書は同じですか？',
    answer:
      '取り扱いは都道府県によって異なります。例えば新潟県の調査書記入方法では、卒業から一定年数が経ち生徒指導要録の保存期間を過ぎた卒業者について、「各教科の学習の記録」欄に斜線を引き、保存期間経過のため記入できない旨を記載する運用が定められています。卒業から年数が経っている場合は、出願を予定する都道府県・高校の募集要項で提出書類の扱いを必ず確認しましょう。',
  },
];
