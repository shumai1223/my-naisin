...
export const metadata: Metadata = {
  ...
  description: '【無料】5教科対応の偏差値計算サイト。点数と平均点・標準偏差を入れるだけで偏差値を30秒で自動算出。高校偏差値の診断・偏差値を求める計算にも対応。点数→偏差値の早見表、偏差値→上位％・順位の完全対応表（偏差値60＝上位約16%）も収録。模試で偏差値が違う理由・高校と大学の偏差値の違いまで解説。2026年最新版。',
  ...
  openGraph: {
    title: '偏差値計算サイト 5教科｜高校偏差値の診断はこれ1つでOK【無料・30秒で算出】 | My Naishin',
    description: '5教科の点数と平均点から偏差値を瞬時に計算。高校偏差値の診断・偏差値を求める計算にも対応した中学生・高校生向け無料ツール。',
