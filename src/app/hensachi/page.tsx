...
export const metadata: Metadata = {
  ...
  keywords: ['偏差値計算サイト', '偏差値計算サイト 5教科', '偏差値計算サイト 中学生', '偏差値計算', '偏差値 計算', '偏差値診断', '偏差値診断 中学生', '中学生 偏差値 診断', '偏差値 求める サイト', '偏差値 出す サイト', '5教科 偏差値', '中学生 偏差値', '高校生 偏差値', '偏差値 上位 何%', '偏差値60 上位', '偏差値65 順位', '偏差値 早見表', '偏差値 順位 換算', '偏差値 とは', '模試 偏差値 違い', '大学 偏差値 違い', '偏差値シミュレーター', '偏差値シュミレーター', '高校偏差値診断', '偏差値テスト', '偏差値テスト 無料', '偏差値チェック', '500点満点 偏差値', '1000点満点 偏差値', '100点満点 偏差値'],
  alternates: {
