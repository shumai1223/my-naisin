...
export const metadata: Metadata = {
  title: '満点変換つき偏差値計算【500点・1000点・900点満点対応】| My Naishin',
  description: '500点満点・1000点満点・900点満点など、100点満点以外のテスト・模試の偏差値を無料で計算。平均点・標準偏差が分からなくても満点から目安値を自動算出。登録不要・30秒で結果表示。',
  keywords: ['500点満点 偏差値', '1000点満点 偏差値', '900点満点 偏差値', '満点 偏差値 計算', '偏差値 満点変換'],
        ...
        <div className="mx-auto max-w-3xl px-4 py-6 md:py-10">
          ...
          <header className="mb-8 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl leading-relaxed text-slate-600">
              500点満点・1000点満点・900点満点など、<strong>100点満点以外</strong>のテストや模試の偏差値をそのまま計算できます。
