...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      '私立高校は学習費総額が年約118万円（公立は約60万円）で、3年間では約354万円が目安です。ただし高校無償化（就学支援金）で世帯年収の区分に応じて授業料が軽減されるため、実支出はこれより小さくなる場合があります。「高校の費用」「就学支援金ガイド」で具体的な金額を確認できます。',
  },
];
        ...
        <div className="mx-auto max-w-4xl px-4 py-6 md:py-10">
          ...
          <section className="mb-10 rounded-2xl border border-indigo-100 bg-indigo-50/40 p-6">
            ...
            <p className="leading-relaxed text-slate-700">
              ...
              高校3年間だけでも公立で約179万円・私立で約354万円かかり、塾代・大学費用を加えると数百万円規模になります。
