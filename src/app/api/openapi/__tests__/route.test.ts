...
const EXCLUDED_ROUTES = new Set<string>([
  ...
  '/api/parent-funnel',
  '/api/student-funnel',
  '/api/click-hop-complete',
  '/api/billing/checkout',
  '/api/stripe/webhook',
  '/api/resend/webhook',
  '/api/admin/juku-reviews/moderate',
  '/api/admin/juku-matching/partner',
  '/api/admin/juku-matching/referral-status',
  '/api/admin/juku-matching/commission',
  '/api/admin/community-posts/moderate',
