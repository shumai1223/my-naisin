 ...
 *
 *   GET /api/card?d=<base64url payload>   … 共有文脈（県・点・満点・目標・差・学年・指標）を埋め込んだカード
...
function buildCard(d: CardData): string {
  ...
  ${gapLabel ? `<g transform="translate(700 330)">
    <rect x="0" y="0" width="428" height="120" rx="20" fill="#ffffff" stroke="${gapColor}" stroke-width="3" opacity="0.95"/>
