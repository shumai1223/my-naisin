...
const FAQS = [
  ...
  {
    question: '100点満点に換算することもできますか？',
    answer: 'はい。当ツールは換算後の満点を1000点・500点・100点、または任意の数値に自由に設定できます。100点満点に設定すれば、テストの得点を「100点満点なら何点相当か」に換算できます。模試や実力テストの得点を別の満点基準に揃えたい場合にも使えます。',
  },
  {
