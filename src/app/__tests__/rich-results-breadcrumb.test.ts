...
const BREADCRUMB_EXEMPT_ROUTES: Record<string, string> = {
  ...
  '/juku/dashboard/simulator': 'ZZ-4d系列：noindex・旗付きUI・招待トークン必須の内部ツール（リッチリザルト対象外・Λ-8）',
  '/juku/dashboard/report': 'ZZ-4d系列：noindex・旗付きUI・招待トークン必須の内部ツール（リッチリザルト対象外・Λ-8）',
  '/juku/matching/dashboard': 'noindex・旗付きUI・招待トークン必須の内部ツール（リッチリザルト対象外・Λ-7）',
  '/juku/matching': 'noindex・旗付きUIの公開送客導線（提携塾一覧・リッチリザルト対象外・Λ-7残作業）',
  ...
  '/interim-bulletin-preview': 'Y-11：noindex・旗付きUI（サンプルデータのみの内部確認用・リッチリザルト対象外）',
  '/nendomatsu-pack': 'T-TD1：noindex・旗付きUI（法人向け商品の内部確認用・リッチリザルト対象外）',
