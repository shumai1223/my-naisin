          ...
          <Link href="/about/editor-profile" className="group block overflow-hidden rounded-3xl border border-blue-200 bg-white shadow-md transition-all hover:shadow-xl hover:border-blue-400">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-8">
                <h2 className="text-xl font-black text-slate-800 mb-4 group-hover:text-blue-600">ないしんパンダ（現役中学生エンジニア）が全データを直接解析</h2>
                <p className="text-sm text-slate-600 leading-relaxed">
                  2026年度（令和8年度）に受験を控える開発者・ないしんパンダが、47都道府県すべての教育委員会資料を読み込み、1点1点の計算式をコードに反映。当事者だからこその「正確さ」と「使いやすさ」を追求しています。
                </p>
