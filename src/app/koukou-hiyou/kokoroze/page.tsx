...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      '文部科学省「子供の学習費調査」の学習費総額（授業料・教材費・通学費・学校外活動費等を含む全日制1年あたり）では、公立は約60万円/年、私立は約118万円/年です。就学支援金を反映すると、世帯年収によって実質負担の差は大きく変わります。当ページのシミュレーターで、ご家庭の年収区分での公私の実質負担を比較できます。',
  },
  {
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <div className="mx-auto max-w-4xl px-4 py-6 md:py-10">
          ...
          <AnswerBox question="公立と私立、3年間の実質負担はどれだけ違う？">
            <p>
              学習費総額は<strong>公立 約60万円/年・私立 約118万円/年</strong>（文科省・全日制）。これに高校無償化（就学支援金）が効きます。
