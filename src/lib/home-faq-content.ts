...
export const HOME_FAQS = [
  ...
  {
    question: '換算内申とは何ですか？',
    answer: '換算内申とは、9教科の評定をそのまま合計するのではなく、都道府県ごとの計算方式（学年比率・実技教科の倍率等）で重み付けして換算した内申点のことです。特に東京都では「換算内申」という名称で、5教科の評定をそのまま・実技4教科の評定を2倍にして合算する65点満点の値を指します。当サイトの内申点 計算サイトは、この換算内申を含む47都道府県すべての換算方式に対応した自動計算機です。',
  },
  {
