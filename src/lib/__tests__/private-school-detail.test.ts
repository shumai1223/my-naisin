...
describe('PRIVATE_SCHOOL_DETAIL_KANAGAWA(大都市圏5県・育伸社募集要項PDF1〜5ページ目36校を収録・進行中)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録36校・スキップ1校で参照台帳83校のうち残り46校は未着手(重複なし)', () => {
    ...
    expect(result.duplicates).toEqual([]);
    expect(result.missing).toHaveLength(46);
    expect(PRIVATE_SCHOOL_DETAIL_KANAGAWA.schools.length).toBe(36);
