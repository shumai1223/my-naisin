...
describe('PRIVATE_SCHOOL_DETAIL_TOKYO(大都市圏5県の最後・育伸社募集要項PDF全20ページ処理完了+保留3校の再訪+著名進学校12校+個別公式サイト調査17校のスキップ判定・帝京1校を個別公式サイトで収録・241校中170校を収録・スキップ37校・残り34校は別チャネルで継続調査)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録170校・スキップ37校で参照台帳241校のうち残り34校は未着手(重複なし)', () => {
    ...
    expect(PRIVATE_SCHOOL_DETAIL_TOKYO.skipped.length).toBe(37);
  });
});
