...
describe('PRIVATE_SCHOOL_DETAIL_OSAKA(大都市圏5県の3県目・育伸社募集要項PDF1ページ目+公式サイト個別確認で25校を収録・スキップ4校・進行中・参照台帳107校)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録25校・スキップ4校で参照台帳107校のうち残り78校は未着手(重複なし)', () => {
    ...
    expect(PRIVATE_SCHOOL_DETAIL_OSAKA.schools.length).toBe(25);
...
describe('PRIVATE_SCHOOL_DETAIL_TOKYO(大都市圏5県の最後・育伸社募集要項PDF全20ページ処理完了+保留3校の再訪+著名進学校12校+個別公式サイト調査17校+個別公式サイト調査30校のスキップ判定(廃校2校含む)・帝京1校を個別公式サイトで収録・241校中170校を収録・スキップ52校・残り19校は別チャネルで継続調査)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録170校・スキップ52校で参照台帳241校のうち残り19校は未着手(重複なし)', () => {
    ...
    expect(PRIVATE_SCHOOL_DETAIL_TOKYO.schools.length).toBe(170);
    expect(PRIVATE_SCHOOL_DETAIL_TOKYO.skipped.length).toBe(52);
  });
});
