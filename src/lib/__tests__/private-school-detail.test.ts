...
describe('PRIVATE_SCHOOL_DETAIL_KANAGAWA(大都市圏5県・育伸社募集要項PDF1〜7ページ目48校を収録・進行中)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録48校・スキップ1校で参照台帳83校のうち残り34校は未着手(重複なし)', () => {
    ...
    expect(PRIVATE_SCHOOL_DETAIL_KANAGAWA.schools.length).toBe(48);
