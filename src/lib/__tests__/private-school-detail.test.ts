...
describe('PRIVATE_SCHOOL_DETAIL_OKAYAMA(27校中4校を収録・進行中)', () => {
  it('収録した学校は全てcourses合計とtotalCapacityが一致する', () => {
  ...
  it('収録4校・スキップ0件で残り23校は未着手(重複なし)', () => {
    ...
    expect(result.duplicates).toEqual([]);
    expect(result.missing).toHaveLength(23);
    expect(PRIVATE_SCHOOL_DETAIL_OKAYAMA.schools.length).toBe(4);
