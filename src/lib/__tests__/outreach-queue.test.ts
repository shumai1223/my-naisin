...
describe('data/outreach-queue.json（X\'-1・実データ整合性）', () => {
  ...
  // 2026-09-06: batch3/8/11/12のフォーム36件をCowork入力→👤送信し queued→sent へ移した(116→80)。
  it('80件がqueued(教委13[email3+form10]+メディアemail9+メディアform5+個人塾line4+npo4+EdTech校務支援8+本文既存済み94の昇格)', () => {
    ...
    // (115→116)。
    // 2026-09-07: juku-yarukiswitch-advertisementが2026-09-06にCowork batch12として
    // 「やる気スイッチグループHD」の表記で既に送信済みだったと判明(ledger id b2b-form-b12-46-0906)。
