...
export const STATIC_PAGES: StaticPageEntry[] = [
  ...
  { url: '/hyotei-heikin/gakushu-seiseki', priority: 0.9, changeFrequency: 'weekly' },
  { url: '/hyotei-heikin/gakushu-seiseki/chousasho', priority: 0.8, changeFrequency: 'weekly' },
  { url: '/hyotei-heikin/gakushu-seiseki/kyoka-betsu', priority: 0.7, changeFrequency: 'weekly' },
  { url: '/hyotei-heikin/gakushu-seiseki/gaihyou', priority: 0.7, changeFrequency: 'weekly' },
  ...
  { url: '/genten-archive', priority: 0.6, changeFrequency: 'weekly' },
  ...
  { url: '/naishin-oru', priority: 0.8, changeFrequency: 'weekly' },
  { url: '/naishin-oru/3', priority: 0.8, changeFrequency: 'weekly' },
  { url: '/naishin-oru/4', priority: 0.8, changeFrequency: 'weekly' },
  { url: '/naishin-oru/5', priority: 0.8, changeFrequency: 'weekly' },
  ...
  { url: '/shutsugan-junbi/kounai-senkou', priority: 0.7, changeFrequency: 'weekly' },
  ...
  { url: '/futoukou/shussekiatsukai', priority: 0.7, changeFrequency: 'weekly' },
  ...
  { url: '/report/2026/en', priority: 0.6, changeFrequency: 'monthly' },
