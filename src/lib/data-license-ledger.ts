...
export const DATA_LICENSE_LEDGER: Record<string, DataLicenseLedgerEntry> = {
  ...
  nagano: {
    ...
    redistribution: 'ok',
    evidence:
      '【2026-09-04確定・許諾】2026-09-02に送信した絞り込み再質問（「応募状況」募集人員・応募者数・' +
      '応募倍率等データの出典明記のうえでの掲載可否）への回答を受領（2026-09-03 23:39・件名' +
      '「長野県公立高等学校入学者選抜情報の掲載について（回答）」）: 「本県が公表している公立高等' +
      '学校入学者選抜に係るデータにつきましては、出典を明記していただいた上でご利用いただくことに' +
      'ついて、差し支えありません」＝応募状況データの再配布を明示的に許諾。ただし「掲載内容が長野' +
      '県教育委員会による作成又は監修であると誤解されることのないよう配慮」の留保あり（出典表記で' +
      '対応可能）。被リンクは2026-09-01回答で「原則として行っておりません」と別途不可済み' +
      '（mie/ishikawa/gifuと同型）',
  ...
  ishikawa: {
    ...
    redistribution: 'ok',
    evidence:
      '石川県教育委員会学校指導課からGmail回答あり（2026-08-07）: 「学校指導課の関連ページからサイト' +
      '「My Naishin」への参照についてですが、課内で協議して不可となりました」＝mie/gifu/wakayamaと' +
      '同型の被リンクは不可。【2026-08-28追記・T-C9】gifu/mie/akitaと同型の「応募状況（募集人員・' +
      '応募者数・応募倍率等）データの出典明記のうえでの掲載可否」を尋ねる再質問を送信（08-28）。' +
      '【2026-08-31追記・OK確定】同課から「応募状況のデータにつきまして、掲載される場合は、すでに' +
      '掲載いただいている公式資料・情報源（石川県教育委員会 公立高等学校入学者募集要綱／最終確認' +
      '2026-08-05）のように出典を明記し、該当PDFのリンクを掲載する形でご対応ください」と明確な' +
      '許諾回答を得た（Gmailスレッド19fdb5c0bad9773e）。被リンクは不可だが応募状況データの再配布は' +
      '既存の出典表記形式のまま明示的に許諾されたため、A-2実装時はこの県のレコードに出典URLを必ず' +
      '付与する条件で志願状況・募集人員・応募倍率を収録してよい',
  ...
  kagawa: {
    ...
    redistribution: 'ok',
    evidence:
      '⚠️2026-08-28夜に判明した下書き重複の経緯は解消済み(下記回答受領のため放置してよい)。' +
      '2026-08-28 22:43に「応募状況（募集人員・応募者数・応募倍率等）のデータにつきまして、出典' +
      '（資料名およびURL）を明記したうえで当サイトに掲載させていただくことが可能かどうか」と' +
      'gifu/mie/ishikawa/akitaと同型の具体的な再質問を送信し、2026-09-01 21:00に香川県教育委員会' +
      '高校教育課から「当課が公表しております入学者選抜に関する資料をお使いいただくことには差し支え' +
      'ありませんが、掲載する際には誤った情報とならないようご留意ください。なお、当課公式サイトから' +
      '貴サイトを参照することはできません」と明確な許諾回答を得た（Gmailスレッド1a044dd551f5aaa1）。' +
      '被リンクは不可だが応募状況データの再配布は明示的に許諾されたため、A-2実装時はこの県のレコードに' +
      '出典（資料名・URL）を必ず付与する条件で応募状況・募集人員・応募倍率を収録してよい',
  ...
  wakayama: {
    ...
    redistribution: 'ng',
    evidence:
      '【2026-09-04確定・拒否】和歌山県教育庁学校教育局県立学校教育課からGmail回答（2026-09-04' +
      '19:14・スレッド1a06bf4b7da4ce1a）: 「応募状況」（募集人員・応募者数・応募倍率等）データの' +
      '出典明記のうえでの掲載可否を明示的に尋ねたところ「『令和8年度和歌山県立高等学校入学者選抜' +
      '追募集出願状況について』などについては、本県の著作物であることから、出典等を明記した場合' +
      'においても掲載はご遠慮いただいています。ただし、本県教育委員会ホームページのリンクを貼って' +
      'いただくなどについては問題はございません」＝データ内容の転載・収録は明確に拒否。被リンクの' +
      'み許諾（2026-08-12回答と同型）。A-2以降の収録対象から除外する',
    verifiedAt: '2026-09-04',
  },
  shimane: {
    prefecture: 'shimane',
