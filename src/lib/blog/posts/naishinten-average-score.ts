...
export const post: BlogPost = {
    ...
    description: '一般的に内申点の平均点は45点満点中30〜33点と言われています。オール3（27点）は実は平均以下。内申点の分布と偏差値の目安を詳しく解説します。',
    date: '2026-04-22',
    ...
    faqs: [
      { question: '内申点の平均は何点ですか？', answer: '一般的に、9教科合計（45点満点）で平均は約30〜33点と言われています。絶対評価の導入により、評定の平均は3.0より高い3.3〜3.7程度になっています。' },
...
結論から言うと、一般的に、中学生の内申点の平均は**45点満点中おおよそ30〜33点**程度と言われています。これは9教科の平均評定が**3.3〜3.7**に相当します。
