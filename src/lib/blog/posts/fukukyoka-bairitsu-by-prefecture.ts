  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>学年ごとの倍率（中1〜中3で1:2:3）も重なるため、中3では実技×9・主要×6相当に。内申点は660点満点（実選抜換算500点満点。令和6年度以前は440点満点でした）</td>
      </tr>
      <tr>
...
<div class="table-container">
  <table>
    ...
    <tbody>
      ...
      <tr><td>岩手</td><td>660点</td><td>実技×3倍、学年比1:2:3（実選抜換算500点。令和6年度以前は440点）</td></tr>
...
<div class="point-box">
  ...
  <ul>
    <li><strong>東京都</strong>：素内申では＋2点だが、調査書点（300点満点）に換算すると<strong>＋約9.2点</strong>のインパクト</li>
