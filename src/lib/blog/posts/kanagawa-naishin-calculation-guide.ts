...
<div class="table-container">
  <table>
    ...
    <tbody>
      ...
      <tr><td>学力重視型</td><td>3</td><td>7</td><td>入試当日の点数勝負になりやすい</td></tr>
    </tbody>
  </table>
</div>

<p>例えば横浜翠嵐は「内申3：学力7：特色検査3」と学力・特色検査重視。一方で内申7：学力3などの設定をとる高校では、日頃の積み重ねがそのまま有利に働く。<strong>志望校を選ぶ際は必ず各高校の選考基準を確認しよう。</strong></p>
