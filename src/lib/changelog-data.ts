...
export const CHANGELOG: ChangeLogEntry[] = [
  {
    ...
    type: 'fix',
    category: 'content',
    title: '山形県・三重県の総合得点解説ページで、内申点の対象学年に誤りがありました',
    description:
      '山形県・三重県の「総合得点（当日点＋内申点）」解説ページで、内申点（調査書点）の対象学年を「中1〜中3の3年間」と誤って記載していました。正しくはどちらの県も「中学3年の評定のみ」が対象で、45点満点の点数を500点（山形県）または250点満点の学力検査と組み合わせる仕組みです（調査書には中1・中2の評定も記載されますが、合否判定には使われません）。教育委員会の一次情報を再確認のうえ修正し、同じ誤りが他の都道府県のページに無いかも全件確認しました（他に誤りはありませんでした）。',
  },
  {
    date: '2026-08-17',
    type: 'fix',
    category: 'content',
    title: '教育委員会サイトのリンク切れにより出典が404になっていた箇所を25件修正しました',
    description:
      '内申点計算方法のページ、ブログ記事、都道府県別の志願者数・倍率データで引用している教育委員会・文部科学省等の出典リンクのうち、東京都・神奈川県・青森県・福岡県・広島県・岡山県・京都府・宮城県のページ、および記事51本の出典欄あわせて25件がリンク切れ（404）になっていることが分かりました。教育委員会等がページを移転・整理した際にリンク先が変わっていたことが原因です。それぞれ現在の正しいページを探して張り替え、今後は毎月自動でリンク切れを検知する仕組みも導入しました。内申点の計算方法・満点・対象学年・志願者数などの数値自体に変更はありません。',
  },
  {
    date: '2026-08-17',
    type: 'fix',
    category: 'content',
    title: '岩手県・石川県・大阪府・埼玉県・愛知県のページで事実と異なる記載を修正しました',
    description:
      '岩手県教育委員会からのご指摘を受け、岩手県の内申点計算方法ページで実技4教科の倍率を誤って「1.5倍」（正しくは3倍）、調査書の圧縮後点数を令和6年度以前の旧基準「440点満点」（令和7年度以降は500点満点）のまま記載していた誤りを修正しました。あわせて同様の手書き記述を全都道府県で確認したところ、石川県（別県向けの定型文が誤って残っていた）、大阪府・埼玉県（「中3のみが対象」という誤記。実際は中1〜中3の全学年が対象）、愛知県（実技倍率の誤記）でも事実と異なる記載が見つかったため、あわせて修正しました。ご指摘くださった岩手県教育委員会の皆様に感謝申し上げます。',
  },
  {
    date: '2026-08-11',
    type: 'fix',
    category: 'content',
    title: 'プライバシーポリシーの広告に関する記述を実態に合わせて訂正しました',
    description:
      'プライバシーポリシーに「現在、広告は掲載しておりません」と書かれたままになっていましたが、実際には塾・通信教育・FP無料相談などのアフィリエイト広告を掲載しています。事実と異なる記述をそのままにしていたことをお詫びします。利用しているASP（広告仲介事業者）の名前、広告リンクをクリックしたときに何が記録されるか、広告の表示時に外部へ通信が発生することを具体的に書き直しました。あわせて「紹介料の有無によって計算結果や順位・評価を変えることはない」ことを明記し、Google AdSense・Amazonアソシエイトは利用していない（閲覧履歴に基づくパーソナライズ広告は配信していない）ことも明言しました。',
  },
  {
    date: '2026-08-10',
    type: 'fix',
    category: 'data',
    title: '匿名統計（全国分布）の公開を一時停止しました',
    description:
      '利用者のオプトインで集めた匿名統計のうち、偏差値の集計値に自動投稿とみられるデータが混入していることが分かりました。偏差値は本来「平均50」になる指標ですが、集計値がそこから大きく外れていたため、統計ページ・API・CSV配布・白書ページのすべてで公開を停止しました。あわせて、1件ずつの入力チェックだけでは見抜けない「集団として成立しない集計値」を自動で検出し、公開前に止める仕組みを追加しています。送信元を検証する仕組みを実装したうえで、あらためて収集し直します。件数の表示は従来どおり続けます。',
  },
  {
    date: '2026-08-07',
    type: 'fix',
