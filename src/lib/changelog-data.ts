...
export const CHANGELOG: ChangeLogEntry[] = [
  {
    ...
    type: 'update',
    category: 'ui',
    title: 'ブログ全面リニューアル！プロ品質のデザインに刷新',
    description: '記事ページをnote/Medium級のプレミアムデザインに全面改修。ヒーローヘッダー・目次・FAQ・CTA・関連記事を追加。ブログ一覧ページもフィーチャード記事＋カテゴリ別表示に刷新。トップページのブログセクションも新記事対応のカード型レイアウトに変更。',
  },
  {
    date: '2026-03-15',
    type: 'update',
