...
export const CHANGELOG: ChangeLogEntry[] = [
  {
    ...
    type: 'fix',
    category: 'content',
    title: '教育委員会サイトのリンク切れにより出典が404になっていた箇所を20件修正しました',
    description:
      '内申点計算方法のページ、ブログ記事、都道府県別の志願者数・倍率データで引用している教育委員会・文部科学省等の出典リンクのうち、東京都・神奈川県・青森県・福岡県・広島県・岡山県のページ、および記事51本の出典欄あわせて20件がリンク切れ（404）になっていることが分かりました。教育委員会等がページを移転・整理した際にリンク先が変わっていたことが原因です。それぞれ現在の正しいページを探して張り替え、今後は毎月自動でリンク切れを検知する仕組みも導入しました。内申点の計算方法・満点・対象学年・志願者数などの数値自体に変更はありません。',
  },
  {
    date: '2026-08-17',
    type: 'fix',
