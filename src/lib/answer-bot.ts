...
const GENERAL_FACTS: { test: RegExp; result: Omit<AnswerResult, 'kind'> }[] = [
  ...
  },
  {
    ...
    result: {
      title: '高校の費用の目安',
      answer:
        '高校3年間の費用は、おおむね公立で150万円前後、私立で300〜400万円前後が一つの目安です（授業料・通学費・教材費などを含む。地域・学校で変動し、塾代は別途）。早めに総額を把握しておくと、志望校の選択肢を狭めずに準備できます。',
      links: [
        { href: '/koukou-hiyou', label: '高校の費用シミュレーター（公立/私立）' },
        { href: '/juku-hiyou', label: '塾代シミュレーター（相場・3年間の総額）' },
