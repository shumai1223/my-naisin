  ...
  iwate: {
    ...
    pitfalls: {
      ...
      items: [
        ...
        '<strong>「660点満点→440点満点」への謎の換算：</strong>複雑な計算で出した内申点（660点満点）は、最終的に440点満点に圧縮されます。学力検査500点・調査書440点・面接60点の合計1000点満点で一般選抜が実施されます。受験生は、自分の素点（660点満点）だけでなく、この換算後の点数も意識して志望校のボーダーラインと比較する必要があります。',
