 ...
 * 「特色選抜」に変わっていたため修正）。他1県はまだ未検証。
 */
export const VERIFIED_PITFALLS_PREFECTURE_CODES = new Set(['tokyo', 'kanagawa', 'osaka', 'saitama', 'chiba', 'hokkaido', 'fukuoka', 'shizuoka', 'hyogo', 'hiroshima', 'aichi', 'aomori', 'iwate']);
