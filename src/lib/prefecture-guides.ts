 ...
 * 固定方式(山形・鳥取等の変動比率制度を誤って適用した記述)だったため修正）。他2県はまだ未検証。
 */
export const VERIFIED_PITFALLS_PREFECTURE_CODES = new Set(['tokyo', 'kanagawa', 'osaka', 'saitama', 'chiba', 'hokkaido', 'fukuoka', 'shizuoka', 'hyogo', 'hiroshima', 'aichi', 'aomori']);
