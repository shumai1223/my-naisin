...
// 表示される（getPrefectureTraps参照）。topicが無いエントリ（tokyo/kanagawa/osaka/fukuoka以外の
// 8県）はまだ内容の再検証が済んでいないため、意図的に非表示のまま据え置く（1県ずつ検証してから
...
// 判明し訂正した（東京都・大阪府の同名エントリからのコピペ由来の誤りと推測）。
 ...
 * （2026-08-01: 東京都・神奈川県・大阪府・福岡県を再検証・topicタグ付けを実施。他県は今後1県ずつ検証してから解禁する）。
 */
