...
const FAQ = [
  ...
  {
    q: '東京都と他の地域で違うの？',
    a: 'はい！東京都は実技4教科を2倍で計算するため、満点が65点になります。神奈川県は中2・中3の成績を使い135点満点、北海道は3年間の成績で315点満点など、地域ごとに大きく異なります。ページ上部から都道府県を選択すると、その地域の計算方法が適用されます。'
  },
  {
    q: 'いつの成績が内申点になる？',
    a: '都道府県によって異なります。東京都は中3のみ、神奈川県は中2〜3年、埼玉県は中1〜3年の成績が対象です。ページ上部で都道府県を選択すると、対象学年が表示されます。'
  },
  {
    q: 'ランクはどう決まる？',
    a: 'Sランク(85%以上)、Aランク(70%以上)、Bランク(55%以上)、Cランク(55%未満)で判定しています。これは目安であり、志望校によって必要な内申点は異なります。'
  }
];
