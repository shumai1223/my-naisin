...
const FEATURED_ARTICLES = [
  ...
  },
  {
    ...
    title: '【東京都】換算内申の計算方法と都立高校入試の仕組み',
    description: '実技4教科が2倍！65点満点の計算方法と、調査書点の重要性を徹底解説',
    icon: Target,
  ...
  },
  {
    ...
    title: '【副教科】音楽・美術・体育・技家の内申点を上げるコツ',
    description: '実技が苦手でも大丈夫！評価されるポイントと先生が見ているところを解説',
    icon: Star,
