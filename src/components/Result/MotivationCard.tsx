...
const MOTIVATION_MESSAGES: Record<string, {
  ...
  S: {
    ...
    tips: ['応用問題にどんどん挑戦', '後輩に教えることで理解を深める', '志望校の過去問を解いてみよう'],
    icon: Trophy,
  ...
  A: {
    ...
    tips: ['苦手科目を1つ選んで集中対策', '得意科目は満点を目指す', '計画的な学習スケジュールを'],
    icon: Star,
  ...
  B: {
    ...
    tips: ['毎日30分の復習を習慣に', '間違えた問題を記録しよう', '友達と教え合うのも効果的'],
    icon: TrendingUp,
  ...
  C: {
    ...
    tips: ['まずは1教科を重点的に', '基礎問題を繰り返し解く', '分からないことはすぐ質問'],
    icon: Flame,
  ...
  D: {
    ...
    tips: ['教科書の基本に立ち返る', '1日10分から始めてみよう', '「できた！」を増やしていこう'],
    icon: Rocket,
