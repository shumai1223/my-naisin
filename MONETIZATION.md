...
| --- | --- | --- | --- | --- |
| 1 | Comiru（株式会社POPER） | A. 塾SaaS（校務/生徒管理） | （要確認） | ✅確認済（学習塾特化型SaaS、導入3,000教室超） |
| 2 | スクパス | A. 塾SaaS | （要確認） | ✅確認済（学習塾・スクール向け管理システム、導入2,400施設超） |
| 3 | Grow | A. 塾SaaS | （要確認） | ✅確認済（学習塾トータル管理システム） |
| 4 | E-Space | A. 塾SaaS | （要確認） | ✅確認済（小〜中規模スクール向けスケジュール管理SaaS） |
| 5 | コエテコマネージャー（GMOメディア株式会社） | A. 塾SaaS | （要確認） | ✅確認済（スクール管理システム） |
| 6 | スタディサプリ（株式会社リクルート） | B. 受験・学習アプリ | （要確認） | ✅確認済 |
| 7 | Studyplus（Studyplus株式会社） | B. 受験・学習アプリ | （要確認） | ✅確認済 |
| 8 | atama+（atama plus株式会社） | B. 受験・学習アプリ | （要確認） | ✅確認済 |
| 9 | インターエデュ・ドットコム | C. 教育メディア | （要確認） | ✅確認済 |
| 10 | リセマム（イード） | C. 教育メディア | （要確認） | ✅確認済 |
| 11 | ONETES／首都圏模試センター | C. 教育メディア | （要確認） | ✅確認済 |
| 12 | | D. 地場塾（D-1/D-2直接契約） | | 👤埋め |
| 13 | | D. 地場塾 | | 👤埋め |
| 14 | | D. 地場塾 | | 👤埋め |
| 15 | | D. 地場塾 | | 👤埋め |
| 16 | | D. 地場塾 | | 👤埋め |
| 17 | 家庭教師のトライ（株式会社トライグループ） | E. 家庭教師サービス | （要確認） | ✅確認済（個別指導・家庭教師の全国最大手、オンライン家庭教師も展開） |
| 18 | オンライン家庭教師WAM（株式会社エイチ・エム・グループ） | E. 家庭教師サービス | （要確認） | ✅確認済（個別指導塾を全国展開する同社が運営するオンライン家庭教師サービス） |
| 19 | スタディコーチ（株式会社Builds） | E. 家庭教師サービス | （要確認） | ✅確認済（東大・早慶生コーチによる難関大学・難関高校向け個別指導） |
| 20 | みんなの高校情報（株式会社イトクロ） | F. 教育メディア/受験情報サイト（追加候補） | （要確認） | ✅確認済（全国の高校の偏差値・口コミ・入試情報サイト。塾ナビ等も運営） |
| 21 | 大学受験パスナビ（株式会社旺文社） | F. 教育メディア（追加候補） | （要確認） | ✅確認済（大学受験情報・過去問・合格体験記を扱う旺文社運営サイト） |
| 22 | FLENS School Manager（FLENS株式会社） | G. 塾SaaS（追加候補） | （要確認） | ✅確認済（塾・スクール向け保護者コミュニケーション/校務プラットフォーム、利用者12万人超） |
| 23 | BitCampusEX（株式会社ティエラコム） | G. 塾SaaS（追加候補） | （要確認） | ✅確認済（学習塾向け生徒管理・入退室・請求管理システム、10万人超が利用） |
| 24 | 進研ゼミ（株式会社ベネッセコーポレーション） | H. 通信教育・映像授業 | （要確認） | ✅確認済（国内最大手の通信教育、中高一貫コースあり） |
| 25 | Z会（株式会社Z会／増進会ホールディングス） | H. 通信教育・映像授業 | （要確認） | ✅確認済（通信教育・映像授業・個別指導を展開、大学受験に強い） |
