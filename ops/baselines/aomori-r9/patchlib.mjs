// aomori.ts の (schoolName, department, selectionCategory) で特定した1レコード内だけを置換するヘルパ。oldが0件/複数件なら例外。
import fs from 'fs';
export const FILE = 'C:/Users/E24054/my-naisin/src/data/school-selection-methods/aomori.ts';
