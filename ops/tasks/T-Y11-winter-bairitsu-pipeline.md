...
- [~] N1-2 と同じ形で `src/data/snapshots/2024-r6/` `2023-r5/` を作る →
      ...
      **2023-r5は未着手** → **✅2026-09-22着手**: `src/data/snapshots/2023-r5/`を新設し
      ehime・kochi・yamanashi・osaka・chiba・tochigi・wakayama・ibaraki・mieの9県を収録(9/47)。
      mieは単純URL置換でなくWebSearchで「令和５年度三重県立高等学校入学者選抜実施方針」
      PDFを直接発見(45点満点・9教科×5段階・第3学年のみ対象、R6/R7の引用文と一言一句一致)。
