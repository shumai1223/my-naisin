...
- [ ] 各県のパーサをテストファイルから**純関数として抽出**し、レジストリに登録する
      🔶進行中（13/31県・toyama/aomori/iwate/fukui/kagawa/ehime/chiba/yamanashi/miyagi/nagasaki/
      saitama/gunma/shimane完了・2026-09-06）。1県ずつのため次回以降続行
...
- [x] ⚠️ 1県ずつやる。**まとめて動かして壊すより、1県ずつ緑を確認する**
      ...
      （残り18県。行数の少ない順に選ぶと着手しやすい: nara134行/kyoto154行が次点）
