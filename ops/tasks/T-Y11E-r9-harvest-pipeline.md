...
- [ ] 各県のパーサをテストファイルから**純関数として抽出**し、レジストリに登録する
      🔶進行中（11/31県・toyama/aomori/iwate/fukui/kagawa/ehime/chiba/yamanashi/miyagi/nagasaki/
      saitama完了・2026-09-06）。1県ずつのため次回以降続行
...
- [x] ⚠️ 1県ずつやる。**まとめて動かして壊すより、1県ずつ緑を確認する**
      ...
      （残り20県。行数の少ない順に選ぶと着手しやすい: gunma119行/shimane122行が次点）
