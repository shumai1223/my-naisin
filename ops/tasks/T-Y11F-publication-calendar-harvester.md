...
|---|---|---|---|
| 1 | **R9実施要項の差分検出**⚠️着手中(2026-09-07) | 埼玉5/29確定版・長野7/2・大阪・神奈川・山口が**既に公表済み**。R9スナップショットを凍結し `exam-system-diff.ts` にかければ制度変更が出る。T-N1の年次変化レポートの原料 | 24h |
...
制度のため、reverseCalcはnullのまま引き継いだ。テストを8件に拡充。**4/5県完了**
（saitama/osaka/kanagawa/nagano）。山口の1県のみ次回以降。
